...
- **NN Performance Intelligence (The Beijing Visualizer)**: [`UNIFIED_REPORTING_WORKSPACE/plot_nn_performance.py`](file:///Users/stefanbund/Developer/LAPTOP_PREPROCESSOR_MODELER/UNIFIED_REPORTING_WORKSPACE/plot_nn_performance.py) [NEW]
    ...
    - *Logic*: Aggregates mean predicted probabilities and historical accuracy for all symbols over a rolling 7-day window. It visualizes the **Beijing Logic** by mapping model confidence against a standard 75% decision threshold.
...
- **Live Access URLs (Exchange: Coinbase)**:
    ...
    - **NN Performance Intelligence (Beijing Portal)**: [View NN Charts](https://stefanbund.github.io/stadium-public-data/coinbase/nn_performance.html) [NEW]
