...
> **Report Generated**: `2026-08-12 11:48:16 PM PDT (2026-08-13 06:48:16 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.59** | **-1.53** (≤ -0.5) | 53.7 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.54** | **+0.30** (≤ -0.5) | 32.3 | 0/100 (< 30) | Expansion 📈 | 🔴 DAW Vetoed |
...
> - **BTC-USD**: $Z = -1.53$ (Safety Margin: **-1.03** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (10.46h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (6.57h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (14.15h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 23:48 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 23:48 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 23:48 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,818` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 6.6h ago (2026-08-12 05:13 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **91.2h (3d 19h 11m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **90.2h (3d 18h 11m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:48:13 AM
   CPU:  53.2%  |  MEM:   5.9% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 920651   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 951502   | COOL-DOWN       | 104      | Next run in 15.0s
Trader ETH-USD       | 951503   | COOL-DOWN       | 104      | Next run in 15.0s
Trader ADA-USD       | 951504   | COOL-DOWN       | 104      | Next run in 15.0s
Trader DOGE-USD      | 951505   | COOL-DOWN       | 104      | Next run in 15.0s
Trader BTC-USD       | 951506   | COOL-DOWN       | 104      | Next run in 15.0s
Trader LINK-USD      | 951507   | COOL-DOWN       | 104      | Next run in 15.0s
Trader SOL-USD       | 951508   | COOL-DOWN       | 104      | Next run in 15.0s
================================================================================
```
