...
> **Report Generated**: `2026-08-25 09:47:51 AM PDT (2026-08-25 16:47:51 UTC)`  
...
| `ETH-USD` | DVOL_ETH | **-0.97** | **-0.50** | **-0.47** | **+5.58** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (0.76h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (1.74h old) | 08-25 08:03 |
| ✅ | **Holding Times config** | Fresh (0.76h old) | 08-25 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-25 09:47 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-25 09:47 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `117` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.7h ago (2026-08-25 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **129.2h (5d 9h 12m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **128.2h (5d 8h 11m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:47:50 PM
...
Trader ETH-USD       | 3597367  | RUNNING         | 116      | Evaluating Funnel/Polling Order
