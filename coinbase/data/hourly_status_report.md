...
> **Report Generated**: `2026-08-28 03:23:45 AM PDT (2026-08-28 10:23:45 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.97** | **-0.50** | **-1.47** | **+6.40** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.99** | **-0.50** | **-1.49** | **+20.52** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.97** | **-0.50** | **-1.47** | **+6.37** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.97** | **-0.50** | **-1.47** | **+6.29** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.97** | **-0.50** | **-1.47** | **+6.37** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.97** | **-0.50** | **-1.47** | **+6.42** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.97** | **-0.50** | **-1.47** | **+6.39** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.68h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (3.36h old) | 08-28 00:01 |
| ❌ | **Holding Times config** | STALE! (162.4h old) | Limit 104.4h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-28 03:23 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 03:23 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-28 03:23 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1973 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `15,040` | **100.0%** |
...
| `LINK-USD` | BUY | 11.65 | `299f735c-5f89-487c-a52f-f30585f88457` |
| `USDT-USDC` | BUY | 0.9999 | `35db74a4-c595-4c08-913a-de3e5f840fbc` |
| `USDT-USDC` | BUY | 0.9999 | `5e0dc9c8-4e38-4d24-80ee-0a0b756ff672` |
| `USDT-USDC` | BUY | 0.9999 | `ac6e2f79-ba56-4436-93f4-7f66b92b0226` |
| `USDT-USDC` | BUY | 0.9999 | `50bdce4b-8784-4381-b5b2-13938641c408` |
| `USDT-USDC` | BUY | 0.9999 | `4d564dad-c0d4-4fba-b9f6-80576c0dab01` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.4h ago (2026-08-28 12:01 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **63.6h (2d 15h 36m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **62.6h (2d 14h 35m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:23:43 AM
   CPU:   9.1%  |  MEM:   6.9% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2671002  | COOL-DOWN       | 60       | Next run in 4.0s
Trader ETH-USD       | 2671003  | COOL-DOWN       | 72       | Next run in 4.0s
Trader ADA-USD       | 2671179  | COOL-DOWN       | 64       | Next run in 9.3s
Trader DOGE-USD      | 2654248  | RUNNING         | 21       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2671402  | COOL-DOWN       | 84       | Next run in 14.7s
Trader LINK-USD      | 2671004  | RUNNING         | 51       | Evaluating Funnel/Polling Order
```
