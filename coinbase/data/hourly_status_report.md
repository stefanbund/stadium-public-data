...
> **Report Generated**: `2026-08-28 03:39:40 PM PDT (2026-08-28 22:39:40 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.42** | **-0.50** | **-0.92** | **+1.28** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.48** | **-0.50** | **-0.98** | **+13.02** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.42** | **-0.50** | **-0.92** | **+1.39** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.42** | **-0.50** | **-0.92** | **+1.22** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.42** | **-0.50** | **-0.92** | **+1.12** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.42** | **-0.50** | **-0.92** | **+1.37** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.42** | **-0.50** | **-0.92** | **+0.98** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (6.79h old) | 08-28 08:52 |
| ✅ | **TimesFM Forecasts** | Fresh (2.80h old) | 08-28 12:51 |
| ❌ | **Holding Times config** | STALE! (174.6h old) | Limit 116.7h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-28 15:39 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 15:39 |
| ❌ | **Live Trading Telemetry** | STALE! (1.8h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 501 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `20,147` | **100.0%** |
...
| `SOL-USD` | SELL | 104.04 | `51d68866-f2ce-48e4-913d-09011694cee2` |
...
| `LINK-USD` | BUY | 11.387 | `684da257-cbbc-4e64-bf8c-305bf8818e53` |
| `BTC-USD` | BUY | 77550.94 | `e6c8bf80-91cc-43e3-a70a-d1259dbcb84c` |
| `DOGE-USD` | BUY | 0.08499 | `cee6b65c-7ddf-4a87-943f-73f11fd5d880` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.8h ago (2026-08-28 12:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **51.3h (2d 3h 20m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-28 08:52:07 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **50.3h (2d 2h 20m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:39:41 PM
...
Trader ETH-USD       | 3262332  | COOL-DOWN       | 119      | Next run in 9.2s
Trader ADA-USD       | 3227165  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3262000  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3261323  | RUNNING         | 18       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 3260978  | RUNNING         | 5        | Evaluating Funnel/Polling Order
```
