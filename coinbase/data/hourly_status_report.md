...
> **Report Generated**: `2026-08-26 07:51:59 AM PDT (2026-08-26 14:51:59 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+5.40** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.33** | **-0.50** | **-0.83** | **+20.69** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+5.39** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+5.39** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+5.53** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+5.39** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+5.53** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (22.83h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (3.02h old) | 08-26 04:51 |
| ❌ | **Holding Times config** | STALE! (118.8h old) | Limit 60.9h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 07:52 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 07:52 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-26 07:52 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1274 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `9,377` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.0h ago (2026-08-26 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **107.1h (4d 11h 7m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **106.1h (4d 10h 7m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  02:51:57 PM
   CPU:  22.9%  |  MEM:   6.2% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 466771   | COOL-DOWN       | 150      | Next run in 14.9s
Trader ETH-USD       | 466772   | COOL-DOWN       | 180      | Next run in 14.9s
Trader ADA-USD       | 466773   | RUNNING         | 152      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 466925   | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 466682   | COOL-DOWN       | 153      | Next run in 9.7s
Trader LINK-USD      | 466926   | RUNNING         | 150      | Evaluating Funnel/Polling Order
```
