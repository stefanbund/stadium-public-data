...
> **Report Generated**: `2026-08-16 04:44:55 PM PDT (2026-08-16 23:44:55 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.12** | **-0.50** | **-1.62** | **+27.65** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.02** | **-0.50** | **+1.52** | **+40.13** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.12** | **-0.50** | **-1.62** | **+27.65** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.12** | **-0.50** | **-1.62** | **+27.65** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.12** | **-0.50** | **-1.62** | **+27.65** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.12** | **-0.50** | **-1.62** | **+27.65** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.12** | **-0.50** | **-1.62** | **+27.65** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (81.60h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.72h old) | 08-16 16:01 |
| ✅ | **Holding Times config** | Fresh (103.09h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 16:45 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-16 16:44 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 16:45 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `55,654` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.7h ago (2026-08-16 04:01 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **2.3h (0d 2h 15m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **1.2h (0d 1h 14m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:44:57 PM
   CPU:  36.8%  |  MEM:   6.6% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1446653  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1450640  | COOL-DOWN       | 12       | Next run in 14.9s
Trader ETH-USD       | 1450641  | COOL-DOWN       | 12       | Next run in 14.9s
Trader ADA-USD       | 1450642  | COOL-DOWN       | 12       | Next run in 14.9s
Trader DOGE-USD      | 1450643  | COOL-DOWN       | 12       | Next run in 14.9s
Trader BTC-USD       | 1450644  | COOL-DOWN       | 12       | Next run in 14.9s
Trader LINK-USD      | 1450645  | COOL-DOWN       | 12       | Next run in 14.9s
Trader SOL-USD       | 1450646  | COOL-DOWN       | 12       | Next run in 14.9s
================================================================================
```
