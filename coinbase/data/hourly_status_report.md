...
> **Report Generated**: `2026-08-26 10:36:02 AM PDT (2026-08-26 17:36:02 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.56** | **-0.50** | **-1.06** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.38** | **-0.50** | **-0.88** | **+16.71** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.56** | **-0.50** | **-1.06** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.56** | **-0.50** | **-1.06** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.56** | **-0.50** | **-1.06** | **+5.19** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.56** | **-0.50** | **-1.06** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.56** | **-0.50** | **-1.06** | **+5.19** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (25.57h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (2.55h old) | 08-26 08:03 |
| ❌ | **Holding Times config** | STALE! (121.6h old) | Limit 63.6h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 10:36 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 10:36 |
| ❌ | **Live Trading Telemetry** | STALE! (2.7h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 357 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `9,892` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.5h ago (2026-08-26 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **104.4h (4d 8h 23m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **103.4h (4d 7h 23m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:36:00 PM
   CPU:   6.9%  |  MEM:   8.3% (14.1GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 513596   | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 513602   | RUNNING         | -        | Oracle Yield Analysis
Stable Farmer        | 513604   | RUNNING         | -        | Volume Farmer
Trader AVAX-USD      | 513605   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 594705   | RUNNING         | 311      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 513607   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 513608   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 513609   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader LINK-USD      | 513610   | RUNNING         | 0        | Evaluating Funnel/Polling Order
```
...
logs/watchdog_Trader_AVAX_USD.log:2026-08-26 12:30:19 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1007] [AVAX-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_AVAX_USD.log:2026-08-26 12:30:24 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1007] [AVAX-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_AVAX_USD.log:2026-08-26 12:30:30 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1007] [AVAX-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_AVAX_USD.log:2026-08-26 12:30:35 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1007] [AVAX-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
...
logs/watchdog_Trader_LINK_USD.log:2026-08-26 16:04:37 [WARNING] [async_sfgk_trader.py:_execute_api_call:220] [LINK-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_product_book | Sleeping 1.30s... | Error: 500 Server Error: Internal Server E
logs/watchdog_Trader_LINK_USD.log:2026-08-26 16:04:38 [WARNING] [async_sfgk_trader.py:_execute_api_call:220] [LINK-USD] Coinbase API Call Exception (Attempt 2/5). Func: get_product_book | Sleeping 2.10s... | Error: 500 Server Error: Internal Server E
logs/watchdog_Trader_LINK_USD.log:2026-08-26 16:04:40 [WARNING] [async_sfgk_trader.py:_execute_api_call:220] [LINK-USD] Coinbase API Call Exception (Attempt 3/5). Func: get_product_book | Sleeping 4.23s... | Error: 500 Server Error: Internal Server E
...
logs/watchdog_Trader_SOL_USD.log:2026-08-26 00:41:13 [WARNING] [async_sfgk_trader.py:_safe_requests_get:261] [SOL-USD] requests.get Exception (Attempt 1/5). Sleeping 1.39s... | Error: HTTPSConnectionPool(host='api.exchange.coinbase.com', port=443): R
logs/watchdog_Trader_SOL_USD.log:2026-08-26 00:48:44 [WARNING] [async_sfgk_trader.py:_safe_requests_get:261] [SOL-USD] requests.get Exception (Attempt 1/5). Sleeping 1.13s... | Error: HTTPSConnectionPool(host='api.exchange.coinbase.com', port=443): R
logs/watchdog_Trader_SOL_USD.log:2026-08-26 01:08:15 [WARNING] [async_sfgk_trader.py:_safe_requests_get:261] [SOL-USD] requests.get Exception (Attempt 1/5). Sleeping 1.49s... | Error: HTTPSConnectionPool(host='api.exchange.coinbase.com', port=443): R
```
</details>
