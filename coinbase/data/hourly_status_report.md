...
> **Report Generated**: `2026-08-23 05:57:01 AM PDT (2026-08-23 12:57:01 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.53** | **-0.50** | **-1.03** | **+12.32** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+2.68** | **-0.50** | **+3.18** | **+28.18** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.53** | **-0.50** | **-1.03** | **+12.32** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.53** | **-0.50** | **-1.03** | **+12.32** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.53** | **-0.50** | **-1.03** | **+12.32** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.53** | **-0.50** | **-1.03** | **+12.32** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.53** | **-0.50** | **-1.03** | **+12.32** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (10.52h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (5.92h old) | 08-23 00:02 |
| ✅ | **Holding Times config** | Fresh (44.90h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-23 05:57 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 05:56 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 05:56 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `11,396` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 5.9h ago (2026-08-23 12:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **13.0h (0d 13h 2m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **12.0h (0d 12h 2m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:57:01 PM
   CPU:  42.3%  |  MEM:   6.7% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 919336   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 981607   | COOL-DOWN       | 198      | Next run in 14.9s
Trader ETH-USD       | 981608   | COOL-DOWN       | 198      | Next run in 14.9s
Trader ADA-USD       | 981609   | COOL-DOWN       | 198      | Next run in 14.9s
Trader DOGE-USD      | 981610   | COOL-DOWN       | 198      | Next run in 14.9s
Trader BTC-USD       | 981611   | COOL-DOWN       | 198      | Next run in 14.9s
Trader LINK-USD      | 981612   | COOL-DOWN       | 198      | Next run in 14.9s
Trader SOL-USD       | 981614   | COOL-DOWN       | 198      | Next run in 14.9s
================================================================================
```
