...
> **Report Generated**: `2026-09-02 05:51:55 AM PDT (2026-09-02 12:51:55 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-0.66** | **-0.50** | **-0.16** | **+8.33** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.05** | **-0.50** | **+0.45** | **+22.57** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.66** | **-0.50** | **-0.16** | **+8.33** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-0.66** | **-0.50** | **-0.16** | **+8.01** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-0.66** | **-0.50** | **-0.16** | **+8.33** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-0.66** | **-0.50** | **-0.16** | **+8.33** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-0.66** | **-0.50** | **-0.16** | **+8.33** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (41.14h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (0.98h old) | 09-02 04:53 |
| ✅ | **Holding Times config** | Fresh (41.14h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 09-02 05:51 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 09-02 05:51 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-02 05:51 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2071 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `77,169` | **100.0%** |
...
| :--- | :--- | :--- |
| **Daemon Engine** | 🟢 RUNNING | PID `766191` on Live EC2 (CPU: `0.9%`, RAM: `0.2%`) |
...
| **Active SELL Tranches** | **10 Orders** (`$59,549.37 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$59,549.37 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$2,239,134.47 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **44.8% Complete** | `$2,760,865.53 USD` to reach $5,000,000.00 threshold |
...
| `USDT-USD` | 🔴 **SELL** | 0.99938 | 5,000.0 | `$4,996.90` | `fd76fdf2-8690-47d7-9ae8-12db1fd3323d` |
| `USDT-USD` | 🔴 **SELL** | 0.99938 | 5,000.0 | `$4,996.90` | `6066a97a-d47b-4d2b-93aa-a8fd1c0466b9` |
| `USDT-USD` | 🔴 **SELL** | 0.99937 | 5,000.0 | `$4,996.85` | `e5e23567-9775-4aee-8581-96965fbe7274` |
| `USDT-USD` | 🔴 **SELL** | 0.99937 | 5,000.0 | `$4,996.85` | `bb728d6e-c2c2-45fb-acb5-2e118aec5c04` |
| `USDT-USD` | 🔴 **SELL** | 0.99937 | 5,000.0 | `$4,996.85` | `03684e19-203a-4965-ae18-483df9b2b38a` |
| `USDT-USD` | 🔴 **SELL** | 0.99937 | 5,000.0 | `$4,996.85` | `00ad44c3-e96f-4cd5-b5ab-ff2dc6e9e0ee` |
| `USDT-USD` | 🔴 **SELL** | 0.99937 | 5,000.0 | `$4,996.85` | `7a8aa033-b693-4077-b073-fb256be3e7fc` |
| `USDT-USD` | 🔴 **SELL** | 0.99937 | 5,000.0 | `$4,996.85` | `0a99ab0b-5c17-48dd-86fb-598c28775713` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 23392.2700 | 31153.5600 | **54545.8300** |
| `CRV` | 0.0500 | 0.0000 | **0.0500** |
| `DOGE` | 0.1000 | 26511.7000 | **26511.8000** |
...
| `DOGE-USD` | SELL | 0.08145 | 26,511.70 | `c33423bc-78b9-4818-9179-51b10b06f758` |
| `USDT-USD` | SELL | 0.99939 | 5,000.00 | `f9e734a9-e795-428c-ae83-d02b60161e12` |
| `USDT-USD` | SELL | 0.99938 | 5,000.00 | `fd76fdf2-8690-47d7-9ae8-12db1fd3323d` |
| `USDT-USD` | SELL | 0.99938 | 5,000.00 | `6066a97a-d47b-4d2b-93aa-a8fd1c0466b9` |
| `ADA-USD` | BUY | 0.19413 | 3,955.13 | `d2b740b1-4c94-4524-b70e-a47b0278297e` |
| `USDT-USD` | SELL | 0.99937 | 5,000.00 | `c1f0641b-d87e-4695-b626-2286a486df6b` |
| `USDT-USD` | SELL | 0.99937 | 5,000.00 | `745e5ea1-17e6-475d-809b-52411f388902` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-09-02 04:53 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **109.1h (4d 13h 7m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **108.1h (4d 12h 7m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:51:52 PM
   CPU:  18.9%  |  MEM:   7.7% (14.2GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 823841   | RUNNING         | 123      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 823842   | RUNNING         | 144      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 822071   | RUNNING         | 102      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 802549   | RUNNING         | 80       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 823843   | RUNNING         | 146      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 823844   | RUNNING         | 123      | Evaluating Funnel/Polling Order
```
