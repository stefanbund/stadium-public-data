...
> **Report Generated**: `2026-08-30 04:48:47 PM PDT (2026-08-30 23:48:47 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+2.95** | **-0.50** | **+3.45** | **+5.80** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+5.32** | **-0.50** | **+5.82** | **+14.40** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+2.95** | **-0.50** | **+3.45** | **-0.33** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+2.95** | **-0.50** | **+3.45** | **+8.39** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+2.95** | **-0.50** | **+3.45** | **+1.18** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+2.95** | **-0.50** | **+3.45** | **-0.33** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+2.95** | **-0.50** | **+3.45** | **+1.18** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (9.68h old) | 08-30 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.78h old) | 08-30 16:02 |
| ❌ | **Holding Times config** | STALE! (223.8h old) | Limit 165.8h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-30 16:48 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-30 16:48 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-30 16:48 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `39,107` | **100.0%** |
...
| `AVAX-USD` | SELL | 7.115 | `838ffd05-7d39-4af6-bd53-38d3be2cbd39` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.8h ago (2026-08-30 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **2.2h (0d 2h 11m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-30 07:08:16 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **1.2h (0d 1h 10m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:48:46 PM
   CPU:  10.0%  |  MEM:   7.1% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1438755  | RUNNING         | 128      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1441896  | COOL-DOWN       | 95       | Next run in 3.8s
Trader ADA-USD       | 1442088  | COOL-DOWN       | 260      | Next run in 9.1s
Trader DOGE-USD      | 1426313  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1442187  | RUNNING         | 310      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1441897  | COOL-DOWN       | 256      | Next run in 3.8s
```
