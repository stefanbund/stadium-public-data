...
> **Report Generated**: `2026-08-31 10:17:27 PM PDT (2026-09-01 05:17:27 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.60** | **-0.50** | **+1.10** | **+8.05** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.77** | **-0.50** | **-2.27** | **+21.09** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.60** | **-0.50** | **+1.10** | **+8.04** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.60** | **-0.50** | **+1.10** | **+8.06** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.60** | **-0.50** | **+1.10** | **+8.06** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.60** | **-0.50** | **+1.10** | **+8.04** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.60** | **-0.50** | **+1.10** | **+8.06** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (9.56h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (1.42h old) | 08-31 20:52 |
| ✅ | **Holding Times config** | Fresh (9.57h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-31 22:17 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-31 22:17 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-31 22:17 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1929 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `61,232` | **100.0%** |
...
| **Active BUY Tranches** | **3 Orders** (`$14,995.50 USD`) | Resting Limit Bids pegged to Best Bid |
| **Active SELL Tranches** | **5 Orders** (`$24,992.75 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$39,988.25 USD`** | Active bidirectional turnover liquidity pool |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🟢 **BUY** | 0.99970 | 5,000.0 | `$4,998.50` | `79499d45-aacc-4b64-91ef-ffe350a0ead9` |
| `USDT-USD` | 🟢 **BUY** | 0.99970 | 5,000.0 | `$4,998.50` | `7c1b9332-c655-4907-a639-ed2b2e23666c` |
| `USDT-USD` | 🟢 **BUY** | 0.99970 | 5,000.0 | `$4,998.50` | `85fc7f5c-591d-4a66-8537-b98a3b9fb61d` |
| `USDT-USD` | 🔴 **SELL** | 0.99971 | 5,000.0 | `$4,998.55` | `d0315258-4e6e-4bfa-b446-f46cc1b823b2` |
| `USDT-USD` | 🔴 **SELL** | 0.99971 | 5,000.0 | `$4,998.55` | `f074966a-ce67-4d5f-9464-34f25fc9a7dc` |
| `USDT-USD` | 🔴 **SELL** | 0.99971 | 5,000.0 | `$4,998.55` | `c31b2303-0833-4f20-89c3-16da8f207143` |
| `USDT-USD` | 🔴 **SELL** | 0.99971 | 5,000.0 | `$4,998.55` | `c46921ac-cfaa-4a44-8c4d-dcabeceabdc8` |
| `USDT-USD` | 🔴 **SELL** | 0.99971 | 5,000.0 | `$4,998.55` | `f4810b3e-7c12-4171-a9f4-c96692dca33c` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 6290.4200 | 25000.0000 | **31290.4200** |
...
| `ADA-USD` | BUY | 0.20114 | 4,454.50 | `3e597947-9073-4a86-a3d7-3ccd92ca05ad` |
| `LINK-USD` | BUY | 11.43000 | 111.39 | `ca7c8a70-1de7-44af-9a34-0fa06dca8f2a` |
| `USDT-USD` | BUY | 0.99970 | 5,000.00 | `79499d45-aacc-4b64-91ef-ffe350a0ead9` |
| `USDT-USD` | BUY | 0.99970 | 5,000.00 | `7c1b9332-c655-4907-a639-ed2b2e23666c` |
| `USDT-USD` | BUY | 0.99970 | 5,000.00 | `85fc7f5c-591d-4a66-8537-b98a3b9fb61d` |
| `USDT-USD` | SELL | 0.99971 | 5,000.00 | `d0315258-4e6e-4bfa-b446-f46cc1b823b2` |
| `USDT-USD` | SELL | 0.99971 | 5,000.00 | `f074966a-ce67-4d5f-9464-34f25fc9a7dc` |
| `USDT-USD` | SELL | 0.99971 | 5,000.00 | `c31b2303-0833-4f20-89c3-16da8f207143` |
| `USDT-USD` | SELL | 0.99971 | 5,000.00 | `c46921ac-cfaa-4a44-8c4d-dcabeceabdc8` |
| `USDT-USD` | SELL | 0.99971 | 5,000.00 | `f4810b3e-7c12-4171-a9f4-c96692dca33c` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.4h ago (2026-08-31 08:52 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **140.7h (5d 20h 42m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **139.7h (5d 19h 42m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:17:26 AM
   CPU:  10.5%  |  MEM:   6.6% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 3041034  | COOL-DOWN       | 162      | Next run in 14.8s
Trader ETH-USD       | 3041035  | COOL-DOWN       | 205      | Next run in 14.8s
Trader ADA-USD       | 3039870  | RUNNING         | 36       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3040754  | COOL-DOWN       | 164      | Next run in 3.8s
Trader BTC-USD       | 3040935  | COOL-DOWN       | 222      | Next run in 9.3s
Trader LINK-USD      | 3039872  | RUNNING         | 41       | Evaluating Funnel/Polling Order
```
