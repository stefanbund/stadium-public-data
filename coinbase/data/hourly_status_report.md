...
> **Report Generated**: `2026-08-26 07:33:40 AM PDT (2026-08-26 14:33:40 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.12** | **-0.50** | **-0.62** | **+7.02** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.14** | **-0.50** | **-0.64** | **+22.23** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.12** | **-0.50** | **-0.62** | **+7.00** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.12** | **-0.50** | **-0.62** | **+7.03** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.12** | **-0.50** | **-0.62** | **+7.02** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.12** | **-0.50** | **-0.62** | **+7.00** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.12** | **-0.50** | **-0.62** | **+7.02** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (22.53h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (2.71h old) | 08-26 04:51 |
| ❌ | **Holding Times config** | STALE! (118.5h old) | Limit 60.6h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 07:33 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 07:33 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-26 07:33 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 958 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `9,005` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.7h ago (2026-08-26 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **107.4h (4d 11h 26m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **106.4h (4d 10h 26m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  02:33:38 PM
   CPU:  14.0%  |  MEM:   5.5% (14.6GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 450754   | COOL-DOWN       | 98       | Next run in 9.9s
Trader ETH-USD       | 450975   | COOL-DOWN       | 126      | Next run in 14.9s
Trader ADA-USD       | 451163   | RUNNING         | 99       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 450613   | COOL-DOWN       | 98       | Next run in 4.8s
Trader BTC-USD       | 450755   | COOL-DOWN       | 99       | Next run in 9.9s
Trader LINK-USD      | 451164   | RUNNING         | 98       | Evaluating Funnel/Polling Order
```
