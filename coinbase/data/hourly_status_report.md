...
> **Report Generated**: `2026-08-16 08:41:12 PM PDT (2026-08-17 03:41:12 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-3.32** | **-0.50** | **-2.82** | **+22.46** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-4.39** | **-0.50** | **-3.89** | **+33.84** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-3.32** | **-0.50** | **-2.82** | **+22.46** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-3.32** | **-0.50** | **-2.82** | **+22.46** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-3.32** | **-0.50** | **-2.82** | **+22.46** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-3.32** | **-0.50** | **-2.82** | **+22.46** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-3.32** | **-0.50** | **-2.82** | **+22.46** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (85.54h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.00h old) | 08-16 20:41 |
| ✅ | **Holding Times config** | Fresh (107.03h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 20:41 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 20:41 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 20:41 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `60,323` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.7h ago (2026-08-16 04:01 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **166.3h (6d 22h 18m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **165.3h (6d 21h 18m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:41:13 AM
   CPU:  43.0%  |  MEM:   6.1% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1657516  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1657689  | COOL-DOWN       | 1        | Next run in 14.8s
Trader ETH-USD       | 1657690  | COOL-DOWN       | 1        | Next run in 14.8s
Trader ADA-USD       | 1657691  | COOL-DOWN       | 1        | Next run in 14.8s
Trader DOGE-USD      | 1657692  | COOL-DOWN       | 1        | Next run in 14.8s
Trader BTC-USD       | 1657693  | COOL-DOWN       | 1        | Next run in 14.8s
Trader LINK-USD      | 1657694  | COOL-DOWN       | 1        | Next run in 14.8s
Trader SOL-USD       | 1657695  | COOL-DOWN       | 1        | Next run in 14.8s
================================================================================
```
