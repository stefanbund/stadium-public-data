...
> **Report Generated**: `2026-09-01 11:41:56 AM PDT (2026-09-01 18:41:56 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+2.96** | **-0.50** | **+3.46** | **+4.83** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.32** | **-0.50** | **+1.82** | **+16.07** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+2.96** | **-0.50** | **+3.46** | **+3.81** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+2.96** | **-0.50** | **+3.46** | **+4.80** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+2.96** | **-0.50** | **+3.46** | **+3.81** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+2.96** | **-0.50** | **+3.46** | **+4.56** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+2.96** | **-0.50** | **+3.46** | **+3.81** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (22.97h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (3.65h old) | 09-01 08:03 |
| ✅ | **Holding Times config** | Fresh (22.98h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-01 11:42 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-01 11:42 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-01 11:41 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `71,817` | **100.0%** |
...
| **Active BUY Tranches** | **7 Orders** (`$34,986.40 USD`) | Resting Limit Bids pegged to Best Bid |
| **Active SELL Tranches** | **0 Orders** (`$0.00 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$34,986.40 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$2,108,799.60 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **42.2% Complete** | `$2,891,200.40 USD` to reach $5,000,000.00 threshold |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🟢 **BUY** | 0.99956 | 5,000.0 | `$4,997.80` | `ef367153-490d-42ce-a10e-cf965e077742` |
| `USDT-USD` | 🟢 **BUY** | 0.99962 | 5,000.0 | `$4,998.10` | `84b534ce-e7e4-4d13-864f-30f56516117b` |
| `USDT-USD` | 🟢 **BUY** | 0.99962 | 5,000.0 | `$4,998.10` | `74fb02e1-f66d-4ac5-a62f-5f7fd333fb3c` |
| `USDT-USD` | 🟢 **BUY** | 0.99962 | 5,000.0 | `$4,998.10` | `57498541-77b4-48e2-a2a9-8bdd5f3384c9` |
| `USDT-USD` | 🟢 **BUY** | 0.99962 | 5,000.0 | `$4,998.10` | `40ab2c12-b846-4839-a431-b55d1d854799` |
| `USDT-USD` | 🟢 **BUY** | 0.99962 | 5,000.0 | `$4,998.10` | `dbcb00eb-b860-4d0c-a3a4-74e66fa49829` |
| `USDT-USD` | 🟢 **BUY** | 0.99962 | 5,000.0 | `$4,998.10` | `80d096b7-5bef-4dd5-aecd-898bc131f1db` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 8452.1500 | 0.0000 | **8452.1500** |
| `CRV` | 0.0500 | 0.0000 | **0.0500** |
| `DOGE` | 0.0000 | 24761.2000 | **24761.2000** |
...
| `DOGE-USD` | SELL | 0.08142 | 24,761.20 | `057460da-49e1-40f9-82fc-6bbb34f67d03` |
| `USDT-USD` | BUY | 0.99956 | 5,000.00 | `ef367153-490d-42ce-a10e-cf965e077742` |
| `AVAX-USD` | SELL | 7.20400 | 169.43 | `6ad55adf-e444-462b-ad80-e1539bf89a7f` |
| `LINK-USD` | SELL | 11.20200 | 127.92 | `a03abfac-c731-4bb5-8473-73d711e0ad6b` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `a669eb5d-d407-4cd3-ad70-55966f25e02e` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `84b534ce-e7e4-4d13-864f-30f56516117b` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `74fb02e1-f66d-4ac5-a62f-5f7fd333fb3c` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `57498541-77b4-48e2-a2a9-8bdd5f3384c9` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `40ab2c12-b846-4839-a431-b55d1d854799` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `dbcb00eb-b860-4d0c-a3a4-74e66fa49829` |
| `USDT-USD` | BUY | 0.99962 | 5,000.00 | `80d096b7-5bef-4dd5-aecd-898bc131f1db` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.6h ago (2026-09-01 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **127.3h (5d 7h 17m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **126.3h (5d 6h 17m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:41:55 PM
   CPU:  18.8%  |  MEM:   7.8% (14.2GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 3858047  | RUNNING         | 97       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 3866478  | COOL-DOWN       | 36       | Next run in 14.3s
Trader ADA-USD       | 3866479  | COOL-DOWN       | 113      | Next run in 14.3s
Trader DOGE-USD      | 3858298  | RUNNING         | 92       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3866491  | RUNNING         | 119      | Evaluating Funnel/Polling Order
