...
> **Report Generated**: `2026-08-23 11:38:57 AM PDT (2026-08-23 18:38:57 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.19** | **-0.50** | **+0.69** | **+10.67** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.21** | **-0.50** | **+1.71** | **+26.31** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.19** | **-0.50** | **+0.69** | **+10.67** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.19** | **-0.50** | **+0.69** | **+10.67** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.19** | **-0.50** | **+0.69** | **+10.67** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.19** | **-0.50** | **+0.69** | **+10.67** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.19** | **-0.50** | **+0.69** | **+10.67** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (16.22h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (3.62h old) | 08-23 08:02 |
| ✅ | **Holding Times config** | Fresh (50.60h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-23 11:39 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 11:39 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 11:38 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `18,088` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.6h ago (2026-08-23 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **7.3h (0d 7h 20m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **6.3h (0d 6h 20m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:38:55 PM
   CPU:  21.2%  |  MEM:   6.4% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1290197  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1290468  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1290469  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1290470  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1290471  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1290472  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1290473  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1290474  | RUNNING         | 1        | Evaluating Funnel/Polling Order
================================================================================
```
