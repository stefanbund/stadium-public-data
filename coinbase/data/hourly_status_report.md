...
> **Report Generated**: `2026-08-26 03:44:43 PM PDT (2026-08-26 22:44:43 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-0.98** | **-0.50** | **-0.48** | **+6.07** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.45** | **-0.50** | **+0.05** | **+21.79** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.98** | **-0.50** | **-0.48** | **+6.07** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-0.98** | **-0.50** | **-0.48** | **+6.08** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-0.98** | **-0.50** | **-0.48** | **+6.07** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-0.98** | **-0.50** | **-0.48** | **+6.07** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-0.98** | **-0.50** | **-0.48** | **+6.07** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (5.00h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (2.89h old) | 08-26 12:51 |
| ❌ | **Holding Times config** | STALE! (126.7h old) | Limit 68.7h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 15:44 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 15:44 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-26 15:44 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2414 recent read events).
...
- **TimesFM Forecast DB**: 🟢 Updated 2.9h ago (2026-08-26 12:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **99.3h (4d 3h 15m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **98.3h (4d 2h 15m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:44:43 PM
   CPU:   9.8%  |  MEM:   6.5% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 860312   | COOL-DOWN       | 146      | Next run in 14.9s
Trader ETH-USD       | 860032   | COOL-DOWN       | 152      | Next run in 4.5s
Trader ADA-USD       | 860033   | COOL-DOWN       | 122      | Next run in 4.5s
Trader DOGE-USD      | 853221   | RUNNING         | 110      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 860034   | COOL-DOWN       | 152      | Next run in 4.5s
