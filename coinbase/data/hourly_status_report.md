...
> **Report Generated**: `2026-08-27 11:00:07 PM PDT (2026-08-28 06:00:07 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.28** | **-0.50** | **-1.78** | **+7.79** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.06** | **-0.50** | **-1.56** | **+22.64** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.28** | **-0.50** | **-1.78** | **+8.12** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.28** | **-0.50** | **-1.78** | **+7.79** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.28** | **-0.50** | **-1.78** | **+8.12** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.28** | **-0.50** | **-1.78** | **+8.12** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.28** | **-0.50** | **-1.78** | **+8.12** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (13.28h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (2.15h old) | 08-27 20:51 |
| ❌ | **Holding Times config** | STALE! (158.0h old) | Limit 100.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 23:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 23:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 23:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1687 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `11,641` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.1h ago (2026-08-27 08:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **68.0h (2d 19h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **67.0h (2d 18h 59m)**)
...
================================================================================
   ...
   CPU:   5.5%  |  MEM:   5.7% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2450978  | COOL-DOWN       | 12       | Next run in 3.3s
Trader ETH-USD       | 2451013  | COOL-DOWN       | 18       | Next run in 9.4s
Trader ADA-USD       | 2451014  | COOL-DOWN       | 18       | Next run in 9.4s
Trader DOGE-USD      | 2450979  | COOL-DOWN       | 12       | Next run in 3.3s
Trader BTC-USD       | 2451015  | COOL-DOWN       | 18       | Next run in 9.4s
Trader LINK-USD      | 2451016  | COOL-DOWN       | 18       | Next run in 9.4s
```
