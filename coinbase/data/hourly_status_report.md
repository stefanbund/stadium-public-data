...
> **Report Generated**: `2026-08-16 05:39:33 PM PDT (2026-08-17 00:39:33 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.29** | **-0.50** | **-1.79** | **+27.54** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.48** | **-0.50** | **+0.98** | **+40.01** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.29** | **-0.50** | **-1.79** | **+27.54** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.29** | **-0.50** | **-1.79** | **+27.54** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.29** | **-0.50** | **-1.79** | **+27.54** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.29** | **-0.50** | **-1.79** | **+27.54** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.29** | **-0.50** | **-1.79** | **+27.54** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (82.51h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (1.63h old) | 08-16 16:01 |
| ✅ | **Holding Times config** | Fresh (104.00h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-16 17:39 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-16 17:39 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 17:39 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `56,732` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.6h ago (2026-08-16 04:01 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **1.3h (0d 1h 20m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **0.3h (0d 0h 20m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:39:34 AM
   CPU:   2.1%  |  MEM:   5.4% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1446653  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1498282  | COOL-DOWN       | 166      | Next run in 4.6s
Trader ETH-USD       | 1498283  | COOL-DOWN       | 166      | Next run in 4.6s
Trader ADA-USD       | 1498284  | COOL-DOWN       | 166      | Next run in 4.6s
Trader DOGE-USD      | 1498285  | COOL-DOWN       | 166      | Next run in 4.6s
Trader BTC-USD       | 1498286  | COOL-DOWN       | 166      | Next run in 4.6s
Trader LINK-USD      | 1498288  | COOL-DOWN       | 166      | Next run in 4.6s
Trader SOL-USD       | 1498289  | COOL-DOWN       | 166      | Next run in 4.6s
================================================================================
```
