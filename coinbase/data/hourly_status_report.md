...
> **Report Generated**: `2026-08-27 08:25:57 AM PDT (2026-08-27 15:25:57 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.27** | **-0.50** | **+1.77** | **+6.14** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.18** | **-0.50** | **+1.68** | **+20.92** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.27** | **-0.50** | **+1.77** | **+6.34** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.27** | **-0.50** | **+1.77** | **+5.70** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.27** | **-0.50** | **+1.77** | **+6.34** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.27** | **-0.50** | **+1.77** | **+6.25** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.27** | **-0.50** | **+1.77** | **+6.34** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (0.65h old) | 08-27 07:47 |
| ✅ | **TimesFM Forecasts** | Fresh (0.38h old) | 08-27 08:03 |
| ✅ | **Holding Times config** | Fresh (0.65h old) | 08-27 07:47 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 08:26 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 08:26 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 08:25 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 570 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `555` | **100.0%** |
...
| `ETH-USD` | SELL | 2529.75 | `75ff79e9-3168-4136-a34c-e70d8923c478` |
| `USDT-USDC` | BUY | 0.9999 | `0f6e97e7-1308-4d29-bbc6-3dd451137d8a` |
| `USDT-USDC` | BUY | 0.9999 | `f4335bf6-f894-4f1f-9667-589f14a99f72` |
| `USDT-USDC` | BUY | 0.9999 | `890750f5-ad7e-4198-bb0b-e72c2cde47ec` |
| `AVAX-USD` | SELL | 7.545 | `8bbc1007-c121-470e-a08a-86023688de04` |
| `USDT-USDC` | BUY | 0.9999 | `2a1af2e3-6c4c-418b-813a-f27c75716d89` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.4h ago (2026-08-27 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **82.6h (3d 10h 33m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 07:47:00 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **81.6h (3d 9h 33m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:25:55 PM
   CPU:  20.2%  |  MEM:   7.3% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1713500  | RUNNING         | 77       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1715611  | RUNNING         | 84       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1721381  | COOL-DOWN       | 40       | Next run in 15.0s
Trader DOGE-USD      | 1712555  | RUNNING         | 55       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1721382  | COOL-DOWN       | 112      | Next run in 15.0s
Trader LINK-USD      | 1721374  | COOL-DOWN       | 82       | Next run in 9.9s
```
