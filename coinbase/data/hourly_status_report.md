...
> **Report Generated**: `2026-08-27 09:03:06 AM PDT (2026-08-27 16:03:06 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+7.50** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.89** | **-0.50** | **+1.39** | **+22.74** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+6.86** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+7.50** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+7.50** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+7.50** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+7.50** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (1.27h old) | 08-27 07:47 |
| ✅ | **TimesFM Forecasts** | Fresh (1.00h old) | 08-27 08:03 |
| ❌ | **Holding Times config** | STALE! (144.0h old) | Limit 86.1h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 09:03 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 09:03 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 09:03 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1136 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `1,111` | **100.0%** |
...
| `ADA-USD` | SELL | 0.21487 | `29403785-fdab-4280-bdd2-ebddfba78857` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-08-27 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **81.9h (3d 9h 56m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 07:47:00 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **80.9h (3d 8h 56m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:03:06 PM
   CPU:   6.8%  |  MEM:   6.6% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1754124  | COOL-DOWN       | 24       | Next run in 4.7s
Trader ETH-USD       | 1754125  | COOL-DOWN       | 24       | Next run in 4.7s
Trader ADA-USD       | 1750864  | RUNNING         | 15       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1754428  | RUNNING         | 31       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1754429  | RUNNING         | 31       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1752365  | RUNNING         | 25       | Evaluating Funnel/Polling Order
```
