...
> **Report Generated**: `2026-09-02 06:52:21 PM PDT (2026-09-03 01:52:21 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.37** | **-0.50** | **+0.87** | **+8.03** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.03** | **-0.50** | **-0.53** | **+21.85** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.37** | **-0.50** | **+0.87** | **+7.34** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.37** | **-0.50** | **+0.87** | **+8.02** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.37** | **-0.50** | **+0.87** | **+8.02** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.37** | **-0.50** | **+0.87** | **+8.00** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.37** | **-0.50** | **+0.87** | **+8.02** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (11.17h old) | 09-02 07:42 |
| ✅ | **TimesFM Forecasts** | Fresh (2.84h old) | 09-02 16:02 |
| ✅ | **Holding Times config** | Fresh (54.15h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-02 18:52 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-02 18:52 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-02 18:52 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1935 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `86,372` | **100.0%** |
...
| **Active SELL Tranches** | **5 Orders** (`$24,989.00 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$24,989.00 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$2,315,701.37 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **46.3% Complete** | `$2,684,298.63 USD` to reach $5,000,000.00 threshold |
...
| `USDT-USD` | 🔴 **SELL** | 0.99950 | 5,000.0 | `$4,997.50` | `72c7e86f-6e89-4868-b1a0-39fd9f154308` |
| `USDT-USD` | 🔴 **SELL** | 0.99950 | 5,000.0 | `$4,997.50` | `96664130-3de3-4c5e-84b3-7e4d13ec6039` |
| `USDT-USD` | 🔴 **SELL** | 0.99950 | 5,000.0 | `$4,997.50` | `89fb54a2-ef02-490c-98f4-a9d5e0046dae` |
| `USDT-USD` | 🔴 **SELL** | 0.99950 | 5,000.0 | `$4,997.50` | `53620f75-e872-46e7-9ad3-6ecfe71e47f0` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 3947.7900 | 40000.0000 | **43947.7900** |
| `CRV` | 0.0500 | 0.0000 | **0.0500** |
| `ADA` | 0.0000 | 3374.1168 | **3374.1168** |
...
| `ADA-USD` | SELL | 0.20566 | 3,374.12 | `72e86384-76f9-4298-82e3-32fba1523ab6` |
| `ETH-USD` | BUY | 2,381.61000 | 0.24 | `b851a661-e5df-4d1d-af19-f4a62b6660ff` |
| `USDT-USD` | BUY | 0.99949 | 5,000.00 | `648c82e4-ead0-43f6-8b7b-bd85f55fb849` |
| `USDT-USD` | BUY | 0.99949 | 5,000.00 | `0edd029a-8484-4e9d-9f2f-c31874107772` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `947a3a39-d582-4123-8a6f-6994627467cc` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `343ad209-f424-4421-9856-a81352573a23` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `bcc82bd3-acca-4140-8c49-b78ef5d5129b` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `72c7e86f-6e89-4868-b1a0-39fd9f154308` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `96664130-3de3-4c5e-84b3-7e4d13ec6039` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `89fb54a2-ef02-490c-98f4-a9d5e0046dae` |
| `USDT-USD` | SELL | 0.99950 | 5,000.00 | `53620f75-e872-46e7-9ad3-6ecfe71e47f0` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.8h ago (2026-09-02 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **96.1h (4d 0h 7m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-02 07:42:22 AM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **95.1h (3d 23h 7m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:52:18 AM
   CPU:   9.6%  |  MEM:   7.6% (14.2GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1641031  | COOL-DOWN       | 110      | Next run in 14.8s
Trader ETH-USD       | 1640105  | RUNNING         | 140      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1628614  | RUNNING         | 257      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1640922  | COOL-DOWN       | 285      | Next run in 3.9s
Trader BTC-USD       | 1640972  | COOL-DOWN       | 314      | Next run in 9.4s
Trader LINK-USD      | 1633233  | RUNNING         | 140      | Evaluating Funnel/Polling Order
```
