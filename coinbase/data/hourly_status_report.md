...
> **Report Generated**: `2026-08-13 09:09:15 PM PDT (2026-08-14 04:09:15 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+13.75** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.87** | **-0.50** | **-0.37** | **+27.63** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+13.75** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+13.75** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+13.75** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+13.75** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+13.75** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (14.01h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.48h old) | 08-13 20:40 |
| ✅ | **Holding Times config** | Fresh (35.50h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-13 21:09 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-13 21:09 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 21:09 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `2,590` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.5h ago (2026-08-13 08:40 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **69.8h (2d 21h 50m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **68.8h (2d 20h 50m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:09:15 AM
   CPU:   5.2%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2058778  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2085756  | COOL-DOWN       | 90       | Next run in 4.7s
Trader ETH-USD       | 2085757  | COOL-DOWN       | 90       | Next run in 4.7s
Trader ADA-USD       | 2085758  | COOL-DOWN       | 90       | Next run in 4.7s
Trader DOGE-USD      | 2085759  | COOL-DOWN       | 90       | Next run in 4.7s
Trader BTC-USD       | 2085760  | COOL-DOWN       | 90       | Next run in 4.7s
Trader LINK-USD      | 2085761  | COOL-DOWN       | 90       | Next run in 4.7s
Trader SOL-USD       | 2085762  | COOL-DOWN       | 90       | Next run in 4.7s
================================================================================
```
