...
> **Report Generated**: `2026-09-01 11:57:04 PM PDT (2026-09-02 06:57:04 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.04** | **-0.50** | **-1.54** | **+7.74** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.29** | **-0.50** | **+0.21** | **+21.71** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.04** | **-0.50** | **-1.54** | **+7.10** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.04** | **-0.50** | **-1.54** | **+7.66** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.04** | **-0.50** | **-1.54** | **+7.75** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.04** | **-0.50** | **-1.54** | **+7.73** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.04** | **-0.50** | **-1.54** | **+7.75** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (35.22h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (3.07h old) | 09-01 20:53 |
| ✅ | **Holding Times config** | Fresh (35.23h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-01 23:57 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-01 23:57 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-01 23:57 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1764 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `72,549` | **100.0%** |
...
| :--- | :--- | :--- |
| **Daemon Engine** | 🔴 STOPPED | PID `-` on Live EC2 (CPU: `0.0%`, RAM: `0.0%`) |
...
| **Total Deployed U/U Capital** | **`$14,577.52 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$2,202,629.33 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **44.1% Complete** | `$2,797,370.67 USD` to reach $5,000,000.00 threshold |
...
| `DOGE` | 0.1000 | 26966.5000 | **26966.6000** |
...
| `LINK-USD` | SELL | 11.28600 | 101.50 | `eae1cbd2-8853-4d13-9059-785cfaadc43b` |
| `DOGE-USD` | SELL | 0.08195 | 26,966.50 | `cc0c6d1c-b53e-4e30-b411-3e7794527107` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.1h ago (2026-09-01 08:53 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **115.0h (4d 19h 2m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **114.0h (4d 18h 2m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:57:02 AM
   CPU:  23.5%  |  MEM:   7.9% (14.2GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 401662   | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 401780   | RUNNING         | -        | Oracle Yield Analysis
U/U Farmer           | -        | DISABLED        | -        | Excluded from Fee Tier
Trader AVAX-USD      | 453913   | COOL-DOWN       | 121      | Next run in 14.5s
Trader ETH-USD       | 453914   | COOL-DOWN       | 138      | Next run in 14.5s
Trader ADA-USD       | 401783   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 410493   | RUNNING         | 22       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 454086   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 404730   | RUNNING         | 7        | Evaluating Funnel/Polling Order
```
