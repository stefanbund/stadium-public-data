...
> **Report Generated**: `2026-09-02 04:55:37 AM PDT (2026-09-02 11:55:37 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-0.78** | **-0.50** | **-0.28** | **+8.61** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.33** | **-0.50** | **+0.83** | **+23.02** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.78** | **-0.50** | **-0.28** | **+8.61** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-0.78** | **-0.50** | **-0.28** | **+8.61** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-0.78** | **-0.50** | **-0.28** | **+8.61** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-0.78** | **-0.50** | **-0.28** | **+8.61** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-0.78** | **-0.50** | **-0.28** | **+8.61** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (40.20h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (0.04h old) | 09-02 04:53 |
| ✅ | **Holding Times config** | Fresh (40.20h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-02 04:55 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-02 04:55 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-02 04:55 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `76,275` | **100.0%** |
...
| **Active SELL Tranches** | **8 Orders** (`$49,556.67 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$49,556.67 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$2,236,127.39 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **44.7% Complete** | `$2,763,872.61 USD` to reach $5,000,000.00 threshold |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🔴 **SELL** | 0.99939 | 5,000.0 | `$4,996.95` | `a88efa31-fc17-4ebd-8068-7d66c0e5b836` |
...
| `USDT-USD` | 🔴 **SELL** | 0.99939 | 5,000.0 | `$4,996.95` | `c9eb71a7-64e8-419e-b54b-2750896294cb` |
| `USDT-USD` | 🔴 **SELL** | 0.99939 | 5,000.0 | `$4,996.95` | `f113659c-3907-4f2c-a8f8-46dcc8993044` |
| `USDT-USD` | 🔴 **SELL** | 0.99939 | 5,000.0 | `$4,996.95` | `6c16a7b4-83c7-43eb-ac82-35f4c3bce554` |
| `USDT-USD` | 🔴 **SELL** | 0.99939 | 5,000.0 | `$4,996.95` | `37ff2b63-2e76-462d-ae83-caf80da2cf00` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 17541.2800 | 33739.3600 | **51280.6400** |
...
| `USDT-USD` | SELL | 0.99939 | 5,000.00 | `a88efa31-fc17-4ebd-8068-7d66c0e5b836` |
| `ETH-USD` | SELL | 2,381.02000 | 0.36 | `3b9e3acb-eb83-48f2-ba83-36996d6f69db` |
...
| `USDT-USD` | SELL | 0.99939 | 5,000.00 | `c9eb71a7-64e8-419e-b54b-2750896294cb` |
| `USDT-USD` | SELL | 0.99939 | 5,000.00 | `f113659c-3907-4f2c-a8f8-46dcc8993044` |
| `USDT-USD` | SELL | 0.99939 | 5,000.00 | `6c16a7b4-83c7-43eb-ac82-35f4c3bce554` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.0h ago (2026-09-02 04:53 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **110.1h (4d 14h 4m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **109.1h (4d 13h 4m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:55:33 AM
   CPU:  20.6%  |  MEM:   7.2% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 761913   | COOL-DOWN       | 309      | Next run in 14.0s
Trader ETH-USD       | 748971   | RUNNING         | 118      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 761944   | RUNNING         | 278      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 761562   | COOL-DOWN       | 259      | Next run in 3.4s
Trader BTC-USD       | 761945   | RUNNING         | 318      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 761946   | RUNNING         | 90       | Evaluating Funnel/Polling Order
```
