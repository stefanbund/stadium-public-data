...
> **Report Generated**: `2026-08-24 06:43:03 AM PDT (2026-08-24 13:43:03 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **-1.69** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.11** | **-0.50** | **+0.61** | **+11.24** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **-1.51** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **-2.07** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **-3.54** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **-3.54** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **-3.54** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (5.70h old) | 08-24 01:01 |
| ✅ | **TimesFM Forecasts** | Fresh (5.51h old) | 08-24 01:12 |
| ✅ | **Holding Times config** | Fresh (5.50h old) | 08-24 01:13 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-24 06:43 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-24 06:43 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-24 06:42 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `35,279` | **100.0%** |
...
| `LINK-USD` | 18 | 88.9% | 0 | 🟢 OK |
| `DOGE-USD` | 16 | 93.8% | 0 | 🟢 OK |
| `ADA-USD` | 24 | 95.8% | 0 | 🟢 OK |
...
- **TimesFM Forecast DB**: 🟢 Updated 5.5h ago (2026-08-24 01:12 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-24 01:12:31 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **156.3h (6d 12h 16m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-24 01:01:26 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **155.3h (6d 11h 16m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:43:03 PM
   CPU:   8.5%  |  MEM:   6.9% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2175719  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2271104  | RUNNING         | 237      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2274773  | RUNNING         | 305      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2272113  | RUNNING         | 257      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2274228  | RUNNING         | 278      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2274395  | COOL-DOWN       | 322      | Next run in 9.6s
Trader LINK-USD      | 2274396  | COOL-DOWN       | 210      | Next run in 9.6s
Trader SOL-USD       | 2274397  | COOL-DOWN       | 322      | Next run in 9.6s
================================================================================
```
