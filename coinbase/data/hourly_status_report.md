...
> **Report Generated**: `2026-08-27 05:03:14 AM PDT (2026-08-27 12:03:14 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.59** | **-0.50** | **+2.09** | **+9.10** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.96** | **-0.50** | **+2.46** | **+24.76** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.59** | **-0.50** | **+2.09** | **+9.09** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.59** | **-0.50** | **+2.09** | **+9.08** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.59** | **-0.50** | **+2.09** | **+9.09** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.59** | **-0.50** | **+2.09** | **+9.08** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.59** | **-0.50** | **+2.09** | **+9.09** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (18.31h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (0.20h old) | 08-27 04:51 |
| ❌ | **Holding Times config** | STALE! (140.0h old) | Limit 82.1h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 05:03 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 05:03 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 05:03 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `17,659` | **100.0%** |
...
| `AVAX-USD` | BUY | 7.39 | `321899b5-4d1f-47bc-b35c-0e71b4183f6c` |
| `ETH-USD` | SELL | 2506.06 | `3c658b60-59eb-49d2-b091-885a75330eb7` |
| `AVAX-USD` | SELL | 7.423 | `0a314c9e-c1a0-4474-9fe7-3b014689749c` |
| `DOGE-USD` | SELL | 0.08869 | `00e35130-f301-495d-a21d-d62faaa3fb20` |
| `LINK-USD` | SELL | 11.787 | `65c0c10f-afa9-4178-83c8-a2c0897e4d55` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.2h ago (2026-08-27 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **85.9h (3d 13h 56m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **84.9h (3d 12h 56m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:03:10 PM
   CPU:  18.0%  |  MEM:   6.1% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1549490  | RUNNING         | 22       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1550378  | COOL-DOWN       | 30       | Next run in 14.7s
Trader ADA-USD       | 1550176  | COOL-DOWN       | 30       | Next run in 9.3s
Trader DOGE-USD      | 1550634  | RUNNING         | 30       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1550177  | COOL-DOWN       | 30       | Next run in 9.3s
Trader LINK-USD      | 1550379  | COOL-DOWN       | 30       | Next run in 14.7s
```
