...
> **Report Generated**: `2026-09-26 12:07:47 PM PDT (2026-09-26 19:07:47 UTC)`  
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (115.71h old) | 09-21 16:25 |
| ✅ | **TimesFM Forecasts** | Fresh (4.07h old) | 09-26 08:03 |
| ❌ | **Holding Times config** | STALE! (623.4h old) | Limit 137.1h |
| ❌ | **BTC DVOL Cache** | STALE! (26.1h old) | Limit 0.0h |
| ❌ | **ETH DVOL Cache** | STALE! (26.1h old) | Limit 0.0h |
| ❌ | **Live Causal Telemetry** | STALE! (264.4h old) | Limit 0.5h |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.1h ago (2026-09-26 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-27 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **30.9h (1d 6h 52m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-21 04:25:29 PM PDT`
- **Next Scheduled Run**: `2026-09-27 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **29.9h (1d 5h 51m)**)
...
================================================================================
2713990    02:01:16  0.0  0.0 sudo /opt/hft_trader/venv/bin/python3 -u guardian_causal.py
2714031    02:01:16  0.0  0.0 /opt/hft_trader/venv/bin/python3 -u guardian_causal.py
```
