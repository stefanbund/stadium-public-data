...
> **Report Generated**: `2026-08-16 07:03:54 AM PDT (2026-08-16 14:03:54 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.96** | **-0.50** | **+1.46** | **+30.49** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.45** | **-0.50** | **+1.95** | **+42.78** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.96** | **-0.50** | **+1.46** | **+30.49** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.96** | **-0.50** | **+1.46** | **+30.49** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.96** | **-0.50** | **+1.46** | **+30.49** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.96** | **-0.50** | **+1.46** | **+30.49** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.96** | **-0.50** | **+1.46** | **+30.49** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (71.92h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (2.38h old) | 08-16 04:41 |
| ✅ | **Holding Times config** | Fresh (93.41h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 07:03 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 07:03 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 07:04 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `44,212` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.4h ago (2026-08-16 04:41 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **11.9h (0d 11h 56m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **10.9h (0d 10h 55m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  02:03:55 PM
   CPU:  10.6%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 920473   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 940721   | COOL-DOWN       | 66       | Next run in 9.7s
Trader ETH-USD       | 940722   | COOL-DOWN       | 66       | Next run in 9.7s
Trader ADA-USD       | 940723   | COOL-DOWN       | 66       | Next run in 9.7s
Trader DOGE-USD      | 940724   | COOL-DOWN       | 66       | Next run in 9.7s
Trader BTC-USD       | 940725   | COOL-DOWN       | 66       | Next run in 9.7s
Trader LINK-USD      | 940726   | COOL-DOWN       | 66       | Next run in 9.7s
Trader SOL-USD       | 940727   | COOL-DOWN       | 66       | Next run in 9.7s
================================================================================
```
