...
> **Report Generated**: `2026-08-25 10:00:02 AM PDT (2026-08-25 17:00:02 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.21** | **-0.50** | **-0.71** | **N/A** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-0.86** | **-0.50** | **-0.36** | **+5.37** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.21** | **-0.50** | **-0.71** | **N/A** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.21** | **-0.50** | **-0.71** | **N/A** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.21** | **-0.50** | **-0.71** | **N/A** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.21** | **-0.50** | **-0.71** | **N/A** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.21** | **-0.50** | **-0.71** | **N/A** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (0.97h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (1.95h old) | 08-25 08:03 |
| ✅ | **Holding Times config** | Fresh (0.97h old) | 08-25 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-25 10:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-25 10:00 |
| ❌ | **Live Trading Telemetry** | NOT FOUND ON EC2 | - |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 154 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `153` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.9h ago (2026-08-25 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **129.0h (5d 8h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **128.0h (5d 7h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:00:02 PM
...
Trader ETH-USD       | 3606479  | COOL-DOWN       | 152      | Next run in 10.0s
