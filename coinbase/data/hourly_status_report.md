...
> **Report Generated**: `2026-08-13 08:51:22 PM PDT (2026-08-14 03:51:22 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.48** | **-0.50** | **-0.98** | **+14.05** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.03** | **-0.50** | **-0.53** | **+27.89** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.48** | **-0.50** | **-0.98** | **+14.05** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.48** | **-0.50** | **-0.98** | **+14.05** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.48** | **-0.50** | **-0.98** | **+14.05** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.48** | **-0.50** | **-0.98** | **+14.05** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.48** | **-0.50** | **-0.98** | **+14.05** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (13.71h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.18h old) | 08-13 20:40 |
| ✅ | **Holding Times config** | Fresh (35.20h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-13 20:51 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-13 20:51 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 20:51 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `2,226` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.2h ago (2026-08-13 08:40 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **70.1h (2d 22h 8m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **69.1h (2d 21h 8m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:51:22 AM
   CPU:   5.5%  |  MEM:   5.3% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2058778  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2070092  | COOL-DOWN       | 38       | Next run in 4.8s
Trader ETH-USD       | 2070093  | COOL-DOWN       | 38       | Next run in 4.8s
Trader ADA-USD       | 2070094  | COOL-DOWN       | 38       | Next run in 4.8s
Trader DOGE-USD      | 2070095  | COOL-DOWN       | 38       | Next run in 4.8s
Trader BTC-USD       | 2070096  | COOL-DOWN       | 38       | Next run in 4.8s
Trader LINK-USD      | 2070097  | COOL-DOWN       | 38       | Next run in 4.8s
Trader SOL-USD       | 2070098  | COOL-DOWN       | 38       | Next run in 4.8s
================================================================================
```
