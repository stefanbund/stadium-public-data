...
> **Report Generated**: `2026-08-28 05:50:32 AM PDT (2026-08-28 12:50:32 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.40** | **-0.50** | **-0.90** | **+6.09** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.43** | **-0.50** | **-0.93** | **+20.21** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.40** | **-0.50** | **-0.90** | **+6.49** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.40** | **-0.50** | **-0.90** | **+6.41** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.40** | **-0.50** | **-0.90** | **+6.09** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.40** | **-0.50** | **-0.90** | **+6.09** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.40** | **-0.50** | **-0.90** | **+6.09** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (20.12h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (0.98h old) | 08-28 04:51 |
| ❌ | **Holding Times config** | STALE! (164.8h old) | Limit 106.8h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-28 05:50 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 05:50 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-28 05:50 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `17,127` | **100.0%** |
...
| `USDT-USDC` | BUY | 0.9999 | `d10f7d2a-9c55-4e06-ad23-ad9494ed207a` |
| `USDT-USDC` | BUY | 0.9999 | `3b9fb815-f20f-45f2-ae3e-b19e057e907e` |
| `USDT-USDC` | BUY | 0.9999 | `0e41cff9-d4db-43a4-b66a-f05dbdcb7161` |
| `USDT-USDC` | BUY | 0.9999 | `ba8bf896-24ea-4b96-982e-0505b93dc1f0` |
| `USDT-USDC` | BUY | 0.9999 | `b9419af5-ccc5-435b-bce1-3cd4ee2b8c3b` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-08-28 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **61.2h (2d 13h 9m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **60.2h (2d 12h 9m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:50:31 PM
   CPU:  11.2%  |  MEM:   6.6% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2795030  | COOL-DOWN       | 116      | Next run in 14.8s
Trader ETH-USD       | 2795031  | COOL-DOWN       | 154      | Next run in 14.8s
...
Trader BTC-USD       | 2795007  | COOL-DOWN       | 157      | Next run in 3.9s
Trader LINK-USD      | 2795014  | COOL-DOWN       | 84       | Next run in 9.3s
```
