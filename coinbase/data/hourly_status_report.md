...
> **Report Generated**: `2026-08-26 08:00:07 AM PDT (2026-08-26 15:00:07 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.39** | **-0.50** | **-0.89** | **+19.41** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+5.19** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+5.36** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.52** | **-0.50** | **-1.02** | **+5.19** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (22.97h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (3.15h old) | 08-26 04:51 |
| ❌ | **Holding Times config** | STALE! (119.0h old) | Limit 61.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 08:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 08:00 |
| ❌ | **Live Trading Telemetry** | STALE! (0.1h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1308 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `9,431` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.2h ago (2026-08-26 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **107.0h (4d 10h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **106.0h (4d 9h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:00:04 PM
   CPU:   9.9%  |  MEM:   8.4% (14.1GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 414326   | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 414355   | RUNNING         | -        | Oracle Yield Analysis
Stable Farmer        | 414357   | RUNNING         | -        | Volume Farmer
Trader AVAX-USD      | 469241   | RUNNING         | 156      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 473531   | COOL-DOWN       | 204      | Next run in 14.9s
Trader ADA-USD       | 469161   | RUNNING         | 158      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 469242   | RUNNING         | 157      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 468793   | RUNNING         | 159      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 469162   | RUNNING         | 156      | Evaluating Funnel/Polling Order
```
