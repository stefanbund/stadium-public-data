...
> **Report Generated**: `2026-09-02 10:00:08 AM PDT (2026-09-02 17:00:08 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.30** | **-0.50** | **-0.80** | **+8.42** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.55** | **-0.50** | **-2.05** | **+21.79** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.30** | **-0.50** | **-0.80** | **+7.92** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.30** | **-0.50** | **-0.80** | **+8.54** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.30** | **-0.50** | **-0.80** | **+8.42** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.30** | **-0.50** | **-0.80** | **+7.63** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.30** | **-0.50** | **-0.80** | **+7.92** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (2.30h old) | 09-02 07:42 |
| ✅ | **TimesFM Forecasts** | Fresh (1.95h old) | 09-02 08:03 |
| ✅ | **Holding Times config** | Fresh (45.28h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-02 10:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-02 10:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-02 10:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1375 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `79,354` | **100.0%** |
...
| **Active BUY Tranches** | **1 Orders** (`$4,996.95 USD`) | Resting Limit Bids pegged to Best Bid |
| **Active SELL Tranches** | **1 Orders** (`$4,997.05 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$9,994.00 USD`** | Active bidirectional turnover liquidity pool |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🟢 **BUY** | 0.99939 | 5,000.0 | `$4,996.95` | `e8f8df0a-4703-436a-8da5-06ec26d6c8b6` |
| `USDT-USD` | 🔴 **SELL** | 0.99941 | 5,000.0 | `$4,997.05` | `4722724f-314f-4ac3-9fcc-025ae47f9d38` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 14713.5800 | 30000.0000 | **44713.5800** |
...
| `USDT-USD` | SELL | 0.99941 | 5,000.00 | `c6bd2ecb-dad6-4c05-a2b7-d57826020502` |
| `USDT-USD` | SELL | 0.99941 | 5,000.00 | `2fab63ff-b298-4a36-a152-b87a27fec663` |
| `USDT-USD` | SELL | 0.99941 | 5,000.00 | `065226e4-3e75-4248-a193-a8fcf52a4700` |
| `USDT-USD` | SELL | 0.99941 | 5,000.00 | `1aa335e7-d14e-4ad8-9e19-a36ee81d8e4a` |
| `USDT-USD` | SELL | 0.99941 | 5,000.00 | `d82c30c4-6ba9-458e-893b-e0becd4ef30e` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.9h ago (2026-09-02 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **105.0h (4d 8h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-02 07:42:22 AM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **104.0h (4d 7h 59m)**)
...
================================================================================
   ...
   CPU:  12.9%  |  MEM:   7.2% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1083729  | COOL-DOWN       | 1        | Next run in 9.4s
Trader ETH-USD       | 1051184  | RUNNING         | 59       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1083858  | COOL-DOWN       | 167      | Next run in 14.7s
Trader DOGE-USD      | 1031021  | RUNNING         | 22       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1083730  | COOL-DOWN       | 172      | Next run in 9.4s
