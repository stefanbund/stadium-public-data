...
> **Report Generated**: `2026-08-27 11:03:29 PM PDT (2026-08-28 06:03:29 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.21** | **-0.50** | **-1.71** | **+8.31** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.03** | **-0.50** | **-1.53** | **+22.84** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.21** | **-0.50** | **-1.71** | **+8.32** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.21** | **-0.50** | **-1.71** | **+8.31** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.21** | **-0.50** | **-1.71** | **+8.32** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.21** | **-0.50** | **-1.71** | **+8.32** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.21** | **-0.50** | **-1.71** | **+8.32** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (13.34h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (2.20h old) | 08-27 20:51 |
| ❌ | **Holding Times config** | STALE! (158.0h old) | Limit 100.1h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 23:03 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 23:03 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 23:03 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1713 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `11,704` | **100.0%** |
...
| `USDT-USDC` | BUY | 0.9999 | `7dc09a69-3d6a-4bb1-b673-275716e27b77` |
| `USDT-USDC` | BUY | 0.9999 | `ad70e14c-96d2-4393-945f-968c5480ccc8` |
| `USDT-USDC` | BUY | 0.9999 | `cbf5f769-a410-46e9-8c68-3ea2f929a616` |
| `USDT-USDC` | BUY | 0.9999 | `6a41f462-1dec-46c3-a830-2feacbfe8510` |
| `USDT-USDC` | BUY | 0.9999 | `58bd06f6-c4ed-47f7-bb92-95e1d5ec3e2c` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.2h ago (2026-08-27 08:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **67.9h (2d 19h 56m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **66.9h (2d 18h 56m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:03:28 AM
   CPU:  10.7%  |  MEM:   6.0% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2454420  | RUNNING         | 22       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2454207  | COOL-DOWN       | 27       | Next run in 3.9s
Trader ADA-USD       | 2454208  | COOL-DOWN       | 27       | Next run in 3.9s
Trader DOGE-USD      | 2454421  | RUNNING         | 22       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2454209  | COOL-DOWN       | 27       | Next run in 3.9s
Trader LINK-USD      | 2454210  | COOL-DOWN       | 27       | Next run in 3.9s
```
