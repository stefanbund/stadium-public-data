...
Generated at: 2026-08-05 06:00:14 
...
--------------------------------------------------
• DVOL BTC: Close=34.76 | Z-Score=2.70 (Thresh <= 0.5) | RSI=80.7 | Exhaustion=80/100
  Volatility Trend: UPWARD (Expansion)
  Safety Status:    🔴 REJECTED_TOO_RISKY (Vetoed by DAW)
  Veto Rationale:   Volatility Expansion (Z-Score=2.70 > 0.5), High Volatility Toxicity (Exhaustion=80 >= 30)
• DVOL ETH: Close=48.28 | Z-Score=1.65 (Thresh <= 0.5) | RSI=41.6 | Exhaustion=0/100
  Volatility Trend: UPWARD (Expansion)
  Safety Status:    🔴 REJECTED_TOO_RISKY (Vetoed by DAW)
...
--------------------------------------------------
• Report Window (Recent Decisions): 2026-08-05 09:00:27 to 2026-08-05 13:00:07
...
• Rejection Reasons Breakdown:
  - Layer 1: DAW Causal Volatility Veto               : 134839 (13483900.0%)
...
• Time Until Next Optimizer:  109.0 hour(s) (4d 12h 59m)
