...
> **Report Generated**: `2026-09-03 06:36:18 AM PDT (2026-09-03 13:36:18 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.50** | **-0.50** | **+2.00** | **+7.72** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.66** | **-0.50** | **+1.16** | **+21.40** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.50** | **-0.50** | **+2.00** | **+7.67** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.50** | **-0.50** | **+2.00** | **+7.64** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.50** | **-0.50** | **+2.00** | **+7.68** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.50** | **-0.50** | **+2.00** | **+8.00** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.50** | **-0.50** | **+2.00** | **+7.68** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (22.90h old) | 09-02 07:42 |
| ✅ | **TimesFM Forecasts** | Fresh (1.72h old) | 09-03 04:53 |
| ✅ | **Holding Times config** | Fresh (65.88h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-03 06:36 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-03 06:36 |
| ❌ | **Live Trading Telemetry** | STALE! (11.6h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 645 recent read events).
...
- **TimesFM Forecast DB**: 🟢 Updated 1.7h ago (2026-09-03 04:53 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **84.4h (3d 12h 23m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-02 07:42:22 AM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **83.4h (3d 11h 23m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:36:17 PM
   CPU:   4.6%  |  MEM:   5.9% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2233043  | COOL-DOWN       | 161      | Next run in 4.3s
Trader ETH-USD       | 2233044  | COOL-DOWN       | 161      | Next run in 4.3s
Trader ADA-USD       | 2233045  | COOL-DOWN       | 161      | Next run in 4.3s
Trader DOGE-USD      | 2233046  | COOL-DOWN       | 161      | Next run in 4.3s
Trader BTC-USD       | 2233047  | COOL-DOWN       | 161      | Next run in 4.3s
Trader LINK-USD      | 2233048  | COOL-DOWN       | 161      | Next run in 4.3s
```
