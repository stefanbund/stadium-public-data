...
> **Report Generated**: `2026-08-24 08:32:15 AM PDT (2026-08-24 15:32:15 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+2.39** | **-0.50** | **+2.89** | **-4.83** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.29** | **-0.50** | **+0.21** | **+9.50** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+2.39** | **-0.50** | **+2.89** | **-4.75** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+2.39** | **-0.50** | **+2.89** | **-4.73** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+2.39** | **-0.50** | **+2.89** | **-4.98** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+2.39** | **-0.50** | **+2.89** | **-4.50** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+2.39** | **-0.50** | **+2.89** | **-4.98** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.52h old) | 08-24 01:01 |
| ✅ | **TimesFM Forecasts** | Fresh (0.48h old) | 08-24 08:03 |
| ✅ | **Holding Times config** | Fresh (7.32h old) | 08-24 01:13 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-24 08:32 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-24 08:32 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-24 08:32 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `37,136` | **100.0%** |
...
| :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | 18 | 94.4% | 0 | 🟢 OK |
| `LINK-USD` | 21 | 90.5% | 0 | 🟢 OK |
| `DOGE-USD` | 18 | 94.4% | 0 | 🟢 OK |
...
| `LINK-USD` | BUY | 11.71 | `aa411727-27ea-4d26-bf89-edd877a689ed` |
| `DOGE-USD` | BUY | 0.09239 | `f8a04e84-9297-4c91-8218-9d3096d9d3bc` |
| `ADA-USD` | SELL | 0.22582 | `58a6f3a3-3753-4cc3-9ea0-3e5bc8f4c455` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.5h ago (2026-08-24 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-24 01:12:31 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **154.5h (6d 10h 27m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-24 01:01:26 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **153.5h (6d 9h 27m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:32:15 PM
   CPU:   6.5%  |  MEM:   7.3% (14.3GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2279335  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2365092  | RUNNING         | 225      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2369031  | RUNNING         | 263      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2368415  | RUNNING         | 270      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2368416  | RUNNING         | 263      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2368698  | COOL-DOWN       | 291      | Next run in 4.5s
Trader LINK-USD      | 2367831  | RUNNING         | 243      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 2368699  | COOL-DOWN       | 291      | Next run in 4.5s
================================================================================
```
