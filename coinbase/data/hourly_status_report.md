...
> **Report Generated**: `2026-08-26 04:00:10 PM PDT (2026-08-26 23:00:10 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.01** | **-0.50** | **-0.51** | **+5.51** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.51** | **-0.50** | **-0.01** | **+21.80** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.01** | **-0.50** | **-0.51** | **+6.13** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.01** | **-0.50** | **-0.51** | **+6.08** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.01** | **-0.50** | **-0.51** | **+6.13** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.01** | **-0.50** | **-0.51** | **+6.07** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.01** | **-0.50** | **-0.51** | **+6.13** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (5.26h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (3.15h old) | 08-26 12:51 |
| ❌ | **Holding Times config** | STALE! (127.0h old) | Limit 69.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 16:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 16:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-26 16:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2337 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `4,767` | **100.0%** |
...
| `LINK-USD` | SELL | 11.547 | `fb685385-2f31-4f25-a428-38f42c77389a` |
| `DOGE-USD` | SELL | 0.08683 | `3c45ce02-a717-4453-a948-0822249dd0ff` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.1h ago (2026-08-26 12:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **99.0h (4d 2h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **98.0h (4d 1h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:00:10 PM
   CPU:  10.2%  |  MEM:   7.1% (14.3GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 814401   | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 814493   | RUNNING         | -        | Oracle Yield Analysis
Stable Farmer        | 814495   | RUNNING         | -        | Volume Farmer
Trader AVAX-USD      | 872917   | COOL-DOWN       | 190      | Next run in 9.4s
Trader ETH-USD       | 873122   | RUNNING         | 197      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 873123   | RUNNING         | 155      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 853221   | RUNNING         | 110      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 873124   | RUNNING         | 197      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 853719   | RUNNING         | 123      | Evaluating Funnel/Polling Order
```
