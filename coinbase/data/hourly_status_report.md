...
> **Report Generated**: `2026-08-12 03:56:12 PM PDT (2026-08-12 22:56:12 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.84** | **-0.18** (≤ -0.5) | 56.0 | 0/100 (< 30) | Expansion 📈 | 🔴 DAW Vetoed |
| `ETH-USD` | **49.32** | **-1.03** (≤ -0.5) | 33.7 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -0.18$ (Safety Margin: **+0.32** vs. gate $-0.5$) $\rightarrow$ **🔴 DAW VETOED**
> - **ETH-USD**: $Z = -1.03$ (Safety Margin: **-0.53** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (2.59h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (6.28h old) | 08-12 09:39 |
| ✅ | **Holding Times config** | Fresh (6.28h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 15:56 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 15:56 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 15:56 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,986` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 6.3h ago (2026-08-12 09:39 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **99.1h (4d 3h 3m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **98.1h (4d 2h 3m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:56:10 PM
   CPU:  49.8%  |  MEM:   6.7% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 498495   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 536046   | COOL-DOWN       | 128      | Next run in 15.0s
Trader ETH-USD       | 536047   | COOL-DOWN       | 128      | Next run in 15.0s
Trader ADA-USD       | 536048   | COOL-DOWN       | 128      | Next run in 15.0s
Trader DOGE-USD      | 536049   | COOL-DOWN       | 128      | Next run in 15.0s
Trader BTC-USD       | 536050   | COOL-DOWN       | 128      | Next run in 15.0s
Trader LINK-USD      | 536051   | COOL-DOWN       | 128      | Next run in 15.0s
Trader SOL-USD       | 536052   | COOL-DOWN       | 128      | Next run in 15.0s
================================================================================
```
