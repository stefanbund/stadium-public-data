...
> **Report Generated**: `2026-08-31 02:38:03 PM PDT (2026-08-31 21:38:03 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.71** | **-0.50** | **+1.21** | **+2.31** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.63** | **-0.50** | **+1.13** | **+16.69** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.71** | **-0.50** | **+1.21** | **+2.33** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.71** | **-0.50** | **+1.21** | **+2.35** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.71** | **-0.50** | **+1.21** | **+2.37** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.71** | **-0.50** | **+1.21** | **+2.38** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.71** | **-0.50** | **+1.21** | **+2.37** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (1.90h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (1.76h old) | 08-31 12:52 |
| ❌ | **Holding Times config** | STALE! (245.6h old) | Limit 19.6h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-31 14:38 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-31 14:38 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-31 14:37 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2033 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `55,239` | **100.0%** |
...
| `DOGE-USD` | BUY | 0.08319 | `6d11421d-41da-437d-a164-d2c0d260528a` |
| `ADA-USD` | SELL | 0.1995 | `aa657eec-dbed-4e27-9e9d-652479f339a1` |
| `USDT-USD` | BUY | 0.99971 | `716b34ea-c0b9-4f1c-a204-2627871d78f6` |
| `USDT-USD` | BUY | 0.99971 | `f166430a-a685-44ab-9a93-e0ee79407359` |
| `USDT-USD` | SELL | 0.99972 | `31112489-4fa9-4425-99c9-ae9dafc1c2a6` |
| `USDT-USD` | SELL | 0.99972 | `9e39f427-0206-4b32-97fa-46cd77004c71` |
| `USDT-USD` | SELL | 0.99972 | `7f4e99ab-0981-4699-aba2-baa68f580995` |
| `USDT-USD` | SELL | 0.99972 | `75896af7-754b-45fa-b286-87f4401cbde9` |
| `USDT-USD` | SELL | 0.99972 | `7d76ac6c-04c7-4a07-82ba-cfdb582852ab` |
| `USDT-USD` | SELL | 0.99972 | `8cfd0f70-ecc7-45e0-aa3b-10f183c6d0f4` |
| `USDT-USD` | SELL | 0.99972 | `d4b3e1e6-f37d-4bae-abe8-16a883bf579d` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.8h ago (2026-08-31 12:52 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **148.4h (6d 4h 21m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **147.4h (6d 3h 21m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  09:38:04 PM
   CPU:   6.0%  |  MEM:   7.2% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2564968  | RUNNING         | 222      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2566972  | RUNNING         | 225      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2565633  | RUNNING         | 99       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2565634  | RUNNING         | 141      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2566956  | COOL-DOWN       | 279      | Next run in 9.4s
Trader LINK-USD      | 2566907  | COOL-DOWN       | 95       | Next run in 3.8s
```
