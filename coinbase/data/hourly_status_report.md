...
> **Report Generated**: `2026-08-23 10:00:09 AM PDT (2026-08-23 17:00:09 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-0.09** | **-0.50** | **+0.41** | **+10.78** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+2.02** | **-0.50** | **+2.52** | **+26.62** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.09** | **-0.50** | **+0.41** | **+10.78** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-0.09** | **-0.50** | **+0.41** | **+10.78** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-0.09** | **-0.50** | **+0.41** | **+10.78** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-0.09** | **-0.50** | **+0.41** | **+10.78** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-0.09** | **-0.50** | **+0.41** | **+11.09** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (14.58h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (1.97h old) | 08-23 08:02 |
| ✅ | **Holding Times config** | Fresh (48.96h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-23 10:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 10:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 10:00 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `16,194` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.0h ago (2026-08-23 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **9.0h (0d 8h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **8.0h (0d 7h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:00:05 PM
   CPU:  17.9%  |  MEM:   6.2% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1135278  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1200222  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1200223  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1200224  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1200225  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1200226  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1200227  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1200213  | COOL-DOWN       | 203      | Next run in 14.3s
================================================================================
```
