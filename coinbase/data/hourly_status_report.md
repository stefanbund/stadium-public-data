...
> **Report Generated**: `2026-08-12 08:36:08 PM PDT (2026-08-13 03:36:08 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.62** | **-1.77** (≤ -0.5) | 54.3 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.44** | **-0.62** (≤ -0.5) | 77.9 | 60/100 (< 30) | Compression 📉 | 🔴 DAW Vetoed |
...
> - **BTC-USD**: $Z = -1.77$ (Safety Margin: **-1.27** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -0.62$ (Safety Margin: **-0.12** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.25h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (3.37h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (10.94h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 20:36 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 20:36 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 20:36 |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.4h ago (2026-08-12 05:13 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **94.4h (3d 22h 23m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **93.4h (3d 21h 23m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:36:05 AM
   CPU:   2.5%  |  MEM:   6.1% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 709684   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 782245   | COOL-DOWN       | 245      | Next run in 9.9s
Trader ETH-USD       | 782246   | COOL-DOWN       | 245      | Next run in 9.9s
Trader ADA-USD       | 782247   | COOL-DOWN       | 245      | Next run in 9.9s
Trader DOGE-USD      | 782248   | COOL-DOWN       | 245      | Next run in 9.9s
Trader BTC-USD       | 782249   | COOL-DOWN       | 245      | Next run in 9.9s
Trader LINK-USD      | 782250   | COOL-DOWN       | 245      | Next run in 9.9s
Trader SOL-USD       | 782251   | COOL-DOWN       | 245      | Next run in 9.9s
================================================================================
```
