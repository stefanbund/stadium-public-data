...
> **Report Generated**: `2026-08-20 02:04:12 PM PDT (2026-08-20 21:04:12 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.57** | **-0.50** | **+1.07** | **-17.61** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.45** | **-0.50** | **+0.95** | **-33.00** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.57** | **-0.50** | **+1.07** | **-17.48** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.57** | **-0.50** | **+1.07** | **-17.44** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.57** | **-0.50** | **+1.07** | **-46.76** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.57** | **-0.50** | **+1.07** | **-17.54** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.57** | **-0.50** | **+1.07** | **-46.76** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (20.35h old) | 08-19 17:43 |
| ✅ | **TimesFM Forecasts** | Fresh (6.04h old) | 08-20 08:02 |
| ❌ | **Holding Times config** | STALE! (196.4h old) | Limit 168h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-20 14:04 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-20 14:04 |
...
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **76.9h (3d 4h 55m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **75.9h (3d 3h 55m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  09:04:13 PM
   CPU:   1.8%  |  MEM:   8.4% (14.1GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1874568  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1931950  | RUNNING         | 5        | Evaluating Funnel/Polling Order
