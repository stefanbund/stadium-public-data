...
> **Report Generated**: `2026-08-16 09:17:31 PM PDT (2026-08-17 04:17:31 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.48** | **-0.50** | **-1.98** | **+22.65** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-3.01** | **-0.50** | **-2.51** | **+34.15** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.48** | **-0.50** | **-1.98** | **+22.65** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.48** | **-0.50** | **-1.98** | **+22.65** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.48** | **-0.50** | **-1.98** | **+22.65** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.48** | **-0.50** | **-1.98** | **+22.65** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.48** | **-0.50** | **-1.98** | **+22.65** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (86.15h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.61h old) | 08-16 20:41 |
| ✅ | **Holding Times config** | Fresh (107.63h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 21:17 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 21:17 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 21:17 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `61,037` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.6h ago (2026-08-16 08:41 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **165.7h (6d 21h 42m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **164.7h (6d 20h 42m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:17:32 AM
   CPU:  14.5%  |  MEM:   6.0% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1657516  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1689670  | RUNNING         | 104      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1689671  | RUNNING         | 104      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1689672  | RUNNING         | 104      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1689673  | RUNNING         | 104      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1689674  | RUNNING         | 104      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1689675  | RUNNING         | 104      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1689676  | RUNNING         | 104      | Evaluating Funnel/Polling Order
================================================================================
```
