...
> **Report Generated**: `2026-08-12 11:13:21 PM PDT (2026-08-13 06:13:21 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.59** | **-1.57** (≤ -0.5) | 36.8 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.63** | **+0.74** (≤ -0.5) | 88.1 | 40/100 (< 30) | Expansion 📈 | 🔴 DAW Vetoed |
...
> - **BTC-USD**: $Z = -1.57$ (Safety Margin: **-1.07** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = +0.74$ (Safety Margin: **+1.24** vs. gate $-0.5$) $\rightarrow$ **🔴 DAW VETOED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (9.87h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (5.99h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (13.56h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 23:13 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 23:13 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 23:13 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,090` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 6.0h ago (2026-08-12 05:13 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **91.8h (3d 19h 46m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **90.8h (3d 18h 46m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:13:19 AM
   CPU:   9.2%  |  MEM:   5.3% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 920651   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 920656   | COOL-DOWN       | 0        | Next run in 10.0s
Trader ETH-USD       | 920657   | COOL-DOWN       | 0        | Next run in 10.0s
Trader ADA-USD       | 920658   | COOL-DOWN       | 0        | Next run in 10.0s
Trader DOGE-USD      | 920659   | COOL-DOWN       | 0        | Next run in 10.0s
Trader BTC-USD       | 920660   | COOL-DOWN       | 0        | Next run in 10.0s
Trader LINK-USD      | 920661   | COOL-DOWN       | 0        | Next run in 10.0s
Trader SOL-USD       | 920662   | COOL-DOWN       | 0        | Next run in 10.0s
================================================================================
```
