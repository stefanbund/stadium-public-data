...
> **Report Generated**: `2026-08-25 02:19:34 PM PDT (2026-08-25 21:19:34 UTC)`  
...
| `ETH-USD` | DVOL_ETH | **-1.45** | **-0.50** | **-0.95** | **+10.73** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.70** | **-0.50** | **-0.20** | **-4.00** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (5.29h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (1.48h old) | 08-25 12:50 |
| ❌ | **Holding Times config** | STALE! (101.3h old) | Limit 43.3h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-25 14:19 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-25 14:19 |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.5h ago (2026-08-25 12:50 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **124.7h (5d 4h 40m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **123.7h (5d 3h 40m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  09:19:34 PM
...
Trader ETH-USD       | 3808359  | COOL-DOWN       | 267      | Next run in 9.9s
Trader ADA-USD       | 3802318  | RUNNING         | 1        | Evaluating Funnel/Polling Order
