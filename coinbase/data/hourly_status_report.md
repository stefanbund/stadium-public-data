...
> **Report Generated**: `2026-08-13 06:29:18 AM PDT (2026-08-13 13:29:18 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.40** | **-1.21** (≤ -0.5) | 62.2 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **48.91** | **-1.61** (≤ -0.5) | 64.8 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -1.21$ (Safety Margin: **-0.71** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -1.61$ (Safety Margin: **-1.11** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.14h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (5.25h old) | 08-13 01:14 |
| ✅ | **Holding Times config** | Fresh (20.83h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-13 06:28 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-13 06:29 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 06:29 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,651` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 5.3h ago (2026-08-13 01:14 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **84.5h (3d 12h 30m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **83.5h (3d 11h 30m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:29:18 PM
   CPU:   7.2%  |  MEM:   5.9% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1237805  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1304129  | RUNNING         | 224      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1304130  | RUNNING         | 224      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1304131  | RUNNING         | 224      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1304132  | RUNNING         | 224      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1304133  | RUNNING         | 224      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1304134  | RUNNING         | 224      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1304135  | RUNNING         | 224      | Evaluating Funnel/Polling Order
================================================================================
```
