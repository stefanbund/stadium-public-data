...
> **Report Generated**: `2026-08-23 12:50:28 PM PDT (2026-08-23 19:50:28 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.81** | **-0.50** | **+1.31** | **+11.50** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.91** | **-0.50** | **+2.41** | **+27.29** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.81** | **-0.50** | **+1.31** | **+11.50** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.81** | **-0.50** | **+1.31** | **+11.50** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.81** | **-0.50** | **+1.31** | **+11.50** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.81** | **-0.50** | **+1.31** | **+11.50** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.81** | **-0.50** | **+1.31** | **+11.50** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.41h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (4.81h old) | 08-23 08:02 |
| ✅ | **Holding Times config** | Fresh (51.80h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-23 12:50 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 12:50 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-23 12:50 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,460` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.8h ago (2026-08-23 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **6.2h (0d 6h 9m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **5.2h (0d 5h 9m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  07:50:24 PM
   CPU:  40.8%  |  MEM:   6.0% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1359053  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1359261  | COOL-DOWN       | 0        | Next run in 14.9s
Trader ETH-USD       | 1359262  | COOL-DOWN       | 0        | Next run in 14.9s
Trader ADA-USD       | 1359263  | COOL-DOWN       | 0        | Next run in 14.9s
Trader DOGE-USD      | 1359264  | COOL-DOWN       | 0        | Next run in 14.9s
Trader BTC-USD       | 1359265  | COOL-DOWN       | 0        | Next run in 14.9s
Trader LINK-USD      | 1359266  | COOL-DOWN       | 0        | Next run in 14.9s
Trader SOL-USD       | 1359267  | COOL-DOWN       | 0        | Next run in 14.9s
================================================================================
```
