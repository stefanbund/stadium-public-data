...
> **Report Generated**: `2026-08-12 09:46:04 PM PDT (2026-08-13 04:46:04 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.50** | **-2.27** (≤ -0.5) | 23.6 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.26** | **-1.50** (≤ -0.5) | 40.0 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -2.27$ (Safety Margin: **-1.77** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -1.50$ (Safety Margin: **-1.00** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (8.42h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (4.54h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (12.11h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 21:45 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 21:46 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 21:46 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,776` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.5h ago (2026-08-12 05:13 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **93.2h (3d 21h 13m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **92.2h (3d 20h 13m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:46:04 AM
   CPU:  53.9%  |  MEM:   6.5% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 815328   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 844135   | COOL-DOWN       | 98       | Next run in 15.0s
Trader ETH-USD       | 844136   | COOL-DOWN       | 98       | Next run in 15.0s
Trader ADA-USD       | 844137   | COOL-DOWN       | 98       | Next run in 15.0s
Trader DOGE-USD      | 844138   | COOL-DOWN       | 98       | Next run in 15.0s
Trader BTC-USD       | 844139   | COOL-DOWN       | 98       | Next run in 15.0s
Trader LINK-USD      | 844140   | COOL-DOWN       | 98       | Next run in 15.0s
Trader SOL-USD       | 844141   | COOL-DOWN       | 98       | Next run in 15.0s
================================================================================
```
