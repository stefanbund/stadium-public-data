...
> **Report Generated**: `2026-08-28 04:00:24 AM PDT (2026-08-28 11:00:24 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.62** | **-0.50** | **-1.12** | **+6.21** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.56** | **-0.50** | **-1.06** | **+20.50** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.62** | **-0.50** | **-1.12** | **+6.21** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.62** | **-0.50** | **-1.12** | **+6.22** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.62** | **-0.50** | **-1.12** | **+6.22** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.62** | **-0.50** | **-1.12** | **+6.22** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.62** | **-0.50** | **-1.12** | **+5.60** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (18.29h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (3.98h old) | 08-28 00:01 |
| ❌ | **Holding Times config** | STALE! (163.0h old) | Limit 105.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-28 04:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 04:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-28 04:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2060 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `15,672` | **100.0%** |
...
| `USDT-USDC` | BUY | 0.9999 | `8f2b157f-191b-4386-b04b-5a5ab0939d82` |
| `USDT-USDC` | BUY | 0.9999 | `bbb1d47e-edec-445d-b95c-572f67f212e8` |
| `USDT-USDC` | BUY | 0.9999 | `462abd5e-e988-4a49-8374-3b0305e911f6` |
| `USDT-USDC` | BUY | 0.9999 | `a9f4c504-4043-4825-b268-38beaf882811` |
| `USDT-USDC` | BUY | 0.9999 | `f94cb98b-5fb4-4193-9efb-28f0697d9256` |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.0h ago (2026-08-28 12:01 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **63.0h (2d 14h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **62.0h (2d 13h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:00:22 AM
   CPU:  15.9%  |  MEM:   6.2% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2702885  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2702589  | COOL-DOWN       | 174      | Next run in 9.2s
Trader ADA-USD       | 2702590  | COOL-DOWN       | 160      | Next run in 9.2s
Trader DOGE-USD      | 2702886  | RUNNING         | 102      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2702887  | RUNNING         | 186      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 2702888  | RUNNING         | 119      | Evaluating Funnel/Polling Order
```
