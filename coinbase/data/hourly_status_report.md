...
> **Report Generated**: `2026-08-27 10:43:55 PM PDT (2026-08-28 05:43:55 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.13** | **-0.50** | **-1.63** | **+8.11** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.17** | **-0.50** | **-1.67** | **+22.52** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.13** | **-0.50** | **-1.63** | **+8.11** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.13** | **-0.50** | **-1.63** | **+8.11** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.13** | **-0.50** | **-1.63** | **+8.07** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.13** | **-0.50** | **-1.63** | **+8.11** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.13** | **-0.50** | **-1.63** | **+8.07** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (13.01h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (1.88h old) | 08-27 20:51 |
| ❌ | **Holding Times config** | STALE! (157.7h old) | Limit 99.7h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 22:43 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 22:43 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 22:44 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `11,369` | **100.0%** |
...
| `USDT-USDC` | BUY | 0.9999 | `5b093fa1-2216-42b9-ac85-16c13e733c85` |
| `USDT-USDC` | BUY | 0.9999 | `de90a834-510c-4bf4-b5bd-d5f646976cba` |
| `USDT-USDC` | BUY | 0.9999 | `1a4018bb-4781-427e-838d-feb02970d2a6` |
| `USDT-USDC` | BUY | 0.9999 | `d16845c3-461d-4333-ba49-f1da4a450611` |
| `USDT-USDC` | BUY | 0.9999 | `1a9a3d5a-e5d6-4450-a873-5c071e064c6d` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.9h ago (2026-08-27 08:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **68.3h (2d 20h 16m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **67.3h (2d 19h 15m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:43:55 AM
   CPU:  10.5%  |  MEM:   5.8% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2437232  | RUNNING         | 65       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2437233  | RUNNING         | 256      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2435266  | COOL-DOWN       | 87       | Next run in 9.2s
Trader DOGE-USD      | 2437159  | COOL-DOWN       | 87       | Next run in 14.6s
Trader BTC-USD       | 2437050  | COOL-DOWN       | 307      | Next run in 3.9s
Trader LINK-USD      | 2437149  | COOL-DOWN       | 170      | Next run in 9.2s
```
