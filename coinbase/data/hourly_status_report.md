...
> **Report Generated**: `2026-08-28 04:18:47 AM PDT (2026-08-28 11:18:47 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.20** | **-0.50** | **-0.70** | **+6.45** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.50** | **-0.50** | **-1.00** | **+20.47** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.20** | **-0.50** | **-0.70** | **+6.45** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.20** | **-0.50** | **-0.70** | **+6.48** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.20** | **-0.50** | **-0.70** | **+6.45** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.20** | **-0.50** | **-0.70** | **+6.45** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.20** | **-0.50** | **-0.70** | **+6.45** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (18.59h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (4.28h old) | 08-28 00:01 |
| ❌ | **Holding Times config** | STALE! (163.3h old) | Limit 105.3h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-28 04:18 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 04:18 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-28 04:18 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2065 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `15,988` | **100.0%** |
...
| `DOGE-USD` | BUY | 0.08718 | `9732faf3-a58c-42f1-8e19-9ff08300dc8b` |
| `USDT-USDC` | BUY | 0.9999 | `d2ebd3fc-c26e-4bc8-8442-115fba46bc7c` |
| `USDT-USDC` | BUY | 0.9999 | `8e6d1d2c-ef93-416f-a67f-8fa4264280bc` |
| `USDT-USDC` | BUY | 0.9999 | `2d5914ec-ce69-4502-971a-1a1d33290fa1` |
| `USDT-USDC` | BUY | 0.9999 | `8c0280c9-8c8e-405f-b6a5-71f4f97c3e2b` |
| `USDT-USDC` | BUY | 0.9999 | `04860d40-02d1-40e5-80a8-032cbeac5990` |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.3h ago (2026-08-28 12:01 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **62.7h (2d 14h 41m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **61.7h (2d 13h 40m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:18:45 AM
   CPU:  13.7%  |  MEM:   6.8% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2718484  | COOL-DOWN       | 196      | Next run in 14.6s
Trader ETH-USD       | 2718465  | COOL-DOWN       | 225      | Next run in 3.9s
Trader ADA-USD       | 2718499  | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2718466  | RUNNING         | 141      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2718485  | COOL-DOWN       | 237      | Next run in 14.6s
Trader LINK-USD      | 2718467  | COOL-DOWN       | 158      | Next run in 3.9s
```
