...
> **Report Generated**: `2026-08-31 03:00:04 PM PDT (2026-08-31 22:00:04 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.51** | **-0.50** | **+2.01** | **+2.87** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.33** | **-0.50** | **+0.83** | **+16.84** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.51** | **-0.50** | **+2.01** | **+2.87** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.51** | **-0.50** | **+2.01** | **+2.87** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.51** | **-0.50** | **+2.01** | **+2.87** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.51** | **-0.50** | **+2.01** | **+2.40** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.51** | **-0.50** | **+2.01** | **+2.87** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (2.27h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (2.13h old) | 08-31 12:52 |
| ❌ | **Holding Times config** | STALE! (246.0h old) | Limit 20.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-31 14:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-31 14:59 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-31 15:00 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `55,553` | **100.0%** |
...
| `USDT-USD` | BUY | 0.99967 | `ff7d18a2-dce0-45c1-8588-01464e763eda` |
| `USDT-USD` | BUY | 0.99967 | `a4a4b698-ac5d-485a-9d3a-5a156a3950c6` |
| `USDT-USD` | BUY | 0.99967 | `0b738d67-c20f-47e1-be23-f2ef6b9096c2` |
| `USDT-USD` | BUY | 0.99967 | `3c7e65e4-fbc3-4534-9dc4-4af4c1252a05` |
| `USDT-USD` | BUY | 0.99967 | `53e6931f-5946-4d86-890c-7dcf704ae855` |
| `USDT-USD` | BUY | 0.99967 | `aadd7fa7-7d77-4277-9e49-b85cedad0a3e` |
| `USDT-USD` | BUY | 0.99967 | `ec38c0f8-a2a9-43f8-b982-c2cb7e024839` |
| `USDT-USD` | BUY | 0.99967 | `186669fe-1186-45f3-a113-705842f9ee4b` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.1h ago (2026-08-31 12:52 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **148.0h (6d 3h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **147.0h (6d 2h 59m)**)
...
================================================================================
   ...
   CPU:  21.7%  |  MEM:   7.4% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2591397  | RUNNING         | 7        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2591398  | RUNNING         | 7        | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2591399  | RUNNING         | 7        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2591400  | RUNNING         | 7        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2591401  | RUNNING         | 7        | Evaluating Funnel/Polling Order
