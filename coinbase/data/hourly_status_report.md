...
> **Report Generated**: `2026-08-12 10:24:27 AM PDT (2026-08-12 17:24:27 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.84** | **-0.58** (≤ -0.5) | 50.6 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.61** | **+0.65** (≤ -0.5) | 55.5 | 0/100 (< 30) | Expansion 📈 | 🔴 DAW Vetoed |
...
> - **BTC-USD**: $Z = -0.58$ (Safety Margin: **-0.08** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = +0.65$ (Safety Margin: **+1.15** vs. gate $-0.5$) $\rightarrow$ **🔴 DAW VETOED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (0.75h old) | 08-12 09:39 |
| ✅ | **TimesFM Forecasts** | Fresh (0.75h old) | 08-12 09:39 |
| ✅ | **Holding Times config** | Fresh (0.75h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-12 10:24 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-12 10:24 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 10:24 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,219` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.7h ago (2026-08-12 09:39 AM PDT)
- **Last Weekly VSTEF Optimization**: `Never`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **104.6h (4d 8h 35m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-11 10:42:12 AM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **103.6h (4d 7h 35m)**)
