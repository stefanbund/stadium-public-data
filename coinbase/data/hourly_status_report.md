...
> **Report Generated**: `2026-08-13 10:34:18 AM PDT (2026-08-13 17:34:18 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.27** | **-1.35** (≤ -0.5) | 36.7 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **48.73** | **-1.44** (≤ -0.5) | 51.0 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -1.35$ (Safety Margin: **-0.85** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -1.44$ (Safety Margin: **-0.94** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (21.22h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (1.34h old) | 08-13 09:14 |
| ✅ | **Holding Times config** | Fresh (24.91h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-13 10:34 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-13 10:34 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 10:34 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,587` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.3h ago (2026-08-13 09:14 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **80.4h (3d 8h 25m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **79.4h (3d 7h 25m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:34:16 PM
   CPU:   5.1%  |  MEM:   5.5% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1499840  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1521529  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1521530  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1521531  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1521532  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1521533  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1521534  | RUNNING         | 72       | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1521535  | RUNNING         | 72       | Evaluating Funnel/Polling Order
================================================================================
```
