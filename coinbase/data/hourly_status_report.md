...
> **Report Generated**: `2026-08-31 02:57:00 PM PDT (2026-08-31 21:57:00 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.56** | **-0.50** | **+1.06** | **+2.48** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.39** | **-0.50** | **+0.89** | **+16.70** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.56** | **-0.50** | **+1.06** | **+2.49** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.56** | **-0.50** | **+1.06** | **+2.49** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.56** | **-0.50** | **+1.06** | **+2.49** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.56** | **-0.50** | **+1.06** | **+2.40** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.56** | **-0.50** | **+1.06** | **+2.49** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (2.22h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (2.08h old) | 08-31 12:52 |
| ❌ | **Holding Times config** | STALE! (245.9h old) | Limit 20.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-31 14:56 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-31 14:56 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-31 14:56 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `55,505` | **100.0%** |
...
| `USDT-USD` | BUY | 0.99967 | `caefce0b-4e54-42a5-92e8-8336524e5c5b` |
| `USDT-USD` | SELL | 0.99969 | `82f94486-86f6-4d34-89c2-e7187ceaf003` |
| `USDT-USD` | SELL | 0.99969 | `b03ed6e2-a0d6-47d7-89f1-ddcf912298bf` |
| `USDT-USD` | SELL | 0.99969 | `b59d3419-7834-432d-99ca-a765c7dd6416` |
| `USDT-USD` | SELL | 0.99969 | `c6a21799-e3c4-4362-8f4f-e0a5fad60005` |
| `USDT-USD` | SELL | 0.99969 | `1762226e-268a-4f71-a994-9eb6c11dc8d8` |
| `USDT-USD` | SELL | 0.99969 | `2d197cc6-cd20-483e-bf65-211e7b4aab1b` |
...
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **148.0h (6d 4h 2m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **147.0h (6d 3h 2m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  09:56:46 PM
   CPU:  20.3%  |  MEM:   6.1% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2586735  | COOL-DOWN       | 273      | Next run in 3.6s
Trader ETH-USD       | 2586736  | COOL-DOWN       | 276      | Next run in 3.6s
Trader ADA-USD       | 2586911  | COOL-DOWN       | 123      | Next run in 8.9s
Trader DOGE-USD      | 2587094  | COOL-DOWN       | 179      | Next run in 14.7s
Trader BTC-USD       | 2587095  | COOL-DOWN       | 331      | Next run in 14.7s
Trader LINK-USD      | 2570568  | RUNNING         | 98       | Evaluating Funnel/Polling Order
```
