...
> **Report Generated**: `2026-08-16 06:15:41 PM PDT (2026-08-17 01:15:41 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.06** | **-0.50** | **-1.56** | **+26.86** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-3.47** | **-0.50** | **-2.97** | **+39.07** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.06** | **-0.50** | **-1.56** | **+26.86** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.06** | **-0.50** | **-1.56** | **+26.86** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.06** | **-0.50** | **-1.56** | **+26.86** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.06** | **-0.50** | **-1.56** | **+26.86** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.06** | **-0.50** | **-1.56** | **+26.86** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (83.12h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (2.23h old) | 08-16 16:01 |
| ✅ | **Holding Times config** | Fresh (104.60h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-16 18:15 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-16 18:15 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 18:15 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `57,446` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.2h ago (2026-08-16 04:01 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **0.7h (0d 0h 44m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **167.7h (6d 23h 44m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:15:38 AM
   CPU:   5.3%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1446653  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1529486  | COOL-DOWN       | 268      | Next run in 4.5s
Trader ETH-USD       | 1529487  | COOL-DOWN       | 268      | Next run in 4.5s
Trader ADA-USD       | 1529488  | COOL-DOWN       | 268      | Next run in 4.5s
Trader DOGE-USD      | 1529489  | COOL-DOWN       | 268      | Next run in 4.5s
Trader BTC-USD       | 1529490  | COOL-DOWN       | 268      | Next run in 4.5s
Trader LINK-USD      | 1529491  | COOL-DOWN       | 268      | Next run in 4.5s
Trader SOL-USD       | 1529492  | COOL-DOWN       | 268      | Next run in 4.5s
================================================================================
```
