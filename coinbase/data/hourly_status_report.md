...
> **Report Generated**: `2026-09-01 04:58:14 PM PDT (2026-09-01 23:58:14 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.24** | **-0.50** | **+0.74** | **+9.20** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.82** | **-0.50** | **+2.32** | **+23.23** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.24** | **-0.50** | **+0.74** | **+9.33** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.24** | **-0.50** | **+0.74** | **+8.62** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.24** | **-0.50** | **+0.74** | **+9.33** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.24** | **-0.50** | **+0.74** | **+8.78** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.24** | **-0.50** | **+0.74** | **+9.28** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (28.24h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (0.94h old) | 09-01 16:02 |
| ✅ | **Holding Times config** | Fresh (28.25h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-01 16:58 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-01 16:58 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 09-01 16:57 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1741 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `75,795` | **100.0%** |
...
| **Active BUY Tranches** | **6 Orders** (`$29,982.30 USD`) | Resting Limit Bids pegged to Best Bid |
| **Active SELL Tranches** | **0 Orders** (`$0.00 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$29,982.30 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$2,155,088.71 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **43.1% Complete** | `$2,844,911.29 USD` to reach $5,000,000.00 threshold |
...
| `USDT-USD` | 🟢 **BUY** | 0.99944 | 5,000.0 | `$4,997.20` | `47f88bb9-f7bb-45cc-8d6f-770b6d431998` |
| `USDT-USD` | 🟢 **BUY** | 0.99944 | 5,000.0 | `$4,997.20` | `e807dca2-beb4-49a6-9d3b-66489971aa58` |
| `USDT-USD` | 🟢 **BUY** | 0.99944 | 5,000.0 | `$4,997.20` | `76dff0ee-7219-4d2c-8174-e684323ceb13` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 10901.8000 | 0.0000 | **10901.8000** |
...
| `USDT-USD` | BUY | 0.99944 | 5,000.00 | `9a9141b6-45b1-4e12-9c85-919271fd76b7` |
...
| `USDT-USD` | BUY | 0.99944 | 5,000.00 | `97cbe43c-cf22-43c4-922e-0f2847f0e2b8` |
| `USDT-USD` | BUY | 0.99944 | 5,000.00 | `47f88bb9-f7bb-45cc-8d6f-770b6d431998` |
| `USDT-USD` | BUY | 0.99944 | 5,000.00 | `e807dca2-beb4-49a6-9d3b-66489971aa58` |
| `USDT-USD` | BUY | 0.99944 | 5,000.00 | `76dff0ee-7219-4d2c-8174-e684323ceb13` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.9h ago (2026-09-01 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **122.0h (5d 2h 1m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **121.0h (5d 1h 1m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:57:53 PM
   CPU:   5.3%  |  MEM:   7.2% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 8846     | RUNNING         | 131      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 10791    | COOL-DOWN       | 280      | Next run in 4.1s
Trader ADA-USD       | 11056    | RUNNING         | 134      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3287     | RUNNING         | 168      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 10792    | COOL-DOWN       | 332      | Next run in 4.1s
Trader LINK-USD      | 3425     | RUNNING         | 120      | Evaluating Funnel/Polling Order
```
