...
> **Report Generated**: `2026-08-28 12:38:02 AM PDT (2026-08-28 07:38:02 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.51** | **-0.50** | **-1.01** | **+8.44** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.24** | **-0.50** | **-0.74** | **+22.95** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.51** | **-0.50** | **-1.01** | **+8.33** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.51** | **-0.50** | **-1.01** | **+8.21** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.51** | **-0.50** | **-1.01** | **+8.21** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.51** | **-0.50** | **-1.01** | **+8.15** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.51** | **-0.50** | **-1.01** | **+8.21** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (14.91h old) | 08-27 09:43 |
| ✅ | **TimesFM Forecasts** | Fresh (0.60h old) | 08-28 00:01 |
| ❌ | **Holding Times config** | STALE! (159.6h old) | Limit 101.6h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-28 00:37 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 00:37 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-28 00:38 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1742 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `12,752` | **100.0%** |
...
| `USDT-USDC` | BUY | 0.9999 | `327cd115-bb8c-4026-91ef-80ad9ee21a05` |
| `USDT-USDC` | BUY | 0.9999 | `0059ecba-a3ab-4e4c-be97-268c311ad692` |
| `USDT-USDC` | BUY | 0.9999 | `c9fca33e-7798-44a4-b21e-6ad25d5fa9e8` |
| `USDT-USDC` | BUY | 0.9999 | `8d997d77-b8f2-4fa1-a5e5-2157a78fc2e0` |
| `USDT-USDC` | BUY | 0.9999 | `c1887799-1e89-4f77-b4f8-d4d4d22f9acf` |
| `AVAX-USD` | SELL | 7.439 | `cd689157-2f2d-41ca-8dd2-f6e4cd59fc93` |
| `ADA-USD` | BUY | 0.2088 | `a04ab73c-b2ac-4006-8463-d4c60005b9c4` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.6h ago (2026-08-28 12:01 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **66.4h (2d 18h 21m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 09:43:18 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **65.4h (2d 17h 21m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  07:38:00 AM
   CPU:  16.2%  |  MEM:   7.6% (14.2GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2526857  | RUNNING         | 266      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2531166  | RUNNING         | 116      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2529943  | RUNNING         | 264      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2531167  | RUNNING         | 96       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2531168  | RUNNING         | 121      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 2530894  | COOL-DOWN       | 92       | Next run in 3.7s
```
