...
Generated at: 2026-08-02 23:00:07 
...
--------------------------------------------------
• DVOL BTC: Close=35.75 | Z-Score=2.60 (Thresh <= 0.5) | RSI=46.4 | Exhaustion=40/100
  Volatility Trend: UPWARD (Expansion)
  Safety Status:    🔴 REJECTED_TOO_RISKY (Vetoed by DAW)
  Veto Rationale:   Volatility Expansion (Z-Score=2.60 > 0.5), High Volatility Toxicity (Exhaustion=40 >= 30)
• DVOL ETH: Close=50.24 | Z-Score=0.56 (Thresh <= 0.5) | RSI=66.4 | Exhaustion=20/100
  Volatility Trend: DOWNWARD (Compression)
  Safety Status:    🔴 REJECTED_TOO_RISKY (Vetoed by DAW)
  Veto Rationale:   Volatility Expansion (Z-Score=0.56 > 0.5)
...
--------------------------------------------------
• Report Window (Recent Decisions): 2026-08-03 02:00:11 to 2026-08-03 05:59:57
...
• Rejection Reasons Breakdown:
  - Layer 1: DAW Causal Volatility Veto               : 124896 (12489600.0%)
...
• Time Until Next Optimizer:  164.0 hour(s) (6d 19h 59m)
