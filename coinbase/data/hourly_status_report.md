...
> **Report Generated**: `2026-08-13 12:37:03 PM PDT (2026-08-13 19:37:03 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.15** | **-1.81** (≤ -0.5) | 36.0 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **48.52** | **-1.67** (≤ -0.5) | 43.1 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **ETH-USD**: $Z = -1.67$ (Safety Margin: **-1.17** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (23.27h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (3.38h old) | 08-13 09:14 |
| ✅ | **Holding Times config** | Fresh (26.96h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-13 12:36 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-13 12:36 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 12:37 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,805` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.4h ago (2026-08-13 09:14 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **78.4h (3d 6h 22m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **77.4h (3d 5h 22m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  07:37:04 PM
   CPU:   2.3%  |  MEM:   5.4% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1556789  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1629618  | COOL-DOWN       | 245      | Next run in 9.9s
Trader ETH-USD       | 1629449  | COOL-DOWN       | 245      | Next run in 4.8s
Trader ADA-USD       | 1629450  | COOL-DOWN       | 245      | Next run in 4.8s
Trader DOGE-USD      | 1629451  | COOL-DOWN       | 245      | Next run in 4.8s
Trader BTC-USD       | 1629452  | COOL-DOWN       | 245      | Next run in 4.8s
Trader LINK-USD      | 1629619  | COOL-DOWN       | 245      | Next run in 9.9s
Trader SOL-USD       | 1629453  | COOL-DOWN       | 245      | Next run in 4.8s
================================================================================
```
