...
> **Report Generated**: `2026-08-26 03:00:04 AM PDT (2026-08-26 10:00:04 UTC)`  
...
| `ETH-USD` | DVOL_ETH | **-2.46** | **-0.50** | **-1.96** | **+14.63** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.97h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (2.97h old) | 08-26 00:01 |
| ❌ | **Holding Times config** | STALE! (114.0h old) | Limit 56.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 03:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 03:00 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `7,597` | **100.0%** |
...
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **112.0h (4d 15h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **111.0h (4d 14h 59m)**)
...
================================================================================
   ...
   CPU:   1.4%  |  MEM:   8.2% (14.1GB / 15.4GB Free)
================================================================================
...
Trader ETH-USD       | 234303   | COOL-DOWN       | 27       | Next run in 4.9s
