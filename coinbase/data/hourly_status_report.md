...
> **Report Generated**: `2026-08-28 03:57:56 PM PDT (2026-08-28 22:57:56 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.41** | **-0.50** | **-0.91** | **+1.28** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.44** | **-0.50** | **-0.94** | **+12.91** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.41** | **-0.50** | **-0.91** | **+1.39** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.41** | **-0.50** | **-0.91** | **+1.22** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.41** | **-0.50** | **-0.91** | **+1.12** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.41** | **-0.50** | **-0.91** | **+1.37** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.41** | **-0.50** | **-0.91** | **+0.08** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.10h old) | 08-28 08:52 |
| ✅ | **TimesFM Forecasts** | Fresh (3.11h old) | 08-28 12:51 |
| ❌ | **Holding Times config** | STALE! (174.9h old) | Limit 117.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-28 15:57 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-28 15:57 |
| ❌ | **Live Trading Telemetry** | STALE! (2.1h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 517 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `20,191` | **100.0%** |
...
| `SOL-USD` | SELL | 104.32 | `ae3b59e2-9db8-4cee-ac6e-126dadcf2105` |
...
| `DOGE-USD` | BUY | 0.08499 | `bdcbd708-72ea-4dd1-8645-5f45f0a2ff42` |
| `ADA-USD` | BUY | 0.20205 | `9cf31435-f982-4e3b-820b-b64e2a66e905` |
| `AVAX-USD` | BUY | 7.294 | `56021f93-68f8-4df8-8913-f49fd724192e` |
| `LINK-USD` | BUY | 11.424 | `201c0a40-d1f8-4843-bf8d-f52d5f8a3b8e` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.1h ago (2026-08-28 12:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **51.0h (2d 3h 2m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-28 08:52:07 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **50.0h (2d 2h 1m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:57:56 PM
   CPU:  10.8%  |  MEM:   8.5% (14.1GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 3276027  | RUNNING         | 2        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 3276613  | RUNNING         | 164      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 3275682  | RUNNING         | 3        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3275435  | RUNNING         | 8        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3276614  | RUNNING         | 26       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 3276081  | RUNNING         | 13       | Evaluating Funnel/Polling Order
```
