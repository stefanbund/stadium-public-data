...
> **Report Generated**: `2026-08-13 03:34:58 AM PDT (2026-08-13 10:34:58 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.30** | **-2.34** (≤ -0.5) | 58.1 | 0/100 (< 30) | Expansion 📈 | 🟢 Approved |
| `ETH-USD` | **48.90** | **-2.90** (≤ -0.5) | 43.3 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -2.34$ (Safety Margin: **-1.84** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -2.90$ (Safety Margin: **-2.40** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (14.23h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (2.35h old) | 08-13 01:14 |
| ✅ | **Holding Times config** | Fresh (17.92h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-13 03:34 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-13 03:34 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 03:35 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,531` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.3h ago (2026-08-13 01:14 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **87.4h (3d 15h 24m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **86.4h (3d 14h 24m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:34:55 AM
   CPU:   4.2%  |  MEM:   5.5% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1132440  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1151244  | RUNNING         | 64       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1151246  | RUNNING         | 64       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1151248  | RUNNING         | 64       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1151250  | RUNNING         | 64       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1151262  | RUNNING         | 64       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1151267  | RUNNING         | 64       | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1151268  | RUNNING         | 64       | Evaluating Funnel/Polling Order
================================================================================
```
