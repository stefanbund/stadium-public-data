...
> **Report Generated**: `2026-08-26 10:00:03 AM PDT (2026-08-26 17:00:03 UTC)`  
...
| `ETH-USD` | DVOL_ETH | **-1.52** | **-0.50** | **-1.02** | **+18.70** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (24.97h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (1.95h old) | 08-26 08:03 |
| ❌ | **Holding Times config** | STALE! (121.0h old) | Limit 63.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 10:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 10:00 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `9,785` | **100.0%** |
...
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **105.0h (4d 8h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **104.0h (4d 7h 59m)**)
...
================================================================================
   ...
   CPU:   5.5%  |  MEM:   8.4% (14.1GB / 15.4GB Free)
================================================================================
...
Trader ETH-USD       | 566725   | COOL-DOWN       | 204      | Next run in 9.9s
