...
> **Report Generated**: `2026-08-16 08:16:06 AM PDT (2026-08-16 15:16:06 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.37** | **-0.50** | **+1.87** | **+30.44** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.49** | **-0.50** | **+0.99** | **+42.63** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.37** | **-0.50** | **+1.87** | **+30.44** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.37** | **-0.50** | **+1.87** | **+30.44** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.37** | **-0.50** | **+1.87** | **+30.44** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.37** | **-0.50** | **+1.87** | **+30.44** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.37** | **-0.50** | **+1.87** | **+30.44** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (73.12h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (0.24h old) | 08-16 08:02 |
| ✅ | **Holding Times config** | Fresh (94.61h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 08:16 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 08:16 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 08:16 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `45,623` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.2h ago (2026-08-16 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **10.7h (0d 10h 43m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **9.7h (0d 9h 43m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:16:03 PM
   CPU:  20.3%  |  MEM:   6.3% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 920473   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1004062  | RUNNING         | 268      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1004063  | RUNNING         | 271      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1003956  | COOL-DOWN       | 268      | Next run in 14.2s
Trader DOGE-USD      | 1004064  | RUNNING         | 268      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1004065  | RUNNING         | 268      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1004066  | RUNNING         | 268      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1004067  | RUNNING         | 268      | Evaluating Funnel/Polling Order
================================================================================
```
