...
> **Report Generated**: `2026-09-03 03:00:06 AM PDT (2026-09-03 10:00:06 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.78** | **-0.50** | **-2.28** | **+7.72** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.23** | **-0.50** | **-0.73** | **+21.40** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.78** | **-0.50** | **-2.28** | **+7.67** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.78** | **-0.50** | **-2.28** | **+7.64** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.78** | **-0.50** | **-2.28** | **+7.68** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.78** | **-0.50** | **-2.28** | **+8.00** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.78** | **-0.50** | **-2.28** | **+7.68** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (19.30h old) | 09-02 07:42 |
| ✅ | **TimesFM Forecasts** | Fresh (2.97h old) | 09-03 00:02 |
| ✅ | **Holding Times config** | Fresh (62.28h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 09-03 03:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-03 03:00 |
| ❌ | **Live Trading Telemetry** | STALE! (8.0h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 966 recent read events).
...
- **TimesFM Forecast DB**: 🟢 Updated 3.0h ago (2026-09-03 12:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **88.0h (3d 15h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-02 07:42:22 AM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **87.0h (3d 14h 59m)**)
...
================================================================================
   ...
   CPU:   4.9%  |  MEM:   6.1% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2067513  | COOL-DOWN       | 1        | Next run in 0.0s
Trader ETH-USD       | 2067514  | COOL-DOWN       | 1        | Next run in 0.0s
Trader ADA-USD       | 2067515  | COOL-DOWN       | 1        | Next run in 0.0s
Trader DOGE-USD      | 2067516  | COOL-DOWN       | 1        | Next run in 0.0s
Trader BTC-USD       | 2067517  | COOL-DOWN       | 1        | Next run in 0.0s
Trader LINK-USD      | 2067518  | COOL-DOWN       | 1        | Next run in 0.0s
```
