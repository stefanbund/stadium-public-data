...
> **Report Generated**: `2026-08-26 06:02:43 AM PDT (2026-08-26 13:02:43 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.08** | **-0.50** | **-0.58** | **+3.83** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.25** | **-0.50** | **-0.75** | **+19.43** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.08** | **-0.50** | **-0.58** | **-4.80** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.08** | **-0.50** | **-0.58** | **-4.80** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.08** | **-0.50** | **-0.58** | **-4.80** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.08** | **-0.50** | **-0.58** | **-4.80** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.08** | **-0.50** | **-0.58** | **-4.80** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (21.01h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (1.20h old) | 08-26 04:51 |
| ❌ | **Holding Times config** | STALE! (117.0h old) | Limit 59.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-26 06:02 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 06:02 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `8,139` | **100.0%** |
...
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **109.0h (4d 12h 57m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **108.0h (4d 11h 57m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:02:42 PM
   CPU:   4.1%  |  MEM:   8.2% (14.2GB / 15.4GB Free)
================================================================================
...
Trader ETH-USD       | 376602   | COOL-DOWN       | 213      | Next run in 9.9s
