...
> **Report Generated**: `2026-08-24 07:00:04 PM PDT (2026-08-25 02:00:04 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.62** | **-0.50** | **+2.12** | **-6.70** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.83** | **-0.50** | **+1.33** | **+7.83** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.62** | **-0.50** | **+2.12** | **-6.85** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.62** | **-0.50** | **+2.12** | **-6.69** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.62** | **-0.50** | **+2.12** | **-6.70** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.62** | **-0.50** | **+2.12** | **-6.70** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.62** | **-0.50** | **+2.12** | **-6.70** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (3.84h old) | 08-24 15:09 |
| ✅ | **TimesFM Forecasts** | Fresh (2.97h old) | 08-24 16:02 |
| ❌ | **Holding Times config** | STALE! (82.0h old) | Limit 24.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-24 19:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-24 19:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-24 18:59 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1389 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `1,516` | **100.0%** |
...
| `ADA-USD` | SELL | 0.22444 | `c822e8ac-c21a-43f0-8987-ea696d9e4114` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.0h ago (2026-08-24 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **144.0h (5d 23h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-24 03:09:32 PM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **143.0h (5d 22h 59m)**)
...
================================================================================
   ...
   CPU:  13.5%  |  MEM:   6.5% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2891398  | COOL-DOWN       | 14       | Next run in 9.1s
Trader ETH-USD       | 2891399  | COOL-DOWN       | 25       | Next run in 9.1s
Trader ADA-USD       | 2885097  | RUNNING         | 9        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2891347  | COOL-DOWN       | 18       | Next run in 3.5s
Trader BTC-USD       | 2891411  | COOL-DOWN       | 31       | Next run in 14.7s
Trader LINK-USD      | 2891412  | COOL-DOWN       | 31       | Next run in 14.7s
```
