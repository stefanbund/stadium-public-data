...
> **Report Generated**: `2026-08-16 10:59:10 AM PDT (2026-08-16 17:59:10 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.32** | **-0.50** | **+0.82** | **+28.83** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.72** | **-0.50** | **-0.22** | **+41.05** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.32** | **-0.50** | **+0.82** | **+28.83** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.32** | **-0.50** | **+0.82** | **+28.83** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.32** | **-0.50** | **+0.82** | **+28.83** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.32** | **-0.50** | **+0.82** | **+28.83** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.32** | **-0.50** | **+0.82** | **+28.83** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (75.84h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (2.95h old) | 08-16 08:02 |
| ✅ | **Holding Times config** | Fresh (97.33h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 10:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 10:59 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 10:59 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `48,829` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.0h ago (2026-08-16 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **8.0h (0d 8h 0m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **7.0h (0d 7h 0m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:59:06 PM
   CPU:   6.1%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1130838  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1146774  | COOL-DOWN       | 52       | Next run in 4.6s
Trader ETH-USD       | 1146775  | COOL-DOWN       | 52       | Next run in 4.6s
Trader ADA-USD       | 1146776  | COOL-DOWN       | 52       | Next run in 4.6s
Trader DOGE-USD      | 1146777  | COOL-DOWN       | 52       | Next run in 4.6s
Trader BTC-USD       | 1146778  | COOL-DOWN       | 52       | Next run in 4.6s
Trader LINK-USD      | 1146779  | COOL-DOWN       | 52       | Next run in 4.6s
Trader SOL-USD       | 1146780  | COOL-DOWN       | 52       | Next run in 4.6s
================================================================================
```
