...
> **Report Generated**: `2026-08-27 07:30:23 AM PDT (2026-08-27 14:30:23 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+8.37** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.96** | **-0.50** | **+1.46** | **+23.79** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+7.93** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+8.24** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+7.92** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+7.93** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+7.92** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (20.77h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (2.65h old) | 08-27 04:51 |
| ❌ | **Holding Times config** | STALE! (142.5h old) | Limit 84.5h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 07:30 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 07:30 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 07:30 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1780 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,662` | **100.0%** |
...
| `ADA-USD` | 12 | 91.7% | 0 | 🟢 OK |
| `BTC-USD` | 1 | 100.0% | 0 | 🟢 OK |
| `AVAX-USD` | 4 | 75.0% | 0 | 🟢 OK |
| `DOGE-USD` | 5 | 100.0% | 0 | 🟢 OK |
...
| `DOGE-USD` | SELL | 0.08883 | `beef4be4-675c-48d3-93d3-4612ca0c4126` |
| `AVAX-USD` | SELL | 7.514 | `1211ed13-9ce1-4b98-9be9-ee71bf5a5046` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.7h ago (2026-08-27 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **83.5h (3d 11h 29m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **82.5h (3d 10h 29m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  02:30:23 PM
   CPU:  15.8%  |  MEM:   6.6% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1670250  | RUNNING         | 57       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1673933  | RUNNING         | 106      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1673763  | COOL-DOWN       | 75       | Next run in 3.9s
Trader DOGE-USD      | 1668708  | RUNNING         | 55       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1673821  | COOL-DOWN       | 106      | Next run in 14.6s
Trader LINK-USD      | 1673764  | COOL-DOWN       | 68       | Next run in 3.9s
```
