...
> **Report Generated**: `2026-08-16 05:03:08 PM PDT (2026-08-17 00:03:08 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.63** | **-0.50** | **-1.13** | **+27.95** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.31** | **-0.50** | **+0.19** | **+40.29** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.63** | **-0.50** | **-1.13** | **+27.95** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.63** | **-0.50** | **-1.13** | **+27.95** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.63** | **-0.50** | **-1.13** | **+27.95** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.63** | **-0.50** | **-1.13** | **+27.95** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.63** | **-0.50** | **-1.13** | **+27.95** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (81.91h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (1.02h old) | 08-16 16:01 |
| ✅ | **Holding Times config** | Fresh (103.39h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-16 17:03 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 17:03 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 17:03 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `56,011` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-08-16 04:01 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **1.9h (0d 1h 56m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **0.9h (0d 0h 56m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:03:09 AM
   CPU:   4.2%  |  MEM:   5.1% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1446653  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1466336  | COOL-DOWN       | 63       | Next run in 4.5s
Trader ETH-USD       | 1466337  | COOL-DOWN       | 63       | Next run in 4.5s
Trader ADA-USD       | 1466338  | COOL-DOWN       | 63       | Next run in 4.5s
Trader DOGE-USD      | 1466339  | COOL-DOWN       | 63       | Next run in 4.5s
Trader BTC-USD       | 1466340  | COOL-DOWN       | 63       | Next run in 4.5s
Trader LINK-USD      | 1466341  | COOL-DOWN       | 63       | Next run in 4.5s
Trader SOL-USD       | 1466342  | COOL-DOWN       | 63       | Next run in 4.5s
================================================================================
```
