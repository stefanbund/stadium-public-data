...
> **Report Generated**: `2026-08-29 07:31:10 PM PDT (2026-08-30 02:31:10 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.94** | **-0.50** | **-1.44** | **+21.69** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.68** | **-0.50** | **+1.18** | **+35.33** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.94** | **-0.50** | **-1.44** | **N/A** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.94** | **-0.50** | **-1.44** | **+21.58** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.94** | **-0.50** | **-1.44** | **+21.69** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.94** | **-0.50** | **-1.44** | **N/A** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.94** | **-0.50** | **-1.44** | **+21.69** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (0.74h old) | 08-29 18:46 |
| ✅ | **TimesFM Forecasts** | Fresh (3.49h old) | 08-29 16:02 |
| ❌ | **Holding Times config** | STALE! (202.5h old) | Limit 144.5h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-29 19:31 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-29 19:31 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-29 19:31 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 460 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `21,029` | **100.0%** |
...
| `USDT-USD` | SELL | 1.00003 | `2fe9427a-6158-4704-b30a-222cdedc15da` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.5h ago (2026-08-29 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **23.5h (0d 23h 28m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-29 06:46:46 PM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **22.5h (0d 22h 28m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  02:31:08 AM
   CPU:  15.4%  |  MEM:   7.2% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 358418   | COOL-DOWN       | 42       | Next run in 14.9s
Trader ETH-USD       | 358419   | COOL-DOWN       | 87       | Next run in 14.9s
...
Trader BTC-USD       | 358498   | RUNNING         | 106      | Evaluating Funnel/Polling Order
