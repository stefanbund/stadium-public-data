...
> **Report Generated**: `2026-08-23 12:32:46 PM PDT (2026-08-23 19:32:46 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+11.46** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.27** | **-0.50** | **+1.77** | **+27.05** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+11.46** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+11.46** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+11.46** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+11.46** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.64** | **-0.50** | **+1.14** | **+11.46** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.12h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (4.51h old) | 08-23 08:02 |
| ✅ | **Holding Times config** | Fresh (51.50h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-23 12:32 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-23 12:32 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 12:32 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,138` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.5h ago (2026-08-23 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **6.5h (0d 6h 27m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **5.4h (0d 5h 26m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  07:32:43 PM
   CPU:  19.8%  |  MEM:   6.5% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1290197  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1341398  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1341399  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1341400  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1341401  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1341402  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1341403  | RUNNING         | 151      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1341405  | RUNNING         | 151      | Evaluating Funnel/Polling Order
================================================================================
```
...
logs/watchdog_Trader_AVAX_USD.log:2026-08-23 18:20:15 [ERROR] [async_sfgk_trader.py:fetch_live_state:527] [AVAX-USD] CRITICAL: Failed to fetch DVOL from oracle or check dependencies: Extra data: line 12 column 2 (char 339) (Fail-Closed)
