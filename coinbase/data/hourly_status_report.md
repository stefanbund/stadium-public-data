...
> **Report Generated**: `2026-08-12 10:41:58 AM PDT (2026-08-12 17:41:58 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.80** | **-0.80** (≤ -0.5) | 36.4 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.50** | **+0.12** (≤ -0.5) | 35.5 | 20/100 (< 30) | Compression 📉 | 🔴 DAW Vetoed |
...
> - **ETH-USD**: $Z = +0.12$ (Safety Margin: **+0.62** vs. gate $-0.5$) $\rightarrow$ **🔴 DAW VETOED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (1.04h old) | 08-12 09:39 |
| ✅ | **TimesFM Forecasts** | Fresh (1.04h old) | 08-12 09:39 |
| ✅ | **Holding Times config** | Fresh (1.04h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 10:42 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 10:42 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 10:42 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,571` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-08-12 09:39 AM PDT)
- **Last Weekly VSTEF Optimization**: `Never`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **104.3h (4d 8h 17m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-11 10:42:12 AM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **103.3h (4d 7h 17m)**)
