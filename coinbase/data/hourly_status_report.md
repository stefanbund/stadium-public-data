...
> **Report Generated**: `2026-08-17 05:45:51 AM PDT (2026-08-17 12:45:51 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.58** | **-0.50** | **-1.08** | **+16.35** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.08** | **-0.50** | **-0.58** | **+27.61** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.58** | **-0.50** | **-1.08** | **+16.34** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-1.58** | **-0.50** | **-1.08** | **+16.35** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-1.58** | **-0.50** | **-1.08** | **+16.35** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-1.58** | **-0.50** | **-1.08** | **+16.35** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-1.58** | **-0.50** | **-1.08** | **+16.35** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (4.74h old) | 08-17 01:01 |
| ✅ | **TimesFM Forecasts** | Fresh (1.08h old) | 08-17 04:41 |
| ✅ | **Holding Times config** | Fresh (4.54h old) | 08-17 01:13 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-17 05:45 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-17 05:45 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-17 05:46 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `71,068` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.1h ago (2026-08-17 04:41 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-17 01:13:06 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **157.2h (6d 13h 14m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **156.2h (6d 12h 13m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  12:45:49 PM
   CPU:  17.0%  |  MEM:   6.3% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2079086  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2135676  | RUNNING         | 183      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2135677  | RUNNING         | 183      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2135678  | RUNNING         | 183      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2135679  | RUNNING         | 183      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2135680  | RUNNING         | 183      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 2135681  | RUNNING         | 183      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 2135682  | RUNNING         | 183      | Evaluating Funnel/Polling Order
================================================================================
```
