...
> **Report Generated**: `2026-08-31 01:00:05 AM PDT (2026-08-31 08:00:05 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.44** | **-0.50** | **+0.94** | **+4.65** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.63** | **-0.50** | **-1.13** | **+18.57** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.44** | **-0.50** | **+0.94** | **+4.65** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.44** | **-0.50** | **+0.94** | **+4.65** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.44** | **-0.50** | **+0.94** | **+4.65** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.44** | **-0.50** | **+0.94** | **+4.07** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.44** | **-0.50** | **+0.94** | **+4.65** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ❌ | **Go-List JSON** | STALE! (17.9h old) | Limit 7.0h |
| ✅ | **TimesFM Forecasts** | Fresh (0.97h old) | 08-31 00:02 |
| ❌ | **Holding Times config** | STALE! (232.0h old) | Limit 6.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-31 01:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-31 01:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.01h old) | 08-31 00:59 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1301 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `45,067` | **100.0%** |
...
| `ADA-USD` | 60 | 63.3% | 1 | 🟢 OK |
| `DOGE-USD` | 46 | 65.2% | 1 | 🟢 OK |
| `ETH-USD` | 22 | 68.2% | 0 | 🟢 OK |
| `LINK-USD` | 53 | 73.6% | 0 | 🟢 OK |
| `AVAX-USD` | 41 | 70.7% | 0 | 🟢 OK |
...
| `USDT-USD` | SELL | 0.99987 | `bfd1ce54-e5fb-4447-828b-df41932bd898` |
| `LINK-USD` | BUY | 11.249 | `6e0b5805-690f-401e-b39b-87647981b48c` |
| `USDT-USD` | BUY | 0.99984 | `c1c366fb-6666-4e19-a0ed-6ab946666896` |
| `USDT-USD` | SELL | 0.99985 | `e4985aba-2c44-4d7e-ba88-fbf7ff0a4e1d` |
| `USDT-USD` | SELL | 0.99985 | `648fc358-5acc-4fd2-87ca-dec36f680260` |
| `USDT-USD` | SELL | 0.99985 | `f4b6b302-66c1-4f94-8b67-25cba0793da8` |
| `USDT-USD` | SELL | 0.99985 | `ec534f21-6291-4d86-af03-e9e8bc485c33` |
| `USDT-USD` | SELL | 0.99985 | `8053fe0b-9c2f-4667-a3d0-f976282746e0` |
| `USDT-USD` | SELL | 0.99985 | `fdec8f21-9c41-438b-8067-0293e125984a` |
| `USDT-USD` | SELL | 0.99985 | `e1e49e47-409f-4056-b5e3-597f7e5908bf` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-08-31 12:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **162.0h (6d 17h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-30 07:08:16 AM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **161.0h (6d 16h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  08:00:01 AM
   CPU:  23.9%  |  MEM:   6.2% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1850239  | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 1850318  | RUNNING         | -        | Oracle Yield Analysis
U/U Farmer           | 1850325  | RUNNING         | -        | Volume Farmer
Trader AVAX-USD      | 1853142  | COOL-DOWN       | 8        | Next run in 14.7s
Trader ETH-USD       | 1853143  | COOL-DOWN       | 8        | Next run in 14.7s
Trader ADA-USD       | 1853144  | COOL-DOWN       | 8        | Next run in 14.7s
Trader DOGE-USD      | 1853145  | COOL-DOWN       | 8        | Next run in 14.7s
Trader BTC-USD       | 1853146  | COOL-DOWN       | 8        | Next run in 14.7s
Trader LINK-USD      | 1852753  | COOL-DOWN       | 2        | Next run in 2.9s
```
