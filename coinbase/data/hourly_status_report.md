...
> **Report Generated**: `2026-08-12 06:47:46 PM PDT (2026-08-13 01:47:46 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.79** | **-0.45** (≤ -0.5) | 49.7 | 0/100 (< 30) | Expansion 📈 | 🔴 DAW Vetoed |
| `ETH-USD` | **49.34** | **-1.27** (≤ -0.5) | 38.5 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **ETH-USD**: $Z = -1.27$ (Safety Margin: **-0.77** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (5.45h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (1.57h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (9.14h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 18:47 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 18:47 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 18:47 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `123,043` | **99.5%** |
...
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **96.2h (4d 0h 12m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **95.2h (3d 23h 11m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:47:43 AM
   CPU:  12.2%  |  MEM:   5.3% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 603707   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 686362   | COOL-DOWN       | 279      | Next run in 4.8s
Trader ETH-USD       | 686363   | COOL-DOWN       | 279      | Next run in 4.8s
Trader ADA-USD       | 686364   | COOL-DOWN       | 279      | Next run in 4.8s
Trader DOGE-USD      | 686538   | COOL-DOWN       | 279      | Next run in 14.9s
Trader BTC-USD       | 686365   | COOL-DOWN       | 279      | Next run in 4.8s
Trader LINK-USD      | 686366   | COOL-DOWN       | 279      | Next run in 4.8s
Trader SOL-USD       | 686367   | COOL-DOWN       | 279      | Next run in 4.8s
================================================================================
```
