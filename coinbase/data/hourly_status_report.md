...
> **Report Generated**: `2026-08-30 11:00:10 PM PDT (2026-08-31 06:00:10 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.15** | **-0.50** | **-0.65** | **+3.79** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.60** | **-0.50** | **-1.10** | **+18.25** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.15** | **-0.50** | **-0.65** | **+3.79** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.15** | **-0.50** | **-0.65** | **+3.87** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.15** | **-0.50** | **-0.65** | **+3.55** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.15** | **-0.50** | **-0.65** | **+3.79** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.15** | **-0.50** | **-0.65** | **+3.87** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ❌ | **Go-List JSON** | STALE! (15.9h old) | Limit 5.0h |
| ✅ | **TimesFM Forecasts** | Fresh (2.13h old) | 08-30 20:52 |
| ❌ | **Holding Times config** | STALE! (230.0h old) | Limit 4.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-30 22:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-30 23:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-30 23:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1847 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `44,018` | **100.0%** |
...
| `USDT-USD` | BUY | 0.99988 | `9c0bff42-86be-457b-85df-2b876932c0bc` |
| `USDT-USD` | SELL | 0.99989 | `95f57d41-481f-4ebf-88f4-e0c92ebd2919` |
| `USDT-USD` | SELL | 0.99989 | `18c4b4cf-7275-41d4-b11f-d565d1035285` |
| `USDT-USD` | BUY | 0.99988 | `d905e7fe-8a5c-44a3-ac62-0380fd484cfd` |
| `USDT-USD` | BUY | 0.99988 | `d99643fe-a5eb-4701-81d7-b1fb367e746c` |
| `USDT-USD` | BUY | 0.99988 | `6600504c-319a-4ffb-9a33-9c8763e5ec58` |
| `USDT-USD` | BUY | 0.99988 | `cca531cb-ac92-4322-9e7e-22aa3b5bb3d8` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.1h ago (2026-08-30 08:52 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **164.0h (6d 19h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-30 07:08:16 AM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **163.0h (6d 18h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:00:10 AM
   CPU:   3.6%  |  MEM:   8.4% (14.1GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1752828  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1755284  | COOL-DOWN       | 9        | Next run in 9.6s
Trader ADA-USD       | 1752830  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1752831  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1752832  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1752833  | RUNNING         | 0        | Evaluating Funnel/Polling Order
```
