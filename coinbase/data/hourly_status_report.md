...
> **Report Generated**: `2026-08-31 09:38:16 PM PDT (2026-09-01 04:38:16 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.50** | **-0.50** | **+1.00** | **+7.65** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.50** | **-0.50** | **-2.00** | **+20.95** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.50** | **-0.50** | **+1.00** | **+2.25** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.50** | **-0.50** | **+1.00** | **+7.68** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.50** | **-0.50** | **+1.00** | **+7.67** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.50** | **-0.50** | **+1.00** | **+2.21** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.50** | **-0.50** | **+1.00** | **+7.67** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (8.91h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (0.76h old) | 08-31 20:52 |
| ✅ | **Holding Times config** | Fresh (8.91h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-31 21:38 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-31 21:38 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-31 21:38 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `60,673` | **100.0%** |
...
| :--- | :--- | :--- |
| **Daemon Engine** | 🟢 RUNNING | PID `2972951` on Live EC2 (CPU: `0.8%`, RAM: `0.2%`) |
...
| **Active BUY Tranches** | **6 Orders** (`$29,988.00 USD`) | Resting Limit Bids pegged to Best Bid |
| **Active SELL Tranches** | **2 Orders** (`$9,997.10 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$39,985.10 USD`** | Active bidirectional turnover liquidity pool |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🟢 **BUY** | 0.99960 | 5,000.0 | `$4,998.00` | `dd83b226-38b5-479f-90e8-9a76448f45aa` |
| `USDT-USD` | 🟢 **BUY** | 0.99960 | 5,000.0 | `$4,998.00` | `0704d764-d57c-4d6d-958f-a0afb8e211c8` |
| `USDT-USD` | 🟢 **BUY** | 0.99960 | 5,000.0 | `$4,998.00` | `cacbff59-31af-4d34-b025-934adc9bac2a` |
| `USDT-USD` | 🟢 **BUY** | 0.99960 | 5,000.0 | `$4,998.00` | `f48dd37d-92d8-4608-87ff-0f336bc73676` |
| `USDT-USD` | 🟢 **BUY** | 0.99960 | 5,000.0 | `$4,998.00` | `3f678041-9e82-4520-a9a3-fdb4893db989` |
| `USDT-USD` | 🟢 **BUY** | 0.99960 | 5,000.0 | `$4,998.00` | `3f26c5fa-e974-42eb-8b44-cd77e984a550` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 5558.9000 | 10000.0000 | **15558.9000** |
...
| `USDT-USD` | BUY | 0.99960 | 5,000.00 | `0704d764-d57c-4d6d-958f-a0afb8e211c8` |
...
| `ETH-USD` | BUY | 2,469.80000 | 0.31 | `dbb2acd1-17d9-447a-b9fa-c353816df960` |
| `USDT-USD` | BUY | 0.99960 | 5,000.00 | `cacbff59-31af-4d34-b025-934adc9bac2a` |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.8h ago (2026-08-31 08:52 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **141.4h (5d 21h 21m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **140.4h (5d 20h 21m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:38:14 AM
   CPU:   7.8%  |  MEM:   7.1% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 3005425  | COOL-DOWN       | 70       | Next run in 4.2s
Trader ETH-USD       | 3006335  | RUNNING         | 105      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2972954  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3007389  | RUNNING         | 79       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3007085  | COOL-DOWN       | 113      | Next run in 4.2s
