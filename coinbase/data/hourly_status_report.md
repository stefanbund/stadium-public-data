...
> **Report Generated**: `2026-08-31 06:42:20 PM PDT (2026-09-01 01:42:20 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.48** | **-0.50** | **+1.98** | **+3.43** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.82** | **-0.50** | **-0.32** | **+16.91** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.48** | **-0.50** | **+1.98** | **+3.49** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.48** | **-0.50** | **+1.98** | **+3.32** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.48** | **-0.50** | **+1.98** | **+3.43** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.48** | **-0.50** | **+1.98** | **+3.43** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.48** | **-0.50** | **+1.98** | **+3.43** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (5.98h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (2.68h old) | 08-31 16:02 |
| ❌ | **Holding Times config** | STALE! (249.7h old) | Limit 23.7h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-31 18:42 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-31 18:42 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-31 18:42 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2148 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `58,607` | **100.0%** |
...
| :--- | :--- | :--- |
| **Daemon Engine** | 🟢 RUNNING | PID `2717979` on Live EC2 (CPU: `0.8%`, RAM: `0.2%`) |
...
| **Active SELL Tranches** | **5 Orders** (`$24,991.60 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$44,983.40 USD`** | Active bidirectional turnover liquidity pool |
| **Rolling 30-Day Volume** | **`$1,999,455.11 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **40.0% Complete** | `$3,000,544.89 USD` to reach $5,000,000.00 threshold |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `7932710c-f748-4b36-9ef2-3c72fd41e1c5` |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `25046b81-02e3-451b-ba35-3a9c670e096a` |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `ae726777-5893-4654-8dc4-bef8e708faf0` |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `32687b09-dada-448a-8fd2-c41fdf85d65f` |
...
| `USDT-USD` | 🔴 **SELL** | 0.99960 | 5,000.0 | `$4,998.00` | `f40ad091-68ec-45e3-b7b9-a2b57737fa3a` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 7065.4700 | 16862.8200 | **23928.2900** |
...
| `AVAX-USD` | BUY | 7.26300 | 180.82 | `7d40da47-796e-44b0-9747-d46b19ec5ee9` |
...
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `7932710c-f748-4b36-9ef2-3c72fd41e1c5` |
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `25046b81-02e3-451b-ba35-3a9c670e096a` |
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `ae726777-5893-4654-8dc4-bef8e708faf0` |
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `32687b09-dada-448a-8fd2-c41fdf85d65f` |
| `USDT-USD` | SELL | 0.99960 | 5,000.00 | `f40ad091-68ec-45e3-b7b9-a2b57737fa3a` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.7h ago (2026-08-31 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **144.3h (6d 0h 17m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **143.3h (5d 23h 17m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:42:18 AM
   CPU:  10.1%  |  MEM:   7.7% (14.2GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2831015  | RUNNING         | 213      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2831203  | COOL-DOWN       | 262      | Next run in 9.3s
Trader ADA-USD       | 2794362  | RUNNING         | 121      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2815658  | RUNNING         | 167      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2831339  | COOL-DOWN       | 291      | Next run in 14.8s
Trader LINK-USD      | 2830703  | RUNNING         | 238      | Evaluating Funnel/Polling Order
```
