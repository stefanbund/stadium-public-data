...
> **Report Generated**: `2026-08-16 03:07:52 AM PDT (2026-08-16 10:07:52 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **+28.63** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.25** | **-0.50** | **+0.75** | **+40.90** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **+28.63** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **+28.63** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **+28.63** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **+28.63** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.19** | **-0.50** | **+1.69** | **+28.63** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (67.99h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (3.10h old) | 08-16 00:02 |
| ✅ | **Holding Times config** | Fresh (89.47h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-16 03:07 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-16 03:07 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-16 03:08 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `39,557` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.1h ago (2026-08-16 12:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **15.9h (0d 15h 52m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **14.9h (0d 14h 51m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:07:52 AM
   CPU:  37.5%  |  MEM:   6.4% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 709032   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 733019   | COOL-DOWN       | 78       | Next run in 14.9s
Trader ETH-USD       | 733020   | COOL-DOWN       | 78       | Next run in 14.9s
Trader ADA-USD       | 733021   | COOL-DOWN       | 78       | Next run in 14.9s
Trader DOGE-USD      | 733022   | COOL-DOWN       | 78       | Next run in 14.9s
Trader BTC-USD       | 733023   | COOL-DOWN       | 78       | Next run in 14.9s
Trader LINK-USD      | 733024   | COOL-DOWN       | 78       | Next run in 14.9s
Trader SOL-USD       | 733025   | COOL-DOWN       | 78       | Next run in 14.9s
================================================================================
```
