...
> **Report Generated**: `2026-08-28 09:12:59 AM PDT (2026-08-28 16:12:59 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.64** | **-0.50** | **-1.14** | **-0.12** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.74** | **-0.50** | **-1.24** | **+12.00** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.64** | **-0.50** | **-1.14** | **-0.74** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.64** | **-0.50** | **-1.14** | **+4.98** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.64** | **-0.50** | **-1.14** | **+4.28** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.64** | **-0.50** | **-1.14** | **+1.88** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.64** | **-0.50** | **-1.14** | **+4.98** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (0.35h old) | 08-28 08:52 |
| ✅ | **TimesFM Forecasts** | Fresh (1.16h old) | 08-28 08:03 |
| ❌ | **Holding Times config** | STALE! (168.2h old) | Limit 110.2h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-28 09:12 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-28 09:12 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-28 09:13 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1431 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,103` | **100.0%** |
...
| :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | 1 | 0.0% | 1 | 🟢 OK |
| `ADA-USD` | 30 | 66.7% | 0 | 🟢 OK |
| `DOGE-USD` | 19 | 57.9% | 0 | 🟢 OK |
| `ETH-USD` | 13 | 76.9% | 0 | 🟢 OK |
| `LINK-USD` | 20 | 65.0% | 1 | 🟢 OK |
| `AVAX-USD` | 17 | 58.8% | 1 | 🟢 OK |
...
| :--- | :--- | :--- | :--- |
| `AVAX-USD` | SELL | 7.343 | `46d32947-1bb3-4ad4-a1bf-f81800d33fee` |
| `ACH-USD` | SELL | 0.005507 | `a0d2e243-42b4-4df5-bd23-118f45998df8` |
| `SOL-USD` | SELL | 106.07 | `9245adee-4e93-4fe5-8330-bf6f6ef095ae` |
| `DOGE-USD` | SELL | 0.08645 | `70aba4a8-0d63-4d86-8aef-2b0d681cd567` |
| `BTC-USD` | SELL | 78784.97 | `5a4e398f-5daa-46e8-98fb-ffb6a9edac3d` |
...
| `LINK-USD` | SELL | 11.639 | `14984ea5-5eee-42f0-ad3a-e50b47e1d8a6` |
| `ADA-USD` | SELL | 0.20437 | `ac04fe21-4f7b-4897-adff-64258fe2ff7a` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.2h ago (2026-08-28 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **57.8h (2d 9h 46m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-28 08:52:07 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **56.8h (2d 8h 46m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:12:57 PM
   CPU:   7.1%  |  MEM:   8.7% (14.1GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2952415  | RUNNING         | 1        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 2963035  | RUNNING         | 54       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2959935  | RUNNING         | 4        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2947589  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 2947590  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader LINK-USD      | 2950031  | RUNNING         | 1        | Evaluating Funnel/Polling Order
```
