...
> **Report Generated**: `2026-08-12 10:03:34 PM PDT (2026-08-13 05:03:34 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.68** | **-0.99** (≤ -0.5) | 81.0 | 60/100 (< 30) | Compression 📉 | 🔴 DAW Vetoed |
| `ETH-USD` | **49.35** | **-0.94** (≤ -0.5) | 73.1 | 40/100 (< 30) | Expansion 📈 | 🔴 DAW Vetoed |
...
> - **BTC-USD**: $Z = -0.99$ (Safety Margin: **-0.49** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -0.94$ (Safety Margin: **-0.44** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (8.71h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (4.83h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (12.40h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-12 22:03 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-12 22:03 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 22:03 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,133` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.8h ago (2026-08-12 05:13 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **92.9h (3d 20h 56m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **91.9h (3d 19h 56m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:03:34 AM
   CPU:   6.7%  |  MEM:   5.7% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 815328   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 859327   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 859328   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 859329   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 859330   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 859331   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 859332   | RUNNING         | 150      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 859333   | RUNNING         | 150      | Evaluating Funnel/Polling Order
================================================================================
```
