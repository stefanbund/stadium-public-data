...
> **Report Generated**: `2026-08-24 08:14:07 AM PDT (2026-08-24 15:14:07 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+2.73** | **-0.50** | **+3.23** | **-4.14** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-0.20** | **-0.50** | **+0.30** | **+10.29** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+2.73** | **-0.50** | **+3.23** | **-4.16** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+2.73** | **-0.50** | **+3.23** | **-4.16** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+2.73** | **-0.50** | **+3.23** | **-4.16** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+2.73** | **-0.50** | **+3.23** | **-4.16** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+2.73** | **-0.50** | **+3.23** | **-4.16** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.21h old) | 08-24 01:01 |
| ✅ | **TimesFM Forecasts** | Fresh (0.17h old) | 08-24 08:03 |
| ✅ | **Holding Times config** | Fresh (7.02h old) | 08-24 01:13 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-24 08:14 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-24 08:14 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-24 08:14 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `36,820` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.2h ago (2026-08-24 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-24 01:12:31 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **154.8h (6d 10h 45m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-24 01:01:26 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **153.8h (6d 9h 45m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:14:04 PM
   CPU:  10.2%  |  MEM:   5.4% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2279335  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2353162  | COOL-DOWN       | 192      | Next run in 14.8s
Trader ETH-USD       | 2353137  | COOL-DOWN       | 217      | Next run in 9.6s
Trader ADA-USD       | 2353102  | COOL-DOWN       | 220      | Next run in 4.0s
Trader DOGE-USD      | 2353103  | COOL-DOWN       | 213      | Next run in 4.0s
Trader BTC-USD       | 2353138  | COOL-DOWN       | 240      | Next run in 9.6s
Trader LINK-USD      | 2353139  | COOL-DOWN       | 201      | Next run in 9.6s
Trader SOL-USD       | 2353140  | COOL-DOWN       | 240      | Next run in 9.6s
================================================================================
```
