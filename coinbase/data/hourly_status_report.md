...
> **Report Generated**: `2026-08-31 08:40:16 PM PDT (2026-09-01 03:40:16 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.67** | **-0.50** | **+1.17** | **+2.06** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.37** | **-0.50** | **-1.87** | **+15.60** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.67** | **-0.50** | **+1.17** | **+2.06** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.67** | **-0.50** | **+1.17** | **+2.06** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.67** | **-0.50** | **+1.17** | **+2.18** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.67** | **-0.50** | **+1.17** | **+2.06** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.67** | **-0.50** | **+1.17** | **+2.18** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.94h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (4.64h old) | 08-31 16:02 |
| ✅ | **Holding Times config** | Fresh (7.95h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-31 20:40 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-31 20:40 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-31 20:40 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1730 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `59,973` | **100.0%** |
...
| **Active BUY Tranches** | **3 Orders** (`$14,993.85 USD`) | Resting Limit Bids pegged to Best Bid |
| **Active SELL Tranches** | **6 Orders** (`$29,989.60 USDT`) | Resting Limit Asks pegged to Best Ask |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `87cb0bf0-a12a-4545-9c84-91100f27d6e1` |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `14706684-7c97-4462-9de7-6f109c1ce11c` |
| `USDT-USD` | 🟢 **BUY** | 0.99959 | 5,000.0 | `$4,997.95` | `1165d519-acbb-469e-aaa5-ec149ad55946` |
...
| `USDT-USD` | 🔴 **SELL** | 0.99960 | 5,000.0 | `$4,998.00` | `7a250d01-3378-4031-a3cd-0a08b50fcb4d` |
| `USDT-USD` | 🔴 **SELL** | 0.99960 | 5,000.0 | `$4,998.00` | `eee60aba-4673-439a-a55d-2f0000dca868` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 6817.3800 | 26862.8200 | **33680.2000** |
...
| `USDT-USD` | SELL | 0.99960 | 5,000.00 | `7a250d01-3378-4031-a3cd-0a08b50fcb4d` |
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `87cb0bf0-a12a-4545-9c84-91100f27d6e1` |
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `14706684-7c97-4462-9de7-6f109c1ce11c` |
| `USDT-USD` | BUY | 0.99959 | 5,000.00 | `1165d519-acbb-469e-aaa5-ec149ad55946` |
| `USDT-USD` | SELL | 0.99960 | 5,000.00 | `eee60aba-4673-439a-a55d-2f0000dca868` |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.6h ago (2026-08-31 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **142.3h (5d 22h 19m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **141.3h (5d 21h 19m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:40:16 AM
   CPU:  15.0%  |  MEM:   6.0% (14.5GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 2954898  | COOL-DOWN       | 97       | Next run in 3.9s
Trader ETH-USD       | 2955144  | COOL-DOWN       | 230      | Next run in 14.5s
Trader ADA-USD       | 2955118  | COOL-DOWN       | 124      | Next run in 9.3s
Trader DOGE-USD      | 2954901  | COOL-DOWN       | 104      | Next run in 3.9s
Trader BTC-USD       | 2955196  | RUNNING         | 288      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 2954903  | COOL-DOWN       | 107      | Next run in 3.9s
```
