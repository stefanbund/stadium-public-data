...
> **Report Generated**: `2026-09-03 07:15:53 PM PDT (2026-09-04 02:15:53 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.01** | **-0.50** | **+0.51** | **N/A** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.69** | **-0.50** | **+1.19** | **+1.32** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.01** | **-0.50** | **+0.51** | **-12.16** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.01** | **-0.50** | **+0.51** | **-12.16** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.01** | **-0.50** | **+0.51** | **-12.37** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.01** | **-0.50** | **+0.51** | **-10.81** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.01** | **-0.50** | **+0.51** | **-12.37** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (6.64h old) | 09-03 12:37 |
| ✅ | **TimesFM Forecasts** | Fresh (3.23h old) | 09-03 16:02 |
| ✅ | **Holding Times config** | Fresh (78.54h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-03 19:15 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-03 19:15 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-03 19:16 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 34 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `98,172` | **100.0%** |
...
| **Rolling 30-Day Volume** | **`$2,364,893.35 USD`** | **VIP 2** (Maker: **0.05%** / 5 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 3)** | **47.3% Complete** | `$2,635,106.65 USD` to reach $5,000,000.00 threshold |
...
| `ADA` | 0.0000 | 3106.6711 | **3106.6711** |
| `DOGE` | 0.1000 | 22575.9000 | **22576.0000** |
...
| `ADA-USD` | SELL | 0.22263 | 3,106.67 | `c4449cde-e1ee-480d-a01d-1d90a61b30cf` |
| `DOGE-USD` | SELL | 0.08724 | 22,575.90 | `82a8c38c-2cd8-4bdc-88be-fba2a514d91d` |
...
| `ETH-USD` | BUY | 2,499.56000 | 0.36 | `ab2fcc8d-0ce5-478b-8ea6-b9fc56deb72b` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.2h ago (2026-09-03 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **71.7h (2d 23h 44m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-03 12:37:49 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **70.7h (2d 22h 43m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  02:15:52 AM
   CPU:   8.3%  |  MEM:   9.4% (14.0GB / 15.4GB Free)
================================================================================
...
Trader ETH-USD       | 2816430  | RUNNING         | 2        | Evaluating Funnel/Polling Order
Trader ADA-USD       | 2809276  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 2809277  | RUNNING         | 0        | Evaluating Funnel/Polling Order
