...
> **Report Generated**: `2026-08-13 06:46:44 AM PDT (2026-08-13 13:46:44 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.36** | **-1.39** (≤ -0.5) | 47.7 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **48.90** | **-1.59** (≤ -0.5) | 50.7 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -1.39$ (Safety Margin: **-0.89** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -1.59$ (Safety Margin: **-1.09** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.43h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (5.54h old) | 08-13 01:14 |
| ✅ | **Holding Times config** | Fresh (21.12h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-13 06:46 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-13 06:46 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 06:46 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `123,008` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 5.5h ago (2026-08-13 01:14 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **84.2h (3d 12h 13m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **83.2h (3d 11h 12m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:46:44 PM
   CPU:  15.7%  |  MEM:   6.1% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1237805  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1319303  | RUNNING         | 275      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1319304  | RUNNING         | 275      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1319305  | RUNNING         | 275      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1319306  | RUNNING         | 275      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1319307  | RUNNING         | 275      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1319308  | RUNNING         | 275      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1319309  | RUNNING         | 275      | Evaluating Funnel/Polling Order
================================================================================
```
