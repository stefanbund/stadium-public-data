...
> **Report Generated**: `2026-08-28 12:36:03 PM PDT (2026-08-28 19:36:03 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.83** | **-0.50** | **-1.33** | **-1.45** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-2.01** | **-0.50** | **-1.51** | **+13.88** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.83** | **-0.50** | **-1.33** | **+1.02** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.83** | **-0.50** | **-1.33** | **+0.75** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.83** | **-0.50** | **-1.33** | **+1.34** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.83** | **-0.50** | **-1.33** | **+0.77** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.83** | **-0.50** | **-1.33** | **+1.15** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (3.73h old) | 08-28 08:52 |
| ✅ | **TimesFM Forecasts** | Fresh (4.55h old) | 08-28 08:03 |
| ❌ | **Holding Times config** | STALE! (171.6h old) | Limit 113.6h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-28 12:35 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-28 12:35 |
| ❌ | **Live Trading Telemetry** | STALE! (0.3h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 563 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,657` | **100.0%** |
...
| `AVAX-USD` | BUY | 7.268 | `3dcbf611-3694-4fc6-a471-24d201c0f6c7` |
| `USDT-USDC` | SELL | 1.0001 | `4d9f1df5-f1ce-408b-8fcb-f870df3e47db` |
| `DOGE-USD` | SELL | 0.08479 | `63ec0902-eb19-4020-af25-76159555b9e9` |
...
| `SOL-USD` | BUY | 103.45 | `c36453bc-f665-40f8-b4d5-8f1d581e77b6` |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.5h ago (2026-08-28 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **54.4h (2d 6h 23m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-28 08:52:07 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **53.4h (2d 5h 23m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  07:36:03 PM
   CPU:   6.3%  |  MEM:   7.9% (14.2GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 3118773  | RUNNING         | 17       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 3119460  | COOL-DOWN       | 281      | Next run in 3.7s
Trader ADA-USD       | 3116368  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3109356  | RUNNING         | 12       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3117892  | COOL-DOWN       | 10       | Next run in 9.1s
Trader LINK-USD      | 3109023  | RUNNING         | 12       | Evaluating Funnel/Polling Order
```
