...
> **Report Generated**: `2026-08-12 10:59:25 AM PDT (2026-08-12 17:59:25 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.78** | **-0.89** (≤ -0.5) | 31.4 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.55** | **+0.34** (≤ -0.5) | 63.9 | 20/100 (< 30) | Compression 📉 | 🔴 DAW Vetoed |
...
> - **BTC-USD**: $Z = -0.89$ (Safety Margin: **-0.39** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = +0.34$ (Safety Margin: **+0.84** vs. gate $-0.5$) $\rightarrow$ **🔴 DAW VETOED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (1.33h old) | 08-12 09:39 |
| ✅ | **TimesFM Forecasts** | Fresh (1.33h old) | 08-12 09:39 |
| ✅ | **Holding Times config** | Fresh (1.33h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-12 10:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-12 10:59 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 10:59 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2516 recent read events).
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,934` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.3h ago (2026-08-12 09:39 AM PDT)
- **Last Weekly VSTEF Optimization**: `Never`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **104.0h (4d 8h 0m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-11 10:42:12 AM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **103.0h (4d 7h 0m)**)
