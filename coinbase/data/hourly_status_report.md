...
> **Report Generated**: `2026-08-23 02:02:48 AM PDT (2026-08-23 09:02:48 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-3.05** | **-0.50** | **-2.55** | **+6.36** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.19** | **-0.50** | **-0.69** | **+21.50** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-3.05** | **-0.50** | **-2.55** | **+6.36** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-3.05** | **-0.50** | **-2.55** | **+6.36** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-3.05** | **-0.50** | **-2.55** | **+6.36** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-3.05** | **-0.50** | **-2.55** | **+6.36** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-3.05** | **-0.50** | **-2.55** | **+6.36** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (6.62h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (2.02h old) | 08-23 00:02 |
| ✅ | **Holding Times config** | Fresh (41.00h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-23 02:02 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 02:02 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 02:02 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `6,783` | **100.0%** |
...
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **17.0h (0d 16h 57m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **15.9h (0d 15h 56m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  09:02:45 AM
   CPU:   6.3%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 702712   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 770941   | COOL-DOWN       | 213      | Next run in 4.5s
Trader ETH-USD       | 770942   | COOL-DOWN       | 213      | Next run in 4.5s
Trader ADA-USD       | 770943   | COOL-DOWN       | 213      | Next run in 4.5s
Trader DOGE-USD      | 770944   | COOL-DOWN       | 213      | Next run in 4.5s
Trader BTC-USD       | 770945   | COOL-DOWN       | 213      | Next run in 4.5s
Trader LINK-USD      | 770946   | COOL-DOWN       | 213      | Next run in 4.5s
Trader SOL-USD       | 770947   | COOL-DOWN       | 213      | Next run in 4.5s
================================================================================
```
