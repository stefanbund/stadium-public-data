...
> **Report Generated**: `2026-08-27 09:00:09 AM PDT (2026-08-27 16:00:09 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.14** | **-0.50** | **+1.64** | **+6.88** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.92** | **-0.50** | **+1.42** | **+22.13** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.14** | **-0.50** | **+1.64** | **+6.85** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.14** | **-0.50** | **+1.64** | **+6.88** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.14** | **-0.50** | **+1.64** | **+6.88** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.14** | **-0.50** | **+1.64** | **+6.88** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.14** | **-0.50** | **+1.64** | **+6.88** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (1.22h old) | 08-27 07:47 |
| ✅ | **TimesFM Forecasts** | Fresh (0.95h old) | 08-27 08:03 |
| ❌ | **Holding Times config** | STALE! (144.0h old) | Limit 86.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-27 08:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-27 09:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 09:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1088 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `1,066` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 0.9h ago (2026-08-27 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **82.0h (3d 9h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-27 07:47:00 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **81.0h (3d 8h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  04:00:07 PM
   CPU:  27.2%  |  MEM:   7.0% (14.3GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1751263  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1751264  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1750864  | RUNNING         | 15       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1751218  | COOL-DOWN       | 22       | Next run in 14.9s
Trader BTC-USD       | 1751219  | COOL-DOWN       | 22       | Next run in 14.9s
Trader LINK-USD      | 1751220  | COOL-DOWN       | 22       | Next run in 14.9s
```
...
logs/watchdog_Trader_LINK_USD.log:2026-08-27 15:51:32 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1018] [LINK-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_LINK_USD.log:2026-08-27 15:51:38 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1018] [LINK-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_LINK_USD.log:2026-08-27 15:51:43 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1018] [LINK-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_LINK_USD.log:2026-08-27 15:51:48 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1018] [LINK-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
logs/watchdog_Trader_LINK_USD.log:2026-08-27 15:51:53 [ERROR] [async_sfgk_trader.py:perform_trade_cycle:1018] [LINK-USD] Error polling sell order / ticker: 'TradeBotSFGK' object has no attribute 'get_lob_pressure'
```
</details>
