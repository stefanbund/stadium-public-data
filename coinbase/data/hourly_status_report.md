...
> **Report Generated**: `2026-08-27 06:53:22 AM PDT (2026-08-27 13:53:22 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.23** | **-0.50** | **+0.73** | **+8.04** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.96** | **-0.50** | **+1.46** | **+24.27** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.23** | **-0.50** | **+0.73** | **+8.04** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.23** | **-0.50** | **+0.73** | **+8.04** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.23** | **-0.50** | **+0.73** | **+8.04** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.23** | **-0.50** | **+0.73** | **+8.05** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.23** | **-0.50** | **+0.73** | **+8.04** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (20.15h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (2.03h old) | 08-27 04:51 |
| ❌ | **Holding Times config** | STALE! (141.8h old) | Limit 83.9h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-27 06:53 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-27 06:53 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-27 06:53 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1733 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,113` | **100.0%** |
...
| `ADA-USD` | SELL | 0.21305 | `cee4cb92-3ff7-418e-acb7-a7471cddb42c` |
| `DOGE-USD` | SELL | 0.08869 | `00e35130-f301-495d-a21d-d62faaa3fb20` |
| `USDT-USDC` | SELL | 1.0001 | `a69d9998-a1ee-4622-87af-a15bb8d32eaf` |
| `ETH-USD` | SELL | 2507.95 | `2a7126d0-8db1-4192-aba2-ef2ada834ff8` |
| `LINK-USD` | SELL | 11.811 | `ab88f9dd-e644-44fa-83d9-b452d2acde7c` |
| `LINK-USD` | BUY | 11.78 | `1d4579e3-bc31-4484-9cfd-1dea67f219f8` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.0h ago (2026-08-27 04:51 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **84.1h (3d 12h 6m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **83.1h (3d 11h 6m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  01:53:21 PM
   CPU:   7.7%  |  MEM:   5.9% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1641733  | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 1641739  | RUNNING         | -        | Oracle Yield Analysis
U/U Farmer           | 1641741  | RUNNING         | -        | Volume Farmer
Trader AVAX-USD      | 1642273  | COOL-DOWN       | 2        | Next run in 4.3s
Trader ETH-USD       | 1642274  | COOL-DOWN       | 2        | Next run in 4.3s
Trader ADA-USD       | 1642275  | COOL-DOWN       | 2        | Next run in 4.3s
Trader DOGE-USD      | 1642276  | COOL-DOWN       | 2        | Next run in 4.3s
Trader BTC-USD       | 1642277  | COOL-DOWN       | 2        | Next run in 4.3s
Trader LINK-USD      | 1642278  | RUNNING         | 2        | Evaluating Funnel/Polling Order
```
