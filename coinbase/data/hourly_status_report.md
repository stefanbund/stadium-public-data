...
> **Report Generated**: `2026-08-12 08:53:36 PM PDT (2026-08-13 03:53:36 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.58** | **-1.95** (≤ -0.5) | 28.8 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **49.28** | **-1.56** (≤ -0.5) | 14.6 | 0/100 (< 30) | Expansion 📈 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -1.95$ (Safety Margin: **-1.45** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -1.56$ (Safety Margin: **-1.06** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.54h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (3.66h old) | 08-12 17:13 |
| ✅ | **Holding Times config** | Fresh (11.23h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-12 20:53 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-12 20:53 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-12 20:53 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `123,162` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.7h ago (2026-08-12 05:13 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **94.1h (3d 22h 6m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **93.1h (3d 21h 6m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  03:53:32 AM
   CPU:   4.0%  |  MEM:   5.5% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 709684   | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 797384   | COOL-DOWN       | 296      | Next run in 9.8s
Trader ETH-USD       | 797385   | COOL-DOWN       | 296      | Next run in 9.8s
Trader ADA-USD       | 797386   | COOL-DOWN       | 296      | Next run in 9.8s
Trader DOGE-USD      | 797387   | COOL-DOWN       | 296      | Next run in 9.8s
Trader BTC-USD       | 797388   | COOL-DOWN       | 296      | Next run in 9.8s
Trader LINK-USD      | 797389   | COOL-DOWN       | 296      | Next run in 9.8s
Trader SOL-USD       | 797390   | COOL-DOWN       | 296      | Next run in 9.8s
================================================================================
```
