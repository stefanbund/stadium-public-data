...
> **Report Generated**: `2026-08-23 01:00:01 PM PDT (2026-08-23 20:00:01 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+11.52** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.63** | **-0.50** | **+2.13** | **+27.30** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+11.52** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.12** | **-0.50** | **+1.62** | **+11.59** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (17.57h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (4.97h old) | 08-23 08:02 |
| ✅ | **Holding Times config** | Fresh (51.96h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-23 12:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 12:59 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 13:00 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `19,581` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 5.0h ago (2026-08-23 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **6.0h (0d 5h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **5.0h (0d 4h 59m)**)
...
================================================================================
   ...
   CPU:   1.4%  |  MEM:   6.8% (14.4GB / 15.4GB Free)
================================================================================
...
Trader DOGE-USD      | 1367524  | COOL-DOWN       | 27       | Next run in 4.6s
Trader BTC-USD       | 1367525  | COOL-DOWN       | 27       | Next run in 4.6s
Trader LINK-USD      | 1367526  | COOL-DOWN       | 27       | Next run in 4.6s
Trader SOL-USD       | 1367527  | COOL-DOWN       | 27       | Next run in 4.6s
================================================================================
```
