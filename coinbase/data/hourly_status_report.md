...
> **Report Generated**: `2026-08-26 04:00:08 AM PDT (2026-08-26 11:00:08 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.74** | **-0.50** | **-1.24** | **-4.79** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-2.13** | **-0.50** | **-1.63** | **+14.15** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.74** | **-0.50** | **-1.24** | **-4.80** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.74** | **-0.50** | **-1.24** | **-4.80** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.74** | **-0.50** | **-1.24** | **-4.80** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.74** | **-0.50** | **-1.24** | **-4.80** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.74** | **-0.50** | **-1.24** | **-4.80** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (18.97h old) | 08-25 09:02 |
| ✅ | **TimesFM Forecasts** | Fresh (3.97h old) | 08-26 00:01 |
| ❌ | **Holding Times config** | STALE! (115.0h old) | Limit 57.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-26 03:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 04:00 |
| ❌ | **Live Trading Telemetry** | STALE! (6.5h old) | Limit 0.1h |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `7,776` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.0h ago (2026-08-26 12:01 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **111.0h (4d 14h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-25 09:02:14 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **110.0h (4d 13h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:00:04 AM
   CPU:   7.6%  |  MEM:   8.3% (14.1GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 227213   | RUNNING         | -        | Continuous Websocket Feed
MAO Daemon           | 227394   | RUNNING         | -        | Oracle Yield Analysis
Stable Farmer        | 227396   | RUNNING         | -        | Volume Farmer
Trader AVAX-USD      | 227397   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 281372   | RUNNING         | 206      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 227399   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 227400   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 227401   | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader LINK-USD      | 227402   | RUNNING         | 0        | Evaluating Funnel/Polling Order
```
