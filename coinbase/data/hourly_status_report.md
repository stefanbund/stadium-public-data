...
> **Report Generated**: `2026-08-17 03:56:53 AM PDT (2026-08-17 10:56:53 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.32** | **-0.50** | **-1.82** | **+16.70** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.82** | **-0.50** | **-1.32** | **+27.64** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.32** | **-0.50** | **-1.82** | **+16.70** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.32** | **-0.50** | **-1.82** | **+16.70** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.32** | **-0.50** | **-1.82** | **+16.70** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.32** | **-0.50** | **-1.82** | **+16.70** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.32** | **-0.50** | **-1.82** | **+16.70** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (2.93h old) | 08-17 01:01 |
| ✅ | **TimesFM Forecasts** | Fresh (2.73h old) | 08-17 01:13 |
| ✅ | **Holding Times config** | Fresh (2.72h old) | 08-17 01:13 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-17 03:56 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-17 03:56 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-17 03:57 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `68,919` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.7h ago (2026-08-17 01:13 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-17 01:13:06 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **159.1h (6d 15h 3m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **158.0h (6d 14h 2m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  10:56:54 AM
   CPU:   4.2%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1973602  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2039544  | COOL-DOWN       | 214      | Next run in 4.6s
Trader ETH-USD       | 2039545  | COOL-DOWN       | 214      | Next run in 4.6s
Trader ADA-USD       | 2039546  | COOL-DOWN       | 214      | Next run in 4.6s
Trader DOGE-USD      | 2039547  | COOL-DOWN       | 214      | Next run in 4.6s
Trader BTC-USD       | 2039548  | COOL-DOWN       | 214      | Next run in 4.6s
Trader LINK-USD      | 2039549  | COOL-DOWN       | 214      | Next run in 4.6s
Trader SOL-USD       | 2039550  | COOL-DOWN       | 214      | Next run in 4.6s
================================================================================
```
