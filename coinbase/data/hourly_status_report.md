...
> **Report Generated**: `2026-08-28 04:00:03 PM PDT (2026-08-28 23:00:03 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+1.28** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.43** | **-0.50** | **-0.93** | **+12.61** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+1.39** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+1.22** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+1.12** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+1.37** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.39** | **-0.50** | **-0.89** | **+0.08** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (7.13h old) | 08-28 08:52 |
| ✅ | **TimesFM Forecasts** | Fresh (3.14h old) | 08-28 12:51 |
| ❌ | **Holding Times config** | STALE! (175.0h old) | Limit 117.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-28 16:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 16:00 |
| ❌ | **Live Trading Telemetry** | STALE! (2.1h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 521 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `20,196` | **100.0%** |
...
| `DOGE-USD` | BUY | 0.08508 | `b0834d13-6a15-4616-b610-f0de8f93da7d` |
| `ADA-USD` | BUY | 0.2021 | `9f66bec6-9785-4625-9e84-a606c3b2d0f4` |
| `AVAX-USD` | BUY | 7.294 | `78b2cffc-17c7-43fc-b977-d368abc90e2b` |
| `LINK-USD` | BUY | 11.426 | `3aa04da5-5193-4f61-9532-5fcf1e35ace8` |
...
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **51.0h (2d 2h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-28 08:52:07 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **50.0h (2d 1h 59m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:00:01 PM
...
Trader AVAX-USD      | 3278348  | RUNNING         | 3        | Evaluating Funnel/Polling Order
Trader ETH-USD       | 3278349  | COOL-DOWN       | 169      | Next run in 3.5s
Trader ADA-USD       | 3277884  | RUNNING         | 4        | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3277516  | RUNNING         | 9        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3276614  | RUNNING         | 26       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 3278360  | RUNNING         | 14       | Evaluating Funnel/Polling Order
```
