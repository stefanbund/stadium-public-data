...
> **Report Generated**: `2026-08-23 10:26:57 AM PDT (2026-08-23 17:26:57 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+0.34** | **-0.50** | **+0.84** | **+11.27** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+1.21** | **-0.50** | **+1.71** | **+26.78** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+0.34** | **-0.50** | **+0.84** | **+11.27** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+0.34** | **-0.50** | **+0.84** | **+11.27** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+0.34** | **-0.50** | **+0.84** | **+11.27** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+0.34** | **-0.50** | **+0.84** | **+11.27** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+0.34** | **-0.50** | **+0.84** | **+11.26** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (15.02h old) | 08-22 19:25 |
| ✅ | **TimesFM Forecasts** | Fresh (2.42h old) | 08-23 08:02 |
| ✅ | **Holding Times config** | Fresh (49.40h old) | 08-21 09:02 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-23 10:26 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-23 10:27 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-23 10:26 |
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `16,726` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.4h ago (2026-08-23 08:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-23 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **8.5h (0d 8h 32m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-22 07:25:41 PM PDT`
- **Next Scheduled Run**: `2026-08-23 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **7.5h (0d 7h 32m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:26:55 PM
   CPU:  23.6%  |  MEM:   6.3% (14.4GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1135278  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1224331  | RUNNING         | 282      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1224332  | RUNNING         | 282      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1224333  | RUNNING         | 282      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1224334  | RUNNING         | 282      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1224335  | RUNNING         | 282      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1224336  | RUNNING         | 282      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1224140  | COOL-DOWN       | 279      | Next run in 14.2s
================================================================================
```
