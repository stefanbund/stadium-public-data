...
> **Report Generated**: `2026-08-13 10:51:51 AM PDT (2026-08-13 17:51:51 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **35.27** | **-1.30** (≤ -0.5) | 45.7 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
| `ETH-USD` | **48.73** | **-1.38** (≤ -0.5) | 51.6 | 20/100 (< 30) | Compression 📉 | 🟢 Approved |
...
> - **BTC-USD**: $Z = -1.30$ (Safety Margin: **-0.80** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
> - **ETH-USD**: $Z = -1.38$ (Safety Margin: **-0.88** vs. gate $-0.5$) $\rightarrow$ **🟢 SAFE / COMPRESSED**
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (21.52h old) | 08-12 13:21 |
| ✅ | **TimesFM Forecasts** | Fresh (1.63h old) | 08-13 09:14 |
| ✅ | **Holding Times config** | Fresh (25.21h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-13 10:51 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-13 10:51 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-13 10:52 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `121,951` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.6h ago (2026-08-13 09:14 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **80.1h (3d 8h 8m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-12 02:28:22 PM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **79.1h (3d 7h 7m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  05:51:50 PM
   CPU:   8.8%  |  MEM:   5.7% (14.5GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 1499840  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 1536595  | RUNNING         | 124      | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1536596  | RUNNING         | 124      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1536597  | RUNNING         | 124      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1536598  | RUNNING         | 124      | Evaluating Funnel/Polling Order
Trader BTC-USD       | 1536599  | RUNNING         | 124      | Evaluating Funnel/Polling Order
Trader LINK-USD      | 1536600  | RUNNING         | 124      | Evaluating Funnel/Polling Order
Trader SOL-USD       | 1536601  | RUNNING         | 124      | Evaluating Funnel/Polling Order
================================================================================
```
