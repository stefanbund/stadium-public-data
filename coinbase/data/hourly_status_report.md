...
> **Report Generated**: `2026-09-24 12:25:31 PM PDT (2026-09-24 19:25:31 UTC)`  
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (68.00h old) | 09-21 16:25 |
| ✅ | **TimesFM Forecasts** | Fresh (4.37h old) | 09-24 08:03 |
| ❌ | **Holding Times config** | STALE! (575.7h old) | Limit 89.4h |
| ❌ | **BTC DVOL Cache** | STALE! (51.4h old) | Limit 0.0h |
| ❌ | **ETH DVOL Cache** | STALE! (51.4h old) | Limit 0.0h |
| ❌ | **Live Causal Telemetry** | STALE! (51.4h old) | Limit 0.5h |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.4h ago (2026-09-24 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-27 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **78.6h (3d 6h 34m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-21 04:25:29 PM PDT`
- **Next Scheduled Run**: `2026-09-27 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **77.6h (3d 5h 34m)**)
...
================================================================================
3277676  1-16:54:15  0.0  0.0 bash -c cd /opt/hft_trader && sudo nohup ./venv/bin/python3 -u guardian_causal.py > guardian_causal.log 2>&1 &
3277677  1-16:54:15  0.0  0.0 sudo nohup ./venv/bin/python3 -u guardian_causal.py
3277680  1-16:54:15  0.0  0.0 ./venv/bin/python3 -u guardian_causal.py
```
