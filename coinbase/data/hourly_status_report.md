...
> **Report Generated**: `2026-08-28 03:00:02 PM PDT (2026-08-28 22:00:02 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-1.43** | **-0.50** | **-0.93** | **+1.28** | 5.0 | 🟢 SAFE |
| `ETH-USD` | DVOL_ETH | **-1.51** | **-0.50** | **-1.01** | **+14.25** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-1.43** | **-0.50** | **-0.93** | **+1.39** | 5.0 | 🟢 SAFE |
| `DOGE-USD` | DVOL_BTC | **-1.43** | **-0.50** | **-0.93** | **+1.22** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-1.43** | **-0.50** | **-0.93** | **+1.12** | 5.0 | 🟢 SAFE |
| `LINK-USD` | DVOL_BTC | **-1.43** | **-0.50** | **-0.93** | **+1.37** | 5.0 | 🟢 SAFE |
| `SOL-USD` | DVOL_BTC | **-1.43** | **-0.50** | **-0.93** | **+1.51** | 5.0 | 🟢 SAFE |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (6.13h old) | 08-28 08:52 |
| ✅ | **TimesFM Forecasts** | Fresh (2.14h old) | 08-28 12:51 |
| ❌ | **Holding Times config** | STALE! (174.0h old) | Limit 116.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-28 15:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-28 15:00 |
| ❌ | **Live Trading Telemetry** | STALE! (1.1h old) | Limit 0.1h |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 491 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `20,045` | **100.0%** |
...
| `SOL-USD` | SELL | 103.58 | `2ca1562f-6eea-4114-9973-e6c907816f78` |
| `BTC-USD` | BUY | 77230.68 | `54a7db02-d9f4-445d-a4be-dc94b1df120c` |
...
- **TimesFM Forecast DB**: 🟢 Updated 2.1h ago (2026-08-28 12:51 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **52.0h (2d 3h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-28 08:52:07 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **51.0h (2d 2h 59m)**)
...
================================================================================
   ...
   CPU:  15.0%  |  MEM:   8.5% (14.1GB / 15.4GB Free)
================================================================================
...
Trader ETH-USD       | 3231612  | COOL-DOWN       | 16       | Next run in 14.4s
...
Trader BTC-USD       | 3230916  | RUNNING         | 2        | Evaluating Funnel/Polling Order
