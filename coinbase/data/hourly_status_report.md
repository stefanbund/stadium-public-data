...
> **Report Generated**: `2026-08-11 11:22:03 AM PDT (2026-08-11 18:22:03 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `BTC-USD` | **36.02** | **+0.58** (≤ -0.5) | 14.5 | 20/100 (< 30) | Compression 📉 | 🔴 DAW Vetoed |
| `ETH-USD` | **49.31** | **-1.13** (≤ -0.5) | 41.7 | 0/100 (< 30) | Expansion 📈 | 🟢 Approved |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `122,576` | **99.5%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.2h ago (2026-08-11 08:12 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **127.6h (5d 7h 37m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-11 10:42:12 AM PDT`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **126.6h (5d 6h 37m)**)
...
```text
logs/watchdog_Trader_SOL_USD.log:2026-08-11 09:29:31,151 - ERROR - [SOL-USD] CRITICAL: Empty DVOL state returned from oracle for BTC (Fail-Closed)
