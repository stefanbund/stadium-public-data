...
> **Report Generated**: `2026-08-14 04:25:43 AM PDT (2026-08-14 11:25:43 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-2.01** | **-0.50** | **-1.51** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-2.40** | **-0.50** | **-1.90** | **+24.75** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-2.01** | **-0.50** | **-1.51** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-2.01** | **-0.50** | **-1.51** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-2.01** | **-0.50** | **-1.51** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-2.01** | **-0.50** | **-1.51** | **+11.59** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-2.01** | **-0.50** | **-1.51** | **+11.59** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (21.28h old) | 08-13 07:08 |
| ✅ | **TimesFM Forecasts** | Fresh (4.40h old) | 08-14 00:02 |
| ✅ | **Holding Times config** | Fresh (42.77h old) | 08-12 09:39 |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-14 04:25 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-14 04:25 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-14 04:25 |
...
| :--- | :--- | :--- |
| Layer 1: DAW Causal Volatility Veto | `11,220` | **100.0%** |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.4h ago (2026-08-14 12:02 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-12 01:22:32 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-16 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **62.6h (2d 14h 34m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `Never`
- **Next Scheduled Run**: `2026-08-16 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **61.6h (2d 13h 33m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  11:25:44 AM
   CPU:   4.6%  |  MEM:   5.2% (14.6GB / 15.4GB Free)
================================================================================
SERVICE              | PID      | STATUS          | RESTARTS | INFO
--------------------------------------------------------------------------------
L3 Consumer          | 2374871  | RUNNING         | -        | Continuous Websocket Feed
Trader AVAX-USD      | 2468395  | COOL-DOWN       | 303      | Next run in 9.7s
Trader ETH-USD       | 2468396  | COOL-DOWN       | 303      | Next run in 9.7s
Trader ADA-USD       | 2468397  | COOL-DOWN       | 303      | Next run in 9.7s
Trader DOGE-USD      | 2468398  | COOL-DOWN       | 303      | Next run in 9.7s
Trader BTC-USD       | 2468399  | COOL-DOWN       | 303      | Next run in 9.7s
Trader LINK-USD      | 2468400  | COOL-DOWN       | 303      | Next run in 9.7s
Trader SOL-USD       | 2468401  | COOL-DOWN       | 303      | Next run in 9.7s
================================================================================
```
