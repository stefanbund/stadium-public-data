...
> **Report Generated**: `2026-08-26 05:00:06 PM PDT (2026-08-27 00:00:06 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-0.63** | **-0.50** | **-0.13** | **+5.08** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.02** | **-0.50** | **+0.52** | **+20.73** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.63** | **-0.50** | **-0.13** | **+5.08** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-0.63** | **-0.50** | **-0.13** | **+4.95** | 5.0 | 🟢 SAFE |
| `BTC-USD` | DVOL_BTC | **-0.63** | **-0.50** | **-0.13** | **+5.08** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-0.63** | **-0.50** | **-0.13** | **+5.08** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-0.63** | **-0.50** | **-0.13** | **+5.08** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (6.26h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (0.97h old) | 08-26 16:02 |
| ❌ | **Holding Times config** | STALE! (128.0h old) | Limit 70.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 08-26 17:00 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 08-26 17:00 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-26 17:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2194 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `5,592` | **100.0%** |
...
| `ETH-USD` | BUY | 2502.95 | `ab698226-f273-47df-b4e0-f83bcd6e1b48` |
...
- **TimesFM Forecast DB**: 🟢 Updated 1.0h ago (2026-08-26 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **98.0h (4d 1h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **97.0h (4d 0h 59m)**)
...
================================================================================
   ...
   CPU:  25.7%  |  MEM:   6.9% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 925055   | COOL-DOWN       | 18       | Next run in 14.8s
Trader ETH-USD       | 923867   | RUNNING         | 19       | Evaluating Funnel/Polling Order
Trader ADA-USD       | 925056   | COOL-DOWN       | 18       | Next run in 14.8s
Trader DOGE-USD      | 922247   | RUNNING         | 9        | Evaluating Funnel/Polling Order
Trader BTC-USD       | 925057   | COOL-DOWN       | 23       | Next run in 14.8s
Trader LINK-USD      | 925132   | RUNNING         | 18       | Evaluating Funnel/Polling Order
```
