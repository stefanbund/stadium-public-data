...
Generated at: 2026-08-03 00:00:11 
...
--------------------------------------------------
• DVOL BTC: Close=35.69 | Z-Score=1.97 (Thresh <= 0.5) | RSI=59.9 | Exhaustion=20/100
  Volatility Trend: DOWNWARD (Compression)
  Safety Status:    🔴 REJECTED_TOO_RISKY (Vetoed by DAW)
  Veto Rationale:   Volatility Expansion (Z-Score=1.97 > 0.5)
• DVOL ETH: Close=50.37 | Z-Score=1.11 (Thresh <= 0.5) | RSI=68.8 | Exhaustion=0/100
  Volatility Trend: UPWARD (Expansion)
  Safety Status:    🔴 REJECTED_TOO_RISKY (Vetoed by DAW)
  Veto Rationale:   Volatility Expansion (Z-Score=1.11 > 0.5)
...
--------------------------------------------------
• Report Window (Recent Decisions): 2026-08-03 03:00:13 to 2026-08-03 06:59:50
...
• Rejection Reasons Breakdown:
  - Layer 1: DAW Causal Volatility Veto               : 124364 (12436400.0%)
...
• Time Until Next Optimizer:  163.0 hour(s) (6d 18h 59m)
