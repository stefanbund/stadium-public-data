...
> **Report Generated**: `2026-08-26 08:00:05 PM PDT (2026-08-27 03:00:05 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **-0.97** | **-0.50** | **-0.47** | **+9.64** | 5.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **-1.86** | **-0.50** | **-1.36** | **+24.95** | 5.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **-0.97** | **-0.50** | **-0.47** | **+9.64** | 5.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **-0.97** | **-0.50** | **-0.47** | **+9.23** | 5.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **-0.97** | **-0.50** | **-0.47** | **+9.23** | 5.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **-0.97** | **-0.50** | **-0.47** | **+9.23** | 5.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **-0.97** | **-0.50** | **-0.47** | **+9.23** | 5.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (9.26h old) | 08-26 10:44 |
| ✅ | **TimesFM Forecasts** | Fresh (3.97h old) | 08-26 16:02 |
| ❌ | **Holding Times config** | STALE! (131.0h old) | Limit 73.0h |
| ✅ | **BTC DVOL Cache** | Fresh (0.01h old) | 08-26 19:59 |
| ✅ | **ETH DVOL Cache** | Fresh (0.01h old) | 08-26 19:59 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 08-26 20:00 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 2075 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `8,459` | **100.0%** |
...
| `AVAX-USD` | SELL | 7.406 | `01013bfc-95ba-4492-9773-7dfbc0383afc` |
...
- **TimesFM Forecast DB**: 🟢 Updated 4.0h ago (2026-08-26 04:02 PM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-05 09:22:38 AM PDT`
- **Next Scheduled VSTEF Run**: `2026-08-30 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **95.0h (3d 22h 59m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-26 10:44:36 AM PDT`
- **Next Scheduled Run**: `2026-08-30 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **94.0h (3d 21h 59m)**)
...
================================================================================
   ...
   CPU:  10.4%  |  MEM:   6.6% (14.4GB / 15.4GB Free)
================================================================================
...
Trader AVAX-USD      | 1039581  | RUNNING         | 55       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 1080561  | RUNNING         | 157      | Evaluating Funnel/Polling Order
Trader ADA-USD       | 1080562  | RUNNING         | 154      | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 1080406  | COOL-DOWN       | 189      | Next run in 9.3s
Trader BTC-USD       | 1080407  | COOL-DOWN       | 192      | Next run in 9.3s
Trader LINK-USD      | 1080204  | COOL-DOWN       | 178      | Next run in 3.8s
```
