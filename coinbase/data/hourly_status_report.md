...
> **Report Generated**: `2026-09-26 11:15:50 AM PDT (2026-09-26 18:15:50 UTC)`  
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (114.84h old) | 09-21 16:25 |
| ✅ | **TimesFM Forecasts** | Fresh (3.21h old) | 09-26 08:03 |
| ❌ | **Holding Times config** | STALE! (622.5h old) | Limit 136.3h |
| ❌ | **BTC DVOL Cache** | STALE! (25.2h old) | Limit 0.0h |
| ❌ | **ETH DVOL Cache** | STALE! (25.2h old) | Limit 0.0h |
| ❌ | **Live Causal Telemetry** | STALE! (263.6h old) | Limit 0.5h |
...
| **Rolling 30-Day Volume** | **`$1,850,872.64 USD`** | **VIP 1** (Maker: **0.06%** / 6 bps, Taker: **0.10%**) |
| **Next Tier Milestone (VIP 2)** | **37.0% Complete** | `$3,149,127.36 USD` to reach $5,000,000.00 threshold |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.2h ago (2026-09-26 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-27 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **31.7h (1d 7h 44m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-21 04:25:29 PM PDT`
- **Next Scheduled Run**: `2026-09-27 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **30.7h (1d 6h 43m)**)
...
================================================================================
2713990    01:09:19  0.0  0.0 sudo /opt/hft_trader/venv/bin/python3 -u guardian_causal.py
2714031    01:09:19  0.0  0.0 /opt/hft_trader/venv/bin/python3 -u guardian_causal.py
```
