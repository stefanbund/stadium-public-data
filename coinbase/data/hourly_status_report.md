...
> **Report Generated**: `2026-09-01 11:04:13 AM PDT (2026-09-01 18:04:13 UTC)`  
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `AVAX-USD` | DVOL_BTC | **+1.36** | **-0.50** | **+1.86** | **+5.01** | -1.0 | 🔴 DAW VETOED |
| `ETH-USD` | DVOL_ETH | **+0.98** | **-0.50** | **+1.48** | **+18.19** | -1.0 | 🔴 DAW VETOED |
| `ADA-USD` | DVOL_BTC | **+1.36** | **-0.50** | **+1.86** | **+5.01** | -1.0 | 🔴 DAW VETOED |
| `DOGE-USD` | DVOL_BTC | **+1.36** | **-0.50** | **+1.86** | **+5.01** | -1.0 | 🔴 DAW VETOED |
| `BTC-USD` | DVOL_BTC | **+1.36** | **-0.50** | **+1.86** | **+5.01** | -1.0 | 🔴 DAW VETOED |
| `LINK-USD` | DVOL_BTC | **+1.36** | **-0.50** | **+1.86** | **+5.01** | -1.0 | 🔴 DAW VETOED |
| `SOL-USD` | DVOL_BTC | **+1.36** | **-0.50** | **+1.86** | **+5.01** | -1.0 | 🔴 DAW VETOED |
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (22.34h old) | 08-31 12:43 |
| ✅ | **TimesFM Forecasts** | Fresh (3.02h old) | 09-01 08:03 |
| ✅ | **Holding Times config** | Fresh (22.35h old) | 08-31 12:43 |
| ✅ | **BTC DVOL Cache** | Fresh (0.00h old) | 09-01 11:04 |
| ✅ | **ETH DVOL Cache** | Fresh (0.00h old) | 09-01 11:04 |
| ✅ | **Live Trading Telemetry** | Fresh (0.00h old) | 09-01 11:04 |

<br>

> **Utilization Certification**: ✅ **CERTIFIED.** The Guardian Watchdog is ONLINE and EC2 traders are actively querying the freshest MLOps data artifacts (Found 1680 recent read events).
...
| :--- | :--- | :--- |
| Tier 1: Macro Volatility Tensor Gate (Omega_macro) | `71,247` | **100.0%** |
...
| :--- | :--- | :--- |
| **Daemon Engine** | 🟢 RUNNING | PID `3818673` on Live EC2 (CPU: `0.9%`, RAM: `0.2%`) |
...
| **Active SELL Tranches** | **3 Orders** (`$14,993.70 USDT`) | Resting Limit Asks pegged to Best Ask |
| **Total Deployed U/U Capital** | **`$14,993.70 USD`** | Active bidirectional turnover liquidity pool |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| `USDT-USD` | 🔴 **SELL** | 0.99958 | 5,000.0 | `$4,997.90` | `011750b9-44f5-4b54-9edf-7ef64b8345e8` |
| `USDT-USD` | 🔴 **SELL** | 0.99958 | 5,000.0 | `$4,997.90` | `07c8e13e-cece-4062-ab2d-4a9b16947332` |
| `USDT-USD` | 🔴 **SELL** | 0.99958 | 5,000.0 | `$4,997.90` | `4eb45615-a67f-4fce-ac57-15cf4e11ab01` |
...
| :--- | :--- | :--- | :--- |
| `USDT` | 1112.2000 | 45000.0000 | **46112.2000** |
...
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `01725af2-59f9-46d5-8843-75c495f47201` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `3ff04362-799f-4537-8dd1-02ea677a832a` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `223be7ac-095e-419b-ae62-564d8687048c` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `edc04423-b20b-43b1-9989-fdbcb0c67823` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `e392c133-27c1-4512-ba3b-2554c24f6970` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `c433566a-6253-4c22-9e3c-dae6662e3f79` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `011750b9-44f5-4b54-9edf-7ef64b8345e8` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `07c8e13e-cece-4062-ab2d-4a9b16947332` |
| `USDT-USD` | SELL | 0.99958 | 5,000.00 | `4eb45615-a67f-4fce-ac57-15cf4e11ab01` |
...
- **TimesFM Forecast DB**: 🟢 Updated 3.0h ago (2026-09-01 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-06 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **127.9h (5d 7h 55m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-08-31 12:43:56 PM PDT`
- **Next Scheduled Run**: `2026-09-06 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **126.9h (5d 6h 55m)**)
...
```text
================================================================================
   🛡️  SFGK FUNNEL GUARDIAN WATCHDOG (HFT ONLY) |  06:04:11 PM
...
Trader AVAX-USD      | 3825858  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader ETH-USD       | 3818675  | RUNNING         | 0        | Evaluating Funnel/Polling Order
Trader ADA-USD       | 3825859  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader DOGE-USD      | 3825860  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader BTC-USD       | 3825861  | RUNNING         | 16       | Evaluating Funnel/Polling Order
Trader LINK-USD      | 3825862  | RUNNING         | 16       | Evaluating Funnel/Polling Order
```
...
logs/watchdog_Trader_SOL_USD.log:2026-09-01 17:58:18 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.32s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 17:59:02 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.30s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 17:59:24 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.16s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:00:09 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.23s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:00:31 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.14s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:00:53 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_product | Sleeping 1.40s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:01:15 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.38s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:01:37 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.36s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:01:59 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.12s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:02:21 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.31s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:02:44 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.39s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:03:06 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_product | Sleeping 1.18s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:03:49 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_accounts | Sleeping 1.45s... | Error: 429 Client Error: Too Many Requests 
logs/watchdog_Trader_SOL_USD.log:2026-09-01 18:04:12 [WARNING] [async_sfgk_trader.py:_execute_api_call:299] [SOL-USD] Coinbase API Call Exception (Attempt 1/5). Func: get_product | Sleeping 1.21s... | Error: 429 Client Error: Too Many Requests
```
</details>
