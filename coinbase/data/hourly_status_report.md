...
> **Report Generated**: `2026-09-26 12:52:43 AM PDT (2026-09-26 07:52:43 UTC)`  
...
| :---: | :--- | :--- | :--- |
| ✅ | **Go-List JSON** | Fresh (104.46h old) | 09-21 16:25 |
| ❌ | **TimesFM Forecasts** | STALE! (16.8h old) | Limit 9.0h |
| ❌ | **Holding Times config** | STALE! (612.2h old) | Limit 125.9h |
| ❌ | **BTC DVOL Cache** | STALE! (87.9h old) | Limit 0.0h |
| ❌ | **ETH DVOL Cache** | STALE! (87.9h old) | Limit 0.0h |
| ❌ | **Live Causal Telemetry** | STALE! (87.9h old) | Limit 0.5h |
...
- **TimesFM Forecast DB**: 🔴 Updated 16.8h ago (2026-09-25 08:03 AM PDT)
- **Last Weekly VSTEF Optimization**: `2026-08-31 12:42:56 PM PDT`
- **Next Scheduled VSTEF Run**: `2026-09-27 07:00:00 PM PDT (Monday 02:00 UTC)` (Countdown: **42.1h (1d 18h 7m)**)
- **Promoted Parameter Gates**: $Z_{DVOL} \le -0.5$ | Holding Horizon $= 12\text{h}$

### Algorithmic Mega Cap Selection
- **Last Run (Confirmation)**: `2026-09-21 04:25:29 PM PDT`
- **Next Scheduled Run**: `2026-09-27 06:00:00 PM PDT (Monday 01:00 UTC)` (Countdown: **41.1h (1d 17h 7m)**)
...
================================================================================
2108550    05:09:04  0.0  0.0 /opt/hft_trader/venv/bin/python -u guardian_causal.py
```
